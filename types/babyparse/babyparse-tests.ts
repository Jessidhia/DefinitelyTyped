...
var UNPARSE_TESTS: UnparserTest[] = [
    ...
    },
    {
        ...
        notes:
            "Baby should add a data property that is an empty array to prevent errors (no copy is made)",
    ...
    {
        description:
            "Force quotes around certain fields only (with header row)",
        input: [
            { Col1: "a", Col2: "b", Col3: "c" },
            { Col1: "d", Col2: "e", Col3: "f" }
        ],
...
function displayResults(
    ...
    results: ParserTestCompareResult
): void {
