...
declare function hasha<E extends hasha.ToStringEncoding>(
    input: hasha.HashaInput,
    options: hasha.HashaOptions<E>
): string;
declare function hasha<E extends "buffer">(
    input: hasha.HashaInput,
    options: hasha.HashaOptions<E>
): Buffer;
...
declare namespace hasha {
    ...
    function fromStream<E extends ToStringEncoding>(
        stream: NodeJS.ReadableStream,
        options?: HashaOptions<E>
    ): Promise<string | null>;
    function fromStream<E extends "buffer">(
        stream: NodeJS.ReadableStream,
        options?: HashaOptions<E>
    ): Promise<Buffer | null>;

    function fromFile(filePath: string): Promise<string | null>;
    function fromFile<E extends ToStringEncoding>(
        filePath: string,
        options: HashaOptions<E>
    ): Promise<string | null>;
    function fromFile<E extends "buffer">(
        filePath: string,
        options: HashaOptions<E>
    ): Promise<Buffer | null>;

    function fromFileSync(filePath: string): string;
    function fromFileSync<E extends ToStringEncoding>(
        filePath: string,
        options: HashaOptions<E>
    ): string;
    function fromFileSync<E extends "buffer">(
        filePath: string,
        options: HashaOptions<E>
    ): Buffer;
}
