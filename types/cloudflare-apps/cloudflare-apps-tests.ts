...
describe("Globals", () => {
    ...
    it("INSTALL_PRODUCT returns InstallProduct", () => {
        const product:
            | CloudflareApps.InstallProduct
            | undefined = INSTALL_PRODUCT;
...
describe("CloudflareApps methods", () => {
    ...
    it("querySelector", () => {
        const element: Element | null = CloudflareApps.querySelector(
            "body > *"
        );
        const bodyElement: HTMLBodyElement | null = CloudflareApps.querySelector(
            "body"
        );
    });
});
