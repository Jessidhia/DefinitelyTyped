...
declare namespace i18n {
    ...
    interface I18n {
        ...
        init(
            ...
            callback?: (err: any, t: TranslationFunction) => void
        ): I18n;
        ...
        on(
            ...
            listener: (options: Options) => void
        ): void;
        on(loaded: "loaded", listener: (loaded: any) => void): void;
        on(
            failedLoading: "failedLoading",
            listener: (lng: string, ns: string, msg: string) => void
        ): void;
        on(
        ...
        on(
            ...
            listener: (lng: string, ns: string) => void
        ): void;
        on(
            languageChanged: "languageChanged",
            listener: (lng: string) => void
        ): void;
