...
myApp.config(
    (
        ...
        const neonRedMap: ng.material.IPalette = $mdThemingProvider.extendPalette(
            "red",
            {
                500: "ff0000"
            }
        ...
        const removeColors = $mdThemingProvider.enableBrowserColor(
            browserColors
        );
        removeColors();
...
myApp.controller(
    ...
    (
        ...
        $scope["setBrowserColors"] = () => {
            ...
            const remove: () => void = $mdTheming.setBrowserColor(
                browserColors
            );
        };
