...
export interface N3StreamParser<Q extends BaseQuad = Quad>
    extends RDF.Stream<Q>,
    ...
    resume(): this;
    isPaused(): boolean;
    pipe<T extends NodeJS.WritableStream | RDF.Stream<Q>>(
        destination: T,
        options?: { end?: boolean }
    ): T;
...
export interface WriterConstructor {
    new <Q extends RDF.BaseQuad = RDF.Quad>(options?: WriterOptions): N3Writer<
        Q
    >;
    new <Q extends RDF.BaseQuad = RDF.Quad>(
        fd: any,
...
export interface N3StreamWriter<Q extends RDF.BaseQuad = Quad>
...
export interface StoreConstructor {
    new <Q_RDF extends RDF.BaseQuad = RDF.Quad, Q_N3 extends BaseQuad = Quad>(
        triples?: Q_RDF[],
        options?: StoreOptions
    ): N3Store<Q_RDF, Q_N3>;
    <Q_RDF extends RDF.BaseQuad = RDF.Quad, Q_N3 extends BaseQuad = Quad>(
        triples?: Q_RDF[],
        options?: StoreOptions
    ): N3Store<Q_RDF, Q_N3>;
}
