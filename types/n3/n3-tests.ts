...
function test_doc_rdf_stream_to_triples_1() {
    ...
    const parser: N3.N3Parser<QuadBnode> = new N3.Parser<QuadBnode>({
...
function test_doc_utility() {
    ...
    N3Util.isLiteral(
        N3.DataFactory.literal(
            "3",
            N3.DataFactory.namedNode("http://www.w3.org/2001/XMLSchema#integer")
        )
    ); // true
    ...
    const namedNode2: RDF.NamedNode = N3Util.prefixes(prefixes)("rdfs")(
        "label"
    );
}
