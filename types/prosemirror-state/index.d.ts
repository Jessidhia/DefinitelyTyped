...
export interface PluginSpec<S extends Schema = any> {
     ...
     */
    filterTransaction?:
        | ((p1: Transaction<S>, p2: EditorState<S>) => boolean)
        | null;
    /**
...
export class Selection<S extends Schema = any> {
     ...
     */
    static near<S extends Schema = any>(
        $pos: ResolvedPos<S>,
        bias?: number
    ): Selection<S>;
    /**
     ...
     * exists.
     */
    static atStart<S extends Schema = any>(
    ...
    static jsonID(
        id: string,
        selectionClass: { new (...args: any[]): Selection }
    ): void;
}
/**
...
export class EditorState<S extends Schema = any> {
    ...
    applyTransaction(
        tr: Transaction<S>
    ): { state: EditorState<S>; transactions: Array<Transaction<S>> };
    /**
     ...
     */
    toJSON(
        pluginFields?: { [name: string]: Plugin<S> } | string | number
    ): { [key: string]: any };
    /**
     * Create a new state.
     */
