...
got("todomvc.com", { json: true, form: true, encoding: null }).then(
    response => {
        response.body; // $ExpectType any
    }
);
...
got("todomvc.com", { form: true, body: {} }).then(
    response => (str = response.body)
);
got("todomvc.com", { form: true, body: [{}] }).then(
    response => (str = response.body)
);
got("todomvc.com", { form: true, body: [{}], encoding: null }).then(
    response => (buf = response.body)
);
got("todomvc.com", { form: true, body: [{}], encoding: "utf8" }).then(
    response => (str = response.body)
);
got("todomvc.com", {
    form: true,
...
got("todomvc.com", { encoding: null, hostname: "todomvc" }).then(
    response => (buf = response.body)
);
got("todomvc.com", { encoding: "utf8", hostname: "todomvc" }).then(
    response => (str = response.body)
);

got("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);

got.get("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
got.post("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
got.put("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
got.patch("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
got.head("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
got.delete("todomvc.com", { hostname: "todomvc" }).then(
    response => (str = response.body)
);
...
got("https://httpbin.org/404").catch(
    err => err instanceof got.HTTPError && err.statusCode === 404
);
...
got("http://todomvc.com", { timeout: 1 }).catch(
    err => err instanceof got.TimeoutError
);
