...
export declare class EmitterBase<EventTypes extends BaseEventMap> extends Base {
    ...
    on<E extends Extract<keyof EventTypes, string> | string | symbol>(
        eventType: E,
        listener: (
    ...
    once<E extends Extract<keyof EventTypes, string> | string | symbol>(
        eventType: E,
        listener: (
            payload: E extends keyof EventTypes ? EventTypes[E] : any,
            ...args: any[]
    ...
    prependListener<
        E extends Extract<keyof EventTypes, string> | string | symbol
    >(
        eventType: E,
        listener: (
            payload: E extends keyof EventTypes ? EventTypes[E] : any,
