...
function test_system() {
    ...
    fin.desktop.System.getLogList(logList => {
        logList.forEach(logInfo => {
            console.log(
                `The filename of the log is ${logInfo.name}, the size is ${
                    logInfo.size
                }, and the date of creation is ${logInfo.date}`
            );
        });
    });
    // getMonitorInfo
    ...
    fin.desktop.System.getMousePosition(mousePosition => {
        console.log(
            `The mouse is located at left: ${mousePosition.left}, top: ${
                mousePosition.top
            }`
        );
    });
...
function test_window() {
    ...
    finWindow.getBounds(bounds => {
        console.log(
            `top: ${bounds.top} left: ${bounds.left} height: ${
                bounds.height
            } width: ${bounds.width}`
        );
    });
