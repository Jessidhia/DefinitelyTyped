...
export function getPositionedAncestor(
    element?: HTMLElement
): HTMLElement | null;
...
export function scrollViewportToShowTarget(options: {
...
export function parseKeystroke(
...
export function toMap<K extends string, V = any>(
