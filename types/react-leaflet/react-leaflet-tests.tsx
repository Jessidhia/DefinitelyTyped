...
export class DraggableExample extends Component<
    undefined,
    DraggableExampleState
> {
    state = {
        center: {
            lat: 51.505,
    ...
    updatePosition = () => {
        const { lat, lng } = (this.refs
            .marker as Marker).leafletElement.getLatLng();
        this.setState({
            marker: { lat, lng }
        });
    };
    ...
    render() {
        ...
        const markerPosition: L.LatLngExpression = [
            ...
            <Map bounds={outer}>
                ...
                <Pane name="yellow-rectangle" style={{ zIndex: 499 }}>
                    ...
                    <Pane
                        ...
                        className="purplePane-purplePane"
                    >
...
export class WMSTileLayerExample extends Component<
    undefined,
    WMSTileLayerExampleState
> {
    state = {
        lat: 51.505,
        lng: -0.09,
...
class LegendControl extends MapControl<
    MapControlProps & { className?: string }
> {
    componentWillMount() {
