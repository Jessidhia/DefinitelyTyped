...
export class MapComponent<P, E extends Leaflet.Class> extends React.Component<
    P
> {
...
export namespace LayersControl {
    ...
    class ControlledLayer<
        P extends BaseControlledLayerProps = BaseControlledLayerProps
    > extends React.Component<P> {
        layer?: Leaflet.Layer;
    ...
    class BaseLayer<
        P extends ControlledLayerProps = ControlledLayerProps
    > extends ControlledLayer<P> {}
    class Overlay<
        P extends ControlledLayerProps = ControlledLayerProps
    > extends ControlledLayer<P> {}
}
