...
function command_scroll() {
    var $el: JQuery;
    $el.velocity("scroll", { duration: 1500, easing: "spring" }).velocity({
        opacity: 1
    });
...
function command_fadeIn_fadeOut() {
    var $el: JQuery;
    $el.velocity("fadeIn", { duration: 1500 }).velocity("fadeOut", {
        delay: 500,
        duration: 1500
    });
}
...
function command_slideDown_slideUp() {
    var $el: JQuery;
    $el.velocity("slideDown", { duration: 1500 }).velocity("slideUp", {
        delay: 500,
        duration: 1500
    });
}
...
function feature_sequences() {
    var $el: JQuery;
    $.Velocity.Sequences.hover = function(
        element: HTMLElement,
