...
class ReactSwipeTest extends React.PureComponent {
    ...
    private readonly onPrev: React.MouseEventHandler<
        HTMLButtonElement
    > = () => {
    ...
    private readonly onNext: React.MouseEventHandler<
        HTMLButtonElement
    > = () => {
        if (this.swipeComponent != null) {
    ...
    private readonly onSlideToStart: React.MouseEventHandler<
        HTMLButtonElement
    > = () => {
        if (this.swipeComponent != null) {
    ...
    private readonly onGetCurrentPosition: React.MouseEventHandler<
        HTMLButtonElement
    > = () => {
