function test_pnotify() {
    ...
    new PNotify({
        ...
        text:
            "No one ever pays attention to me. Why should they? I'm practically invisible.",
        opacity: 0.8
    });
    new PNotify({
        title: "No Shadow Notice",
        text:
            "I don't have a shadow. (It's cause I'm a vampire or something. Or is that reflections...)",
        shadow: false
    });
    ...
    new PNotify({
        ...
        text:
            "Not only does it not matter, but I don't even care if you see this info.",
        type: "info",
        opacity: 0.8
    });
    ...
    new PNotify({
        ...
        text:
            "Check me out! I'm a sticky notice with no unsticky button. You'll have to close me yourself.",
        hide: false,
        buttons: {
            sticker: false
        }
    ...
    new PNotify({
        ...
        text:
            "I don't care if you move your mouse over me, I'll disappear when I want.",
        mouse_reset: false
    });
    ...
    new PNotify({
        ...
        text:
            "I have an additional class that's used to give me special styling. I always wanted to be pretty.",
        addclass: "custom",
