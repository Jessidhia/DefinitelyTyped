...
class Example20 extends React.Component {
    render() {
        return (
            <ButtonGroup>
                <Button>Left</Button> <Button>Middle</Button>{" "}
                <Button>Right</Button>
            </ButtonGroup>
        );
    }
            ...
            <Form>
                    ...
                    <Col sm={10}>
                        <FormGroup check>
                            <Label check>
                                ...
                                is this and that—be sure to include why it's
                                great
                            </Label>
                        </FormGroup>
                        <FormGroup check>
                            <Label check>
                                ...
                                can be something else and selecting it will
                                deselect option one
                            </Label>
                        </FormGroup>
                        <FormGroup check disabled>
                ...
                <FormGroup row>
                    ...
                    <Col sm={{ size: 10 }}>
                        <FormGroup check>
                            <Label check>
                                <Input type="checkbox" id="checkbox2" /> Check
                                me out
                            </Label>
                        </FormGroup>
                    </Col>
    ...
    render() {
        return (
            <Form>
                ...
                <FormGroup check>
                    <Label check>
                        <Input type="radio" /> Option one is this and that—be
            ...
            <Container>
                ...
                <Row>
                    <Col sm={{ size: 6, push: 2, pull: 2, offset: 1 }}>
                        .col .col-sm-6 .col-sm-push-2 .col-sm-pull-2
                        .col-sm-offset-2
                    </Col>
                </Row>
                <Row>
        ...
        return (
            <div>
                {this.state.tooltips.map(
                    (
                        tooltip: { placement: string; text: string },
                        i: number
                    ) => {
...
class InputGroupButtonDropdownGeneric extends InputGroupButtonDropdown<
    GenericInterface
> {}
...
class ListGroupItemHeadingGeneric extends ListGroupItemHeading<
    GenericInterface
> {}
...
class UncontrolledButtonDropdownGeneric extends UncontrolledButtonDropdown<
    GenericInterface
> {}
class UncontrolledDropdownGeneric extends UncontrolledDropdown<
    GenericInterface
> {}
class UncontrolledTooltipGeneric extends UncontrolledTooltip<
    GenericInterface
> {}
class UncontrolledCollapseGeneric extends UncontrolledCollapse<
    GenericInterface
> {}
...
function GenericPropExample() {
    return (
        <React.Fragment>
            ...
            <InputGroupAddonGeneric
                foo={1}
                bar={false}
                foobar="example"
                addonType="prepend"
            />
            <InputGroupButtonDropdownGeneric
                foo={1}
                bar={false}
                foobar="example"
                addonType="prepend"
            ...
            <UncontrolledTooltipGeneric
                foo={1}
                bar={false}
                foobar="example"
                target=""
            />
            <UncontrolledCollapseGeneric
                foo={1}
                bar={false}
                foobar="example"
                target=""
