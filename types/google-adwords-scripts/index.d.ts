...
interface AdCustomizerItemBuilder<AdCustomizerItem>
    ...
    withAttributeValues(attributeValues: {}): AdCustomizerItemBuilder<
        AdCustomizerItem
    >;
    withTargetAdGroup(
        campaignName: string,
...
interface AdCustomizerSourceBuilder<AdCustomizerSource>
    ...
    addAttributes(attributes: {}): AdCustomizerSourceBuilder<
        AdCustomizerSource
    >;
...
interface AdBuilderSpace {
    ...
    gmailMultiProductAdBuilder(): GmailMultiProductAdBuilder<
        GmailMultiProductAd
    >;
    gmailSinglePromotionAdBuilder(): GmailSinglePromotionAdBuilder<
...
declare namespace AdWordsApp {
    ...
    function newAdCustomizerSourceBuilder(): AdCustomizerSourceBuilder<
        AdCustomizerSource
    >;
    function newExcludedPlacementListBuilder(): ExcludedPlacementListBuilder<
        ExcludedPlacementList
    >;
    function newNegativeKeywordListBuilder(): NegativeKeywordListBuilder<
        NegativeKeywordList
    >;
