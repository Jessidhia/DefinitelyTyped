...
() => {
    ...
    test("getParameter", function() {
        ...
        ok(
            a
                .getParameter(new THREE.Vector2(0, 0))
                .equals(new THREE.Vector2(0, 0)),
            "Passed!"
        );
        ok(
            a
                .getParameter(new THREE.Vector2(1, 1))
                .equals(new THREE.Vector2(1, 1)),
            "Passed!"
        );
        ...
        ok(
            b
                .getParameter(new THREE.Vector2(0, 0))
                .equals(new THREE.Vector2(0.5, 0.5)),
            "Passed!"
        );
        ok(
            b
    ...
    test("clampPoint", function() {
        ...
        ok(
            a
                .clampPoint(new THREE.Vector2(0, 0), target)
                .equals(new THREE.Vector2(0, 0)),
            "Passed!"
        );
        ok(
            a
                .clampPoint(new THREE.Vector2(1, 1), target)
                .equals(new THREE.Vector2(0, 0)),
            "Passed!"
        );
        ok(
        ...
        ok(
            b
                .clampPoint(new THREE.Vector2(2, 2), target)
                .equals(new THREE.Vector2(1, 1)),
            "Passed!"
        );
        ok(
    ...
    test("distanceToPoint", function() {
        ...
        ok(
            a.distanceToPoint(new THREE.Vector2(1, 1)) == Math.sqrt(2),
            "Passed!"
        );
        ok(
            a.distanceToPoint(new THREE.Vector2(-1, -1)) == Math.sqrt(2),
        ...
        ok(
            b.distanceToPoint(new THREE.Vector2(2, 2)) == Math.sqrt(2),
            "Passed!"
        );
    ...
    test("translate", function() {
        ...
        ok(
            a
                .clone()
                .translate(one2)
                .equals(new THREE.Box2(one2, one2)),
            "Passed!"
        );
        ok(
            a
    ...
    test("getParameter", function() {
        ...
        ok(
            a
                .getParameter(new THREE.Vector3(0, 0, 0))
                .equals(new THREE.Vector3(0, 0, 0)),
            "Passed!"
        );
        ok(
            a
                .getParameter(new THREE.Vector3(1, 1, 1))
                .equals(new THREE.Vector3(1, 1, 1)),
            "Passed!"
        );
        ...
        ok(
            b
                .getParameter(new THREE.Vector3(0, 0, 0))
                .equals(new THREE.Vector3(0.5, 0.5, 0.5)),
            "Passed!"
        );
        ok(
            b
    ...
    test("clampPoint", function() {
        ...
        ok(
            a
                .clampPoint(new THREE.Vector3(0, 0, 0), target)
                .equals(new THREE.Vector3(0, 0, 0)),
            "Passed!"
        );
        ok(
            a
                .clampPoint(new THREE.Vector3(1, 1, 1), target)
                .equals(new THREE.Vector3(0, 0, 0)),
            "Passed!"
        );
        ok(
        ...
        ok(
            b
                .clampPoint(new THREE.Vector3(2, 2, 2), target)
                .equals(new THREE.Vector3(1, 1, 1)),
            "Passed!"
        );
        ok(
    ...
    test("distanceToPoint", function() {
        ...
        ok(
            a.distanceToPoint(new THREE.Vector3(1, 1, 1)) == Math.sqrt(3),
            "Passed!"
        );
        ok(
            a.distanceToPoint(new THREE.Vector3(-1, -1, -1)) == Math.sqrt(3),
        ...
        ok(
            b.distanceToPoint(new THREE.Vector3(2, 2, 2)) == Math.sqrt(3),
            "Passed!"
        );
    ...
    test("getBoundingSphere", function() {
        ...
        ok(
            a.getBoundingSphere(target).equals(new THREE.Sphere(zero3, 0)),
            "Passed!"
        );
        ok(
            b
        ...
        ok(
            c
                .getBoundingSphere(target)
                .equals(new THREE.Sphere(zero3, Math.sqrt(12) * 0.5)),
            "Passed!"
        );
    });
    ...
    var compareBox = function(
        ...
        return (
            a.min.distanceTo(b.min) < threshold &&
    ...
    test("translate", function() {
        ...
        ok(
            a
                .clone()
                .translate(one3)
                .equals(new THREE.Box3(one3, one3)),
            "Passed!"
        );
        ok(
            a
    ...
    test("getHSL", function() {
        ...
        ok(
            Math.round(parseFloat(hsl.l.toString()) * 100) / 100 == 0.75,
            "lightness: " + hsl.l
        );
    });
    ...
    test("gimbalLocalQuat", function() {
        ...
        var eViaMViaQ1 = new THREE.Euler().setFromRotationMatrix(
            mViaQ1,
            eulerOrder
        );
    ...
    test("setFromMatrix/makeFrustum/containsPoint", function() {
        ...
        ok(
            a.containsPoint(new THREE.Vector3(-99.999, -99.999, -99.999)),
            "Passed!"
        );
        ok(
            !a.containsPoint(new THREE.Vector3(-100.1, -100.1, -100.1)),
            "Passed!"
        );
        ok(
            a.containsPoint(new THREE.Vector3(99.999, 99.999, -99.999)),
    ...
    test("setFromMatrix/makeFrustum/intersectsSphere", function() {
        ...
        ok(
            !a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, 0), 0)
            ),
            "Passed!"
        );
        ok(
            !a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, 0), 0.9)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, 0), 1.1)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, -50), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, -1.001), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(-1, -1, -1.001), 0)
            ),
            "Passed!"
        );
        ok(
            !a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(-1.1, -1.1, -1.001), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(-1.1, -1.1, -1.001), 0.5)
            ),
            "Passed!"
        );
        ok(
        ...
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, -99.999), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(
                    new THREE.Vector3(-99.999, -99.999, -99.999),
                    0
                )
            ),
            "Passed!"
        ...
        ok(
            !a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(-100.1, -100.1, -100.1), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(-100.1, -100.1, -100.1), 0.5)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(99.999, 99.999, -99.999), 0)
            ),
            "Passed!"
        );
        ok(
        ...
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(100.1, 100.1, -100.1), 0.2)
            ),
            "Passed!"
        );
        ok(
            !a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, -101), 0)
            ),
            "Passed!"
        );
        ok(
            a.intersectsSphere(
                new THREE.Sphere(new THREE.Vector3(0, 0, -101), 1.1)
            ),
            "Passed!"
        );
    });
    ...
    test("at", function() {
        ...
        ok(
            a.at(-1, target).distanceTo(new THREE.Vector3(1, 1, 0)) < 0.0001,
            "Passed!"
        );
        ok(a.at(0, target).distanceTo(one3.clone()) < 0.0001, "Passed!");
        ok(
            a.at(1, target).distanceTo(new THREE.Vector3(1, 1, 2)) < 0.0001,
            "Passed!"
        );
        ok(
            a.at(2, target).distanceTo(new THREE.Vector3(1, 1, 3)) < 0.0001,
            "Passed!"
        );
    });
    ...
    test("closestPointToPoint/closestPointToPointParameter", function() {
        ...
        // nearby the ray
        ok(
            a.closestPointToPointParameter(new THREE.Vector3(1, 1, 5), true) ==
                1,
            "Passed!"
        );
    ...
    test("getInverse", function() {
        ...
        for (var i = 0, il = testMatrices.length; i < il; i++) {
            ...
            ok(
                Math.abs(m.determinant() * mInverse3.determinant() - 1) <
                    0.0001,
                "Passed!"
            );
            ok(
    ...
    test("makeBasis/extractBasis", function() {
        ...
        var a = new THREE.Matrix4().makeBasis(
            identityBasis[0],
            identityBasis[1],
            identityBasis[2]
        );
        ...
        for (var i = 0; i < testBases.length; i++) {
            ...
            var b = new THREE.Matrix4().makeBasis(
                testBasis[0],
                testBasis[1],
                testBasis[2]
            );
        ...
        for (var ti = 0; ti < tValues.length; ti++) {
            for (var si = 0; si < sValues.length; si++) {
                for (var ri = 0; ri < rValues.length; ri++) {
                    ...
                    var m2 = new THREE.Matrix4().compose(
                        t2,
                        r2,
                        s2
                    );
    ...
    test("distanceToPoint", function() {
        ...
        ok(
            a.distanceToPoint(
                a.projectPoint(zero3.clone(), new THREE.Vector3())
            ) === 0,
            "Passed!"
        );
        ok(a.distanceToPoint(new THREE.Vector3(4, 0, 0)) === 3, "Passed!");
    ...
    test("isInterestionLine/intersectLine", function() {
        ...
        var l1 = new THREE.Line3(
            new THREE.Vector3(-10, 0, 0),
            new THREE.Vector3(10, 0, 0)
        );
        ok(a.intersectsLine(l1), "Passed!");
        ok(
            a.intersectLine(l1, target).equals(new THREE.Vector3(0, 0, 0)),
            "Passed!"
        );
        ...
        ok(a.intersectsLine(l1), "Passed!");
        ok(
            a.intersectLine(l1, target).equals(new THREE.Vector3(3, 0, 0)),
            "Passed!"
        );
    ...
    test("projectPoint", function() {
        ...
        ok(
            a.projectPoint(new THREE.Vector3(10, 0, 0), target).equals(zero3),
            "Passed!"
        );
        ok(
            a.projectPoint(new THREE.Vector3(-10, 0, 0), target).equals(zero3),
        ...
        ok(
            a
                .projectPoint(new THREE.Vector3(0, 0, 0), target)
                .equals(new THREE.Vector3(0, 1, 0)),
            "Passed!"
        );
        ok(
            a
                .projectPoint(new THREE.Vector3(0, 1, 0), target)
                .equals(new THREE.Vector3(0, 1, 0)),
            "Passed!"
        );
    });
    ...
    test("orthoPoint", function() {
        ...
        ok(
            a
                .orthoPoint(new THREE.Vector3(10, 0, 0), target)
                .equals(new THREE.Vector3(10, 0, 0)),
            "Passed!"
        );
        ok(
            a
    ...
    test("coplanarPoint", function() {
        var a = new THREE.Plane(new THREE.Vector3(1, 0, 0), 0);
        ok(
            a.distanceToPoint(a.coplanarPoint(new THREE.Vector3())) === 0,
            "Passed!"
        );
    ...
    test("applyMatrix4/translate", function() {
        ...
        ok(
            comparePlane(
                a.clone().applyMatrix4(m),
                a.clone().translate(new THREE.Vector3(1, 1, 1))
            ),
            "Passed!"
        );
    });
    ...
    test("setFromAxisAngle", function() {
        ...
        var a = new THREE.Quaternion().setFromAxisAngle(
            new THREE.Vector3(1, 0, 0),
            0
        );
        ok(a.equals(zero), "Passed!");
        a = new THREE.Quaternion().setFromAxisAngle(
            new THREE.Vector3(0, 1, 0),
            0
        );
        ok(a.equals(zero), "Passed!");
        ...
        var b1 = new THREE.Quaternion().setFromAxisAngle(
            new THREE.Vector3(1, 0, 0),
            Math.PI
        );
        ok(!a.equals(b1), "Passed!");
        var b2 = new THREE.Quaternion().setFromAxisAngle(
            new THREE.Vector3(1, 0, 0),
            -Math.PI
        );
    ...
    test("setFromEuler/setFromQuaternion", function() {
        ...
        for (var i = 0; i < orders.length; i++) {
            for (var j = 0; j < angles.length; j++) {
                ...
                var newAngle = new THREE.Vector3(
                    eulers2.x,
                    eulers2.y,
                    eulers2.z
                );
    ...
    test("intersectSphere", function() {
        ...
        ok(
            a1
                .intersectSphere(b, target)
                .distanceTo(new THREE.Vector3(0, 1, 1)) < TOL,
            "Passed!"
        );
        ...
        ok(
            a0
                .intersectSphere(b, target)
                .distanceTo(new THREE.Vector3(0, 0, -1)) < TOL,
            "Passed!"
        );
        ...
        ok(
            a0
                .intersectSphere(b, target)
                .distanceTo(new THREE.Vector3(0, 0, -3)) < TOL,
            "Passed!"
        );
        ...
        ok(
            a0
                .intersectSphere(b, target)
                .distanceTo(new THREE.Vector3(0, 0, -5)) < TOL,
            "Passed!"
        );
    });
    ...
    test("intersectsPlane", function() {
        ...
        var b = new THREE.Plane().setFromNormalAndCoplanarPoint(
            new THREE.Vector3(0, 0, 1),
            one3.clone().sub(new THREE.Vector3(0, 0, -1))
        );
        ok(a.intersectsPlane(b), "Passed!");

        // parallel plane coincident with origin
        var c = new THREE.Plane().setFromNormalAndCoplanarPoint(
            new THREE.Vector3(0, 0, 1),
            one3.clone().sub(new THREE.Vector3(0, 0, 0))
        );
        ok(a.intersectsPlane(c), "Passed!");

        // parallel plane behind the ray
        var d = new THREE.Plane().setFromNormalAndCoplanarPoint(
            new THREE.Vector3(0, 0, 1),
            one3.clone().sub(new THREE.Vector3(0, 0, 1))
        );
        ...
        var e = new THREE.Plane().setFromNormalAndCoplanarPoint(
            new THREE.Vector3(1, 0, 0),
            one3
        );
        ...
        var f = new THREE.Plane().setFromNormalAndCoplanarPoint(
            new THREE.Vector3(1, 0, 0),
            zero3
        );
    ...
    test("distanceSqToSegment", function() {
        ...
        ok(
            ptOnLine.distanceTo(new THREE.Vector3(1, 1, 50)) < 0.0001,
            "Passed!"
        );
    ...
    test("intersectBox", function() {
        ...
        ok(
            a
                ...
                .distanceTo(new THREE.Vector3(-1, 0, 0)) < TOL,
            "Passed!"
        );
        ...
        ok(
            c.intersectBox(box, target).distanceTo(new THREE.Vector3(1, 0, 0)) <
                TOL,
            "Passed!"
        );
        ...
        ok(
            d.intersectBox(box, target).distanceTo(new THREE.Vector3(0, 1, 0)) <
                TOL,
            "Passed!"
        );
        ...
        ok(
            e
                .intersectBox(box, target)
                .distanceTo(new THREE.Vector3(1, -1, 1)) < TOL,
            "Passed!"
        );
    ...
    test("distanceToPoint", function() {
        ...
        ok(a.distanceToPoint(zero3) - 0.732 < 0.001, "Passed!");
    ...
    test("clampPoint", function() {
        ...
        ok(
            a
                .clampPoint(new THREE.Vector3(1, 1, 3), target)
                .equals(new THREE.Vector3(1, 1, 2)),
            "Passed!"
        );
        ok(
            a
                .clampPoint(new THREE.Vector3(1, 1, -3), target)
                .equals(new THREE.Vector3(1, 1, 0)),
            "Passed!"
        );
    });
    ...
    test("getBoundingBox", function() {
        ...
        ok(
            a.getBoundingBox(target).equals(new THREE.Box3(zero3, two3)),
            "Passed!"
        );

        a.set(zero3, 0);
        ok(
            a.getBoundingBox(target).equals(new THREE.Box3(zero3, zero3)),
            "Passed!"
        );
    });
    ...
    test("applyMatrix4", function() {
        ...
        ok(
            a
                ...
                .equals(a.getBoundingBox(new THREE.Box3()).applyMatrix4(m)),
            "Passed!"
        );
    });
    ...
    test("getMidpoint", function() {
        ...
        ok(
            a.getMidpoint(target).equals(new THREE.Vector3(1 / 3, 1 / 3, 0)),
            "Passed!"
        );
        ...
        ok(
            a.getMidpoint(target).equals(new THREE.Vector3(2 / 3, 0, 2 / 3)),
            "Passed!"
        );
    });
    ...
    test("getPlane", function() {
        ...
        ok(
            a.getPlane(target).normal.equals(a.getNormal(new THREE.Vector3())),
            "Passed!"
        );
        ...
        ok(
            a
                ...
                .normal.clone()
                .normalize()
                .equals(a.getNormal(new THREE.Vector3())),
            "Passed!"
        );
    });
    ...
    test("getBarycoord", function() {
        ...
        ok(
            a.getBarycoord(a.a, target).equals(new THREE.Vector3(1, 0, 0)),
            "Passed!"
        );
        ok(
            a.getBarycoord(a.b, target).equals(new THREE.Vector3(0, 1, 0)),
            "Passed!"
        );
        ok(
            a.getBarycoord(a.c, target).equals(new THREE.Vector3(0, 0, 1)),
            "Passed!"
        );
        ok(
            a
                .getBarycoord(a.getMidpoint(new THREE.Vector3()), target)
                .distanceTo(new THREE.Vector3(1 / 3, 1 / 3, 1 / 3)) < 0.0001,
            "Passed!"
        );
    ...
    test("rounding", function() {
        deepEqual(
            new THREE.Vector2(-0.1, 0.1).floor(),
            new THREE.Vector2(-1, 0),
            "floor .1"
        );
        deepEqual(
            new THREE.Vector2(-0.5, 0.5).floor(),
            new THREE.Vector2(-1, 0),
            "floor .5"
        );
        deepEqual(
            new THREE.Vector2(-0.9, 0.9).floor(),
            new THREE.Vector2(-1, 0),
            "floor .9"
        );

        deepEqual(
            new THREE.Vector2(-0.1, 0.1).ceil(),
            new THREE.Vector2(0, 1),
            "ceil .1"
        );
        deepEqual(
            new THREE.Vector2(-0.5, 0.5).ceil(),
            new THREE.Vector2(0, 1),
            "ceil .5"
        );
        deepEqual(
            new THREE.Vector2(-0.9, 0.9).ceil(),
            new THREE.Vector2(0, 1),
            "ceil .9"
        );

        deepEqual(
            new THREE.Vector2(-0.1, 0.1).round(),
            new THREE.Vector2(0, 0),
            "round .1"
        );
        deepEqual(
            new THREE.Vector2(-0.5, 0.5).round(),
            new THREE.Vector2(0, 1),
            "round .5"
        );
        deepEqual(
            new THREE.Vector2(-0.9, 0.9).round(),
            new THREE.Vector2(-1, 1),
            "round .9"
        );

        deepEqual(
            new THREE.Vector2(-0.1, 0.1).roundToZero(),
            new THREE.Vector2(0, 0),
            "roundToZero .1"
        );
        deepEqual(
            new THREE.Vector2(-0.5, 0.5).roundToZero(),
            new THREE.Vector2(0, 0),
            "roundToZero .5"
        );
        deepEqual(
            new THREE.Vector2(-0.9, 0.9).roundToZero(),
            new THREE.Vector2(0, 0),
            "roundToZero .9"
        );
        deepEqual(
            new THREE.Vector2(-1.1, 1.1).roundToZero(),
            new THREE.Vector2(-1, 1),
            "roundToZero 1.1"
        );
        deepEqual(
            new THREE.Vector2(-1.5, 1.5).roundToZero(),
            new THREE.Vector2(-1, 1),
            "roundToZero 1.5"
        );
        deepEqual(
            new THREE.Vector2(-1.9, 1.9).roundToZero(),
            new THREE.Vector2(-1, 1),
            "roundToZero 1.9"
        );
    });
    ...
    test("projectOnVector", function() {
        ...
        ok(
            b
                ...
                .equals(new THREE.Vector3(1, 0, 0)),
            "Passed!"
        );
    ...
    test("angleTo", function() {
        ...
        ok(
            Math.abs(x.angleTo(new THREE.Vector3(1, 1, 0)) - Math.PI / 4) <
                0.0000001
        );
    });
