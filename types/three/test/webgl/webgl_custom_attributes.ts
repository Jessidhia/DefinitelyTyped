...
() => {
    ...
    var sphere: THREE.Mesh,
        uniforms: {
            amplitude: { type: string; value: number };
            color: { type: string; value: THREE.Color };
            texture: { type: string; value: THREE.Texture };
        };
    ...
    function init() {
        ...
        uniforms.texture.value.wrapS = uniforms.texture.value.wrapT =
    ...
    function render() {
        ...
        ((sphere.geometry as THREE.BufferGeometry).getAttribute(
            "displacement"
