...
var sortedByName: KnockoutObservableArray<Person> = persons.sortBy(function(
    person
) {
    return person.name();
});
...
var sortedByYearOfBirthAndThenName: KnockoutObservableArray<
    Person
...
var squareIndex: KnockoutObservable<{
    [index: string]: number[];
...
var personsIndexedByName: KnockoutObservable<{
    [name: string]: Person;
...
// Index texts by
var indexedTexts: KnockoutObservable<{
    [suffixOrPrefix: string]: string[];
