...
declare namespace Vex {
    ...
    namespace Flow {
        ...
        class Stave {
            ...
            setConfigForLines(
                lines_configuration: { visible: boolean }[]
            ): Stave;
        }
        ...
        namespace StaveLine {
            const enum TextVerticalPosition {
                TOP = 1,
                BOTTOM
            }
            const enum TextJustification {
                LEFT = 1,
                CENTER,
                RIGHT
            }
        ...
        class Tuplet {
            constructor(
                notes: StaveNote[],
                options?: { num_notes?: number; beats_occupied?: number }
            );
            attach(): void;
            detach(): void;
