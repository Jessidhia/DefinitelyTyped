...
export declare module ServiceSettings {
     ...
     */
    export function parseAndValidateKeys(
        connectionString: string,
        validKeys: string[]
    ): string[];
     ...
     */
    export function settingWithFunc(
        name: string,
        predicate: Function
    ): Requirement[];
...
export declare module Validate {
    ...
    export function namespaceNameIsValid(
        name: string,
        callback: ErrorCallback
    ): boolean;
    ...
    export function containerNameIsValid(
     ...
     */
    export function blobNameIsValid(
        containerName: string,
        blob: string
    ): boolean;
    export function blobNameIsValid(
    ...
    export function tableNameIsValid(
        tableName: string,
        callback: ErrorCallback
    ): boolean;
    ...
    export function queueNameIsValid(
        queueName: string,
        callback: ErrorCallback
    ): boolean;
...
export interface StorageServiceStatsCallback
    extends StorageCallback<StorageServiceStats> {}
export interface StorageServicePropertiesCallback
    extends StorageCallback<StorageServiceProperties> {}
...
export interface QueryEntitiesResultContinuation
...
export interface GetContainerMetadataOptions
