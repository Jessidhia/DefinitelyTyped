namespace adoneTests.collection.RedBlackTree {
    ...
    type RedBlackTreeIterator<
        K = any,
        V = any
    > = adone.collection.I.RedBlackTree.Iterator<K, V>;
    type RedBlackTreeNode<
        K = any,
        V = any
    > = adone.collection.I.RedBlackTree.Node<K, V>;

    new RedBlackTree();
    new RedBlackTree<string, number>(
    ...
    {
        const a: RedBlackTreeIterator<string, number> = new RedBlackTree<
            string,
            number
        >().begin;
        {
    ...
    {
        const a: RedBlackTree<string, number> = new RedBlackTree<
            string,
            number
        >().insert("123", 456);
    }
    {
        const a: number = new RedBlackTree<string, number>().forEach(
    ...
    {
        const a: RedBlackTreeIterator<string, number> | null = new RedBlackTree<
            string,
            number
        >().find("1");
    }
    ...
    {
        const a: number | undefined = new RedBlackTree<string, number>().get(
            "1"
        );
    }
}
