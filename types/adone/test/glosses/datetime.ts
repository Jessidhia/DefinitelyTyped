namespace datetimeTests {
    ...
    {
        const a: string = datetime.locale("he", {
            meridiem: (hour: number, minute: number, isLower: boolean) => "ba"
        });
    }
    {
    ...
    }
    {
        ...
        const b: string = datetime.locale("he", {
            weekDays: (d: adone.I.datetime.Datetime, f?: string) =>
                d.clone() && "123"
        });
    }
    ...
    }
    {
        ...
        const b: string = datetime.locale("he", {
            weekdaysMin: (d: adone.I.datetime.Datetime, f?: string) =>
                d.clone() && "123"
        });
    }
    ...
    }
    {
        ...
        const b: string = datetime.locale("he", {
            weekdaysShort: (d: adone.I.datetime.Datetime, f?: string) =>
                d.clone() && "123"
        });
    }
    ...
    {
        const a: adone.I.datetime.Datetime = datetime.parseZone(
            1230,
            "DD",
            false
        );
    ...
    {
        const a: adone.I.datetime.Datetime = adone.datetime.min(
            adone.datetime(),
            adone.datetime()
        );
    }
    {
        const a: adone.I.datetime.Datetime = adone.datetime.max(
            adone.datetime(),
            adone.datetime()
        );
    }
    ...
    {
        const a: adone.I.datetime.Locale = adone.datetime.defineLocale(
            "he",
            {}
        );
    ...
    {
        const a: boolean = adone.datetime.relativeTimeRounding(
            (x: number) => 123
        );
    }
