declare namespace adone {
    ...
    namespace fs {
        ...
        class Directory {
            ...
            addFile(
                a: string,
                ...filename: Array<Array<string | I.Directory.AddFileOptions>>
            ): Promise<File>;
            ...
            files(): Promise<
                Array<
                    File | Directory | SymbolicLinkFile | SymbolicLinkDirectory
                >
            >;
        ...
        class RandomAccessFile extends event.Emitter {
            constructor(
                filename: string,
                options?: I.RandomAccessFile.ConstructorOptions
            );
        ...
        namespace I.Glob {
            ...
            interface StreamConstructor {
                new (
                    ...
                    options: StreamOptions & { stat: true; patternIndex: true }
                ): Stream<{
                    path: string;
                    stat: Stats;
                    patternIndex: number;
                ...
                new (
                    patterns: string | string[],
                    options: StreamOptions & { stat: true }
                ): Stream<{
                    path: string;
                    stat: Stats;
                }>;
                new (
                    patterns: string | string[],
                    options: StreamOptions & { patternIndex: true }
                ): Stream<{
                    path: string;
                    patternIndex: number;
                }>;
            ...
            interface EmitterConstructor {
                new (
                    pattern: string,
                    optons: Options,
                    callback?: (error: any, matches: string[]) => void
                ): Emitter;
                new (
                    pattern: string,
                    callback?: (error: any, matches: string[]) => void
            ...
            interface Emitter extends event.Emitter {
                ...
                on(
                    event: "match",
                    callback: (match: string, stat?: Stats) => void
                ): this;
            ...
            interface GlobFunction {
                ...
                (patterns: string | string[], options?: StreamOptions): Stream<
                    string
                >;
        ...
        class Watcher extends event.Emitter {
            ...
            on(
                event: "raw",
                callback: (event: string, path: string, details: object) => void
            ): this;
            on(
                event: I.Watcher.Event,
                callback: (path: string, stat?: I.Stats) => void
            ): this;
        }
        ...
        function watch(
            paths: string | string[],
            options?: I.Watcher.ConstructorOptions
        ): Watcher;
        ...
        function which(
            cmd: string,
            options: I.Which.OptionsAllNothrow
        ): Promise<string[] | null>;
        ...
        function which(
            cmd: string,
            options: I.Which.OptionsNothrow
        ): Promise<string | null>;
        ...
        function flock(
            fd: I.FD,
            flags: "sh" | "ex" | "shnb" | "exnb" | "un" | number
        ): Promise<void>;
        ...
        function createReadStream(
            path: null | undefined,
            options: I.ReadStreamOptionsFD
        ): I.ReadStream;
        function createReadStream(
            path: string | Buffer | I.URL,
            options?: I.ReadStreamOptions
        ): I.ReadStream;
        function createReadStream(
            path: string | Buffer | I.URL,
            encoding: I.Encoding | null
        ): I.ReadStream;
        ...
        function createWriteStream(
            path: null | undefined,
            options: I.WriteStreamOptionsFD
        ): I.WriteStream;
        function createWriteStream(
            path: string | Buffer | I.URL,
            options?: I.WriteStreamOptions
        ): I.WriteStream;
        function createWriteStream(
            path: string | Buffer | I.URL,
            encoding: I.Encoding | null
        ...
        class TailWatcher extends event.Emitter {
            constructor(
                filename: string,
                options?: I.TailWatcher.ConstructorOptions
            );
