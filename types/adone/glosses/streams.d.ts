    ...
    namespace stream {
        namespace core {
            namespace I {
                ...
                type TransformFunction<S, T> = (
                    this: TransformContext<T>,
                    value: S
                ) => void;
            ...
            class Stream<S = any, T = S> implements PromiseLike<T[]> {
                 ...
                 */
                throughSync<R>(
                    transform: I.TransformFunction<T, R>,
                    flush?: I.FlushFunction<R>
                ): Stream<S, R>;
                 ...
                 */
                filter(
                    callback: (value: T) => boolean | Promise<boolean>
                ): this;
                ...
                static merge<S = any, T = S>(
                    streams: Array<
                        | Stream<any, any>
                        | nodestd.stream.Transform
                        | nodestd.stream.Readable
                        | nodestd.stream.Duplex
                    >,
                    options?: {
                        /**
                 ...
                 */
                    ...
                    onReject?: (reason: any) => T1 | PromiseLike<T1>
                ): Promise<T[] | T1>;
            }
