...
const selectedGeometries: Array<
...
const featurePolygonWithProp: GeoJSON.Feature<
    GeoJSON.Polygon,
    TestProp
...
const propColor = topojson.feature(topoWithProp, topoWithProp.objects.foo)
    .properties;
color = propColor.color;
size = propColor.size;

const propName = topojson.feature(topoWithProp, topoWithProp.objects.bar)
    .properties;
