...
const htmlWithCallback: d3Request.Request = d3Request.html(url, function(
    error,
    data
) {
    const that: d3Request.Request = this;
...
const textWithCallback: d3Request.Request = d3Request.text(url, function(
    error,
    data
) {
    const that: d3Request.Request = this;
...
const xmlWithCallback: d3Request.Request = d3Request.xml(url, function(
    error,
    data
) {
    const that: d3Request.Request = this;
...
const csvRequestWithRowWithCallback: d3Request.DsvRequest = d3Request.csv<
    ResponseDatumGET
>(
    url,
...
// url, row mapping function and callback for response handling
const tsvRequestWithRowWithCallback: d3Request.DsvRequest = d3Request.tsv<
    ResponseDatumGET
>(
    url,
    (rawRow, index, columns) => {
