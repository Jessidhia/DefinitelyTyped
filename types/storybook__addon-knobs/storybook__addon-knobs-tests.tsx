...
stories.add("with all knobs", () => {
    ...
    const radioStation = radios("Favorite Radio Station", {
        1100: "1100",
        2200: "2200",
        3300: "3300"
    });
    ...
    const genericObject: string = object<string>(
        "Some generic object",
        "value"
    );
    ...
    const genericSelectV2: X = select<X>(
        "Some generic select",
        { "type a": "a", "type b": "b" },
        "b"
    );
    ...
    const genericArray: string[] = array<string>("Some generic array", [
        "red",
        "green",
        "blue"
    ]);

    const genericKnob: X = knob<X>("Some generic knob", {
        value: "a",
        type: "text"
    });
    ...
    return (
        <div style={style}>
            ...
            <p>
                My most comfortable room temperature is {comfortTemp} degrees
                Fahrenheit.
            </p>
...
userInputArray.push(
    "Make sure that the output is still mutable although the input need not be!"
);
