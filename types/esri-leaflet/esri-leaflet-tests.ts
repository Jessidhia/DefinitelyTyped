...
featureLayerOptions = {
    url:
        "https://services.arcgis.com/rOo16HdIMeOBI4Mb/arcgis/rest/services/stops/FeatureServer/0/"
};
featureLayerOptions = {
    url:
        "https://services.arcgis.com/rOo16HdIMeOBI4Mb/arcgis/rest/services/stops/FeatureServer/0/",
...
featureLayerServiceOptions = {
    url:
        "https://sampleserver6.arcgisonline.com/arcgis/rest/services/WorldTimeZones/MapServer/0",
    proxy: "//localhost/proxy",
    useCors: true,
    timeout: 1000
};
