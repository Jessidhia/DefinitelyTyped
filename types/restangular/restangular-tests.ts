...
myApp.config((RestangularProvider: restangular.IProvider) => {
    ...
    RestangularProvider.addElementTransformer("accounts", false, function(
        elem: any
    ) {
...
myApp.controller(
    ...
    ($scope: MyAppScope, Restangular: restangular.IService) => {
        ...
        Restangular.addElementTransformer("accounts", false, function(
            elem: any
        ) {
            elem.accountName = "Changed";
            return elem;
        ...
        var myRestangular = Restangular.withConfig(
            (configurer: restangular.IProvider) => {
                ...
                configurer.setRequestInterceptor(function(
                    element,
                    operation,
                    route,
                    url
                ...
                configurer.addElementTransformer("accounts", false, function(
                    elem: any
                ) {
                    elem.accountName = "Changed";
                    return elem;
