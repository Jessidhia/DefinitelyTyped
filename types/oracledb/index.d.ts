...
declare namespace oracledb {
    ...
    interface IConnection extends events.EventEmitter {
        ...
        execute(
            ...
            callback: (err: any, value: IExecuteReturn) => void
        ): void;
    ...
    interface IConnectionPool extends events.EventEmitter {
         ...
         */
        getConnection(
            callback: (err: any, connection: IConnection) => void
        ): void;
    ...
    function createPool(
        ...
        callback: (err: any, connection: IConnectionPool) => void
    ): void;
