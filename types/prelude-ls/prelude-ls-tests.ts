...
var eachRes: Array<Array<string>> = prelude.each(x => x.push("boom"), [
    ["a"],
    ["b"],
    ["c"]
]);
...
var partitionRes: Array<Array<number>> = prelude.partition(x => x > 60, [
    49,
    58,
    76,
    43,
...
var uniqueByRes: Array<string> = prelude.uniqueBy(x => x.length, [
    "and",
    "here",
    "are",
    "some",
...
var unfoldrRes: Array<number> = prelude.unfoldr(
    x => (x === 0 ? null : [x, x - 1]),
    10
);
...
var concatMapRes: Array<any> = prelude.concatMap(x => ["hoge", x, x + 2], [
    1,
    2,
    3
]);
...
var intersectionRes: Array<number> = prelude.intersection(
    [1, 2, 3],
    [101, 2, 1, 10],
    [2, 1],
    [-1, 0, 1, 2]
...
var sortByRes: Array<string> = prelude.sortBy(x => x.length, [
    "there",
    "hey",
    "a",
    "ha"
...
var maximumByRes: string = prelude.maximumBy(x => x.length, [
    "hi",
    "there",
    "I",
    "am",
...
var takeWhileRes: Array<number> = prelude.takeWhile(prelude.odd, [
    1,
    3,
    5,
    4,
...
var breakListRes: Array<Array<number>> = prelude.breakList(x => x == 3, [
    1,
    2,
    3,
    4,
...
var zipWithRes: Array<number> = prelude.zipWith(
    x => y => x + y,
    [1, 2, 3],
    [4, 5, 6]
); //=> [5, 7, 9]

var zipAllRes: Array<Array<number>> = prelude.zipAll(
    [1, 2, 3],
    [4, 5, 6],
    [7, 8, 9]
); //=> [[1, 4, 7], [2, 5, 8], [3, 6, 9]]

var zipAllWithRes: Array<number> = prelude.zipAllWith(
    (a, b, c) => a + b + c,
    [1, 2, 3],
    [3, 2, 1],
    [1, 1, 1]
...
var elemIndicesRes: Array<number> = prelude.elemIndices("a", [
    "c",
    "a",
    "b",
    "a"
...
var findIndicesRes: Array<number> = prelude.findIndices(prelude.even, [
    1,
    2,
    3,
    4
...
var fixRes: number = prelude.fix((fib: (n: number) => number) => (n: number) =>
