...
pThrottle((n: number, s: string, b: boolean, n2: number) => true, 2, 3)(
    1,
    "s",
    true,
    1
...
pThrottle(
    (n: number, s: string, b: boolean, n2: number, s2: string) => true,
    2,
    3
).abort();
pThrottle(
...
pThrottle(
    (n: number, s: string, b: boolean, n2: number, s2: string, b2: boolean) =>
        true,
    2,
    3
).abort();
