...
interface EnumeratorConstructor {
    ...
    new (col: InfoPath.DataObjectsCollection): Enumerator<
        InfoPath.DataSourceObject
    >;
    new (col: InfoPath.ErrorsCollection): Enumerator<ADODB.Error>;
    new (col: InfoPath.InputParameterCollection): Enumerator<
        InfoPath.InputParameterObject
    >;
    new (col: InfoPath.PermissionObject): Enumerator<
        InfoPath.UserPermissionObject
    >;
    new (col: InfoPath.SignatureLinesCollection): Enumerator<
        InfoPath.SignatureLineObject
    >;
    new (col: InfoPath.SignaturesCollection): Enumerator<
        InfoPath.SignatureObject
    >;
    new (col: InfoPath.SignedDataBlocksCollection): Enumerator<
        InfoPath.SignedDataBlockObject
    >;
    new (col: InfoPath.TaskPanesCollection): Enumerator<
        InfoPath.TaskPaneObject
    >;
    new (col: InfoPath.ViewInfosCollection): Enumerator<
        InfoPath.ViewInfoObject
    >;
    new (col: InfoPath.WindowsCollection): Enumerator<InfoPath.Window>;
    new (col: InfoPath.XDocuments | InfoPath.XDocumentsCollection): Enumerator<
        InfoPath._XDocument
    >;
