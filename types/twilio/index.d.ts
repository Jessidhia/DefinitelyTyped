...
declare namespace twilio {
    ...
    export interface CreatableMappedResource<T>
        extends MappedResource<T>,
            PostableResource {
        create: RestMethod;
    }

    export interface ListMappedResource<T>
        extends CreatableMappedResource<T>,
            ListableResource {}
    ...
    export interface AccountResource
        extends AccountInstance,
            ListMappedResource<AccountInstance> {}
    ...
    export interface AvailablePhoneNumberResource
        extends BaseMappedResource<AvailablePhoneNumberInstance> {}
    ...
    export interface CallFeedbackSummaryResource
        extends BaseMappedResource<CallFeedbackSummaryInstance> {
        post: RestMethod;
        create: RestMethod;
    }
    export interface CallResource
        extends CreatableMappedResource<CallInstance>,
            ListableResource {
    ...
    export interface ConferenceResource
        extends MappedResource<ConferenceInstance>,
            ListableResource {}
    ...
    export interface IncomingPhoneNumberResource
        extends CreatableMappedResource<IncomingPhoneNumberInstance> {
    ...
    export interface MessageMediaResource
        extends MappedResource<MessageMediaInstance>,
            ListableResource {}
    ...
    export interface MessageResource
        extends ListMappedResource<MessageInstance> {}
    ...
    export interface QueueMemberResource
        extends MappedResource<QueueMemberInstance> {
    ...
    export interface QueueResource
        extends CreatableMappedResource<QueueInstance> {}
    ...
    export interface RecordingResource
        extends MappedResource<RecordingInstance>,
            ListableResource {}
    ...
    export interface UsageRecordResource
        extends MappedResource<UsageRecordInstance> {
    ...
    export interface CredentialResource
        extends ListMappedResource<CredentialInstance> {}
    ...
    export interface ServiceChannelResource
        extends ListMappedResource<ServiceChannelInstance> {}
    ...
    export interface ServiceResource
        extends ListMappedResource<ServiceInstance> {}
    ...
    export interface NumberResource
        extends MappedResource<NumberInstance>,
            ListableResource {}
    ...
    export interface CredentialListResource
        extends ListMappedResource<CredentialListInstance> {}
    ...
    export interface CredentialListMappingResource
        extends ListMappedResource<CredentialListMappingInstance> {}
    ...
    export interface DomainResource
        extends ListMappedResource<DomainInstance> {}
    ...
    export interface IPAddressResource
        extends ListMappedResource<IPAddressInstance> {}
    ...
    export interface IPAccessControlListResource
        extends ListMappedResource<IPAccessControlListInstance> {}
    ...
    export interface WorkspaceActivityResource
        extends ListMappedResource<WorkspaceActivityInstance> {}

    export interface WorkspaceEventInstance extends Resource {}
    export interface WorkspaceEventResource
        extends MappedResource<WorkspaceEventInstance>,
            ListableResource {}
    ...
    export interface WorkspaceTaskResource
        extends ListMappedResource<WorkspaceTaskInstance> {}
    ...
    export interface WorkspaceTaskQueueResource
        extends ListMappedResource<WorkspaceTaskQueueInstance> {
    ...
    export interface WorkspaceWorkerResource
        extends ListMappedResource<WorkspaceWorkerInstance> {
        statistics: WorkspaceStatisticResource;
    }
    ...
    export interface WorkspaceWorkflowResource
        extends ListMappedResource<WorkspaceWorkflowInstance> {
        statistics: WorkspaceStatisticResource;
    }
    ...
    export interface WorkspaceResource
        extends CreatableMappedResource<WorkspaceInstance> {}
    ...
    export interface OriginationURLResource
        extends ListMappedResource<OriginationURLInstance> {}
