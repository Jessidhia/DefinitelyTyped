...
requestHandler = httpBackendService.expect("GET", /test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.expectPATCH(/test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.expectPOST(/test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.expectPUT("http://test.local", function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.expectPUT(/test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.when("GET", /test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPATCH("http://test.local", function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPATCH(/test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPOST("http://test.local", function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPOST(/test.local/, function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPUT("http://test.local", function(
    data: string
): boolean {
    return true;
});
...
requestHandler = httpBackendService.whenPUT(/test.local/, function(
    data: string
): boolean {
    return true;
});
