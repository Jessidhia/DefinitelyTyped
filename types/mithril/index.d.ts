...
): (e: { currentTarget: any; [p: string]: any }) => void;
/** Creates an event handler which takes the value of the specified DOM element property and calls a function with it as the argument. */
declare function withAttr<T>(
    name: string,
    callback: (this: T, value: any) => any,
    thisArg: T
): (e: { currentTarget: any; [p: string]: any }) => void;
...
declare namespace Mithril {
    ...
    interface Hyperscript {
        ...
        <Attrs, State>(
            component: ComponentTypes<Attrs, State>,
            attributes: Attrs &
                Lifecycle<Attrs, State> & { key?: string | number },
            ...args: Children[]
        ): Vnode<Attrs, State>;
    ...
    interface Route {
        ...
        ): (vnode: Vnode<any, any>) => (e?: Event) => any;
    ...
    interface VnodeDOM<Attrs = {}, State extends Lifecycle<Attrs, State> = {}>
    ...
    type Comp<
        Attrs = {},
        State extends Lifecycle<Attrs, State> = {}
