...
function divide() {
    const argv = yargs.usage("Usage: $0 -x [num] -y [num]").demand(["x", "y"])
        .argv;
...
function Argv$version() {
    ...
    const argv3 = yargs.version("1.0.0", "--version");

    const argv4 = yargs.version("1.0.0", "--version", "description");

    const argv5 = yargs.version(() => "1.0.0", "--version", "description");
}
...
function Argv$skipValidation() {
    const ya = yargs.skipValidation("arg1").skipValidation(["arg2", "arg3"])
        .argv;
}

function Argv$commandObject() {
    const ya = yargs.command("commandname", "description", {
        arg: {
            alias: "string",
            array: true,
            boolean: true,
