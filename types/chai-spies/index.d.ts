...
declare namespace ChaiSpies {
    ...
    interface Spy {
        ...
        <A1, A2, A3, R>(fn: SpyFunc3<A1, A2, A3, R>): SpyFunc3Proxy<
            A1,
            A2,
            A3,
            R
        >;
        <A1, A2, A3, A4, R>(fn: SpyFunc4<A1, A2, A3, A4, R>): SpyFunc4Proxy<
            A1,
            A2,
            A3,
            A4,
        ...
        <A1, A2, R>(name: string, fn: SpyFunc2<A1, A2, R>): SpyFunc2Proxy<
            A1,
            A2,
            R
        >;
