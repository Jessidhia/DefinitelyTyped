...
unauthorizedError1.output.payload.attributes ===
    { some: "attribute", error: "message" };
unauthorizedError1.output.headers ===
    { "WWW-Authenticate": 'scheme some="attribute", error="message"' };
...
unauthorizedError3.output.headers ===
    { "WWW-Authenticate": "scheme attribute" };

const unauthorizedError4 = Boom.unauthorized(null, "scheme", {
    some: "attribute"
});
unauthorizedError4.output.payload.attributes === { some: "attribute" };
unauthorizedError4.output.headers ===
    { "WWW-Authenticate": 'scheme some="attribute"' };
...
const proxyAuthRequiredError2: Boom.BoomError = Boom.proxyAuthRequired(
    "message"
);
...
const preconditionFailedError2: Boom.BoomError = Boom.preconditionFailed(
    "message"
);
...
const unsupportedMediaTypeError2: Boom.BoomError = Boom.unsupportedMediaType(
    "message"
);
...
const rangeNotSatisfiableError2: Boom.BoomError = Boom.rangeNotSatisfiable(
    "message"
);
...
const expectationFailedError2: Boom.BoomError = Boom.expectationFailed(
    "message"
);
...
const preconditionRequiredError2: Boom.BoomError = Boom.preconditionRequired(
    "message"
);
...
const badImplementationError2: Boom.BoomError = Boom.badImplementation(
    "message"
);
...
const serverUnavailableError2: Boom.BoomError = Boom.serverUnavailable(
    "message"
);
