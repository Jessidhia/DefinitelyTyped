...
class MultiSortAndFiltering extends React.Component {
    ...
    afterColumnFilter = (
        ...
        for (const resultItem of result) {
            console.log(
                `Product: ${resultItem.id}, ${resultItem.name}, ${
                    resultItem.price
                }`
            );
        }
...
class MyCustomBody extends React.Component<MyCustomBodyProps>
 ...
 */
class MySearchField extends React.Component<SearchFieldProps>
...
class ExpandRowExample extends React.Component<{}, { expanding: number[] }> {
    ...
    handleExpand = (rowKey: number, isExpand: boolean) => {
        if (isExpand) {
            ...
            this.setState({
                expanding: [...this.state.expanding.filter(id => id !== rowKey)]
            });
        }
    };
    ...
    onSelect = (
        ...
        const rowStr = `id: "${row.id}", name: ${row.name}, price: ${
            row.price
        }`;
        console.log(e);
