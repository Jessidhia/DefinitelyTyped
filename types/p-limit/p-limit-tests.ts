...
limit(b, "test", 1).then(v => {
    str = v;
});
limit(c, "test", 1, false).then(v => {
    str = v;
});
limit(d, "test", 1, false, Symbol("test")).then(v => {
    str = v;
});
limit(e, "test", 1, false, Symbol("test"), "no").then(v => {
    str = v;
});
limit(f, "test", 1, false, Symbol("test"), "no", 2).then(v => {
    str = v;
});
limit(g, "test", 1, false, Symbol("test"), "no", 2, true).then(v => {
    str = v;
});
