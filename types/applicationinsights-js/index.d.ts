...
declare module Microsoft.ApplicationInsights.Telemetry {
    ...
    class PageView extends AI.PageViewData
    ...
    class PageViewPerformance extends AI.PageViewPerfData
        implements Microsoft.ApplicationInsights.ISerializable {
        static envelopeType: string;
        static dataType: string;
        aiDataContract: {
    ...
    class RemoteDependencyData extends AI.RemoteDependencyData
        implements Microsoft.ApplicationInsights.ISerializable {
        static envelopeType: string;
        static dataType: string;
        aiDataContract: {
    ...
    class Trace extends AI.MessageData
        implements Microsoft.ApplicationInsights.ISerializable {
        static envelopeType: string;
        static dataType: string;
        aiDataContract: {
...
declare module Microsoft.ApplicationInsights.Telemetry.Common {
    class Base extends Microsoft.Telemetry.Base
        implements Microsoft.ApplicationInsights.ISerializable {
        /**
