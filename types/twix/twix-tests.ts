...
moment()
    ...
    .isValid(); //=> true
moment()
    .twix(moment().add(1, "day"))
    .isValid(); //=> true
moment()
    .twix(moment().subtract(1, "day"))
    .isValid(); //=> false

moment("1982-05-25T05:00")
    .twix("1982-05-26T06:00")
    .isSame("day"); //=> false
moment("1982-05-25T05:00")
    .twix("1982-05-25T06:00")
    .isSame("day"); //=> true
moment("1982-05-25T05:00")
    .twix("1982-05-25T06:00")
    .isSame("year"); //=> true
...
moment("2054-05-25")
    .twix(moment().add(1, "hour"))
    .isCurrent(); //=> true

moment("1982-05-25")
    .twix("1982-05-28")
    .contains("1982-05-26"); //=> true

moment("1982-05-25T5:30")
    .twix("1982-05-25T6:30")
    .length("hours"); //=> 1
moment("1982-05-25T5:00")
    .twix("1982-05-30T6:00")
    .length("days"); //=> 6

moment("1982-05-25T5:00")
    .twix("1982-05-25T6:00")
    .count("days"); //=> 1
moment("1982-05-25T5:00")
    .twix("1982-05-26T6:00")
    .count("days"); //=> 2

moment("1982-05-25T5:00")
    .twix("1982-05-25T6:00")
    .countInner("days"); //=> 0
moment("1982-05-24T5:00")
    .twix("1982-05-26T6:00")
    .countInner("days"); //=> 1

var iter = moment("1982-05-25T5:00")
    .twix("1982-05-26T6:00")
    .iterate("days");
iter.hasNext(); //=> true
...
moment("1982-01-25T09:00")
    .twix("1982-01-25T11:00")
    .format(); //=> 'Jan 25, 1982, 9 - 11 AM'
moment("1982-01-25T9:00")
    .twix("1982-01-26T13:00")
    .format(); //=> 'Jan 25, 9 AM - Jan 26, 1 PM, 1982'

moment("2012-01-25")
    .twix("2012-01-25", { allDay: true })
    .format(); //=> Jan 25
moment("1982-01-25")
    .twix("1982-01-25", { allDay: true })
    .format(); //=> Jan 25, 1982
moment("2012-01-25")
    .twix("2012-01-26", { allDay: true })
    .format(); //=> Jan 25 - 26
moment("1982-01-25")
    .twix("1982-02-25", { allDay: true })
    .format(); //=> Jan 25 - Feb 25, 1982
moment("1982-01-25")
    .twix(new Date(), { allDay: true })
    .format(); //=> Jan 25, 1982 - Jan 9, 2012

moment("1982-01-25T9:30")
    .twix("1/25/1982 1:30 PM")
    .format(); //=> Jan 25, 1982, 9:30 AM - 1:30 PM
moment("1982-01-25T9:30")
    .twix(new Date())
    .format(); //=> Jan 25, 1982, 9:30 AM - Jan 9, 2012, 3:05 AM
moment("1982-01-25")
    .twix("1982-01-27")
    .format(); //=> Jan 25, 12 AM - Jan 27, 12 AM, 1982
...
moment("2012-01-25T8:00")
    .twix("2012-01-25T17:00")
    .format({
        monthFormat: "MMMM",
        dayFormat: "Do"
    });
...
moment("2012-05-25T8:00")
    .twix("2012-05-25T17:00")
    .format({ showDate: false }); //=> 8 AM - 5 PM
...
moment.lang("fr");
moment()
    .twix(moment().add(3, "month"))
    .simpleFormat("MMMM"); //=> 'juillet - octobre'

moment("1982-05-25")
    .twix(moment("1982-05-27"))
    .format(); //=> '25 mai, 0:00 - 27 mai, 0:00, 1982'
