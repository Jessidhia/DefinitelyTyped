                ...
                WL.login({
                    ...
                    function(response) {
                        WL.backgroundDownload({
                            path:
                                "file.8c8ce076ca27823f.8C8CE076CA27823F!129/picture?type=thumbnail",
                            file_output: file
                        }).then(
                            function(response) {
    ...
    data: [
        {
            ...
            count: 4,
            link:
                "https://cid-8c8ce076ca27823f.skydrive.live.com/redir.aspx?page\u003dself\u0026resid\u003d8C8CE076CA27823F!126\u0026type\u003d5",
            type: "album",
            shared_with: {
    ...
    data: [
        {
            ...
            is_embeddable: false,
            source:
                "http://storage.live.com/s1p60U8Xs4UzIXTScrTioalE-ZaVFiDQBA15MS2BwcsuNjfG64Z2fw-DAjXnPuqC47YR40_xAoPD8aRGhtna9ZFZ9_oO4BTz4CWF973DTXMxc5U3TntcQ9qEA/SampleAudio.mp3:Binary",
            link:
                "https://skydrive.live.com/redir.aspx?cid\u003d22688711f5410e6c\u0026page\u003dview\u0026resid\u003d22688711F5410E6C!582\u0026parid\u003d22688711F5410E6C!581",
            type: "audio",
...
var calendarCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.ICalendar
> = {
    data: [
        {
...
var commentCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.IComment
> = {
    data: [
        {
            id:
                "comment.22688711f5410e6c.22688711f0410e6c!818.22688711F5410E6C!979",
            from: {
                name: "Roberto Tamburello",
                id: "8c8ce076ca27823f"
            },
...
var contactCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.IContact
> = {
    data: [
        {
...
var eventI: Microsoft.Live.IEvent = {
    id:
        "event.611afb17fa9448f28cdb8277e8ffeb77.e9f015000d0249ce847c5306a25d7d75",
    ...
    data: [
        {
            ...
            is_embeddable: false,
            source:
                "http://storage.live.com/s1pEwo9qzyT4_BJZqMNm-aVzgLo-WRsQGzjzFsXjyREuQG5pDYr237vKz3i2pmqFuniYPzsuIZAOCUMB_gdfKCUpLpVcaAMXGrk4T7jOWenRniCv9vex7GWfSvy-XCVBVnU/Processing.docx:Binary",
            link:
                "https://skydrive-df.live.com/redir.aspx?cid\u003d22688711f5410e6c\u0026page\u003dview\u0026resid\u003d22688711F5410E6C!942\u0026parid\u003d22688711F5410E6C!479",
            type: "file",
            shared_with: {
                access: "Everyone (public)"
            },
...
var newFileResponse: Microsoft.Live.INewFileResponse = {
    ...
    name: "MyNewFile.txt",
    source:
        "http://storage.live.com/s1pasGKzgXFvuEQCbxGtOyIpboUVH1OCHoRzUJNDDwL0zVoidb0RRrNVk88hUrOEve5OMT7eCkuxPbop7dV9tMJQ-eE8SCQ28vFv9ZgPnDGwQMRm-0FeG3-KEY4HL9dQSw9/MyNewFile.txt:Binary,Default/MyNewFile.txt"
};

var folderCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.IFolder
> = {
    data: [
        {
            ...
            count: 3,
            link:
                "https://cid-8c8ce076ca27823f.skydrive.live.com/redir.aspx?page\u003dself\u0026resid\u003d8C8CE076CA27823F!142\u0026parid\u003d8C8CE076CA27823F!126\u0026type\u003d5",
            type: "folder",
            shared_with: {
                access: "Just me"
            },
...
var friendCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.IFriend
> = {
    data: [
        {
            id: "d09ea18fafc39a0c",
...
var permissionsCollection: Microsoft.Live.IObjectCollection<
    Microsoft.Live.IPermissions
> = {
    data: [
        {
            "wl.basic": 1,
    ...
    data: [
        {
            ...
            source:
                "http://storage.live.com/s1pKk5vzd-gdPanbzKYhB0nQGn8wGq5DSgqvrgIHU1NTXA4e2-spGkAhQjW1d9pcgKAGLB4NsEsSvDoREmdx5w-JiFrinEJJuEoz08Ws_IFupkX2bPSvy5qmths9ijwvDrXi1OBCWk9GW9Kt-qNNOAA9g/Maui09_0034.JPG:HighRes",
            upload_location:
            ...
            images: [
                {
                    ...
                    width: 600,
                    source:
                        "http://storage.live.com/s1pKk5vzd-gdPanbzKYhB0nQGn8wGq5DSgqvrgIHU1NTXA4e2-spGkAhQjW1d9pcgKAGLB4NsEsSvDoREmdx5w-JiFrinEJJuEoz08Ws_IFupkX2bPSvy5qmths9ijwvDrXi1OBCWk9GW9Kt-qNNOAA9g/Maui09_0034.JPG:WebReady",
                    type: "normal"
                },
                {
                    height: 132,
                    width: 176,
                    source:
                        "http://storage.live.com/s1pKk5vzd-gdPanbzKYhB0nQGn8wGq5DSgqvrgIHU1NTXA4e2-spGkAhQjW1d9pcgKAGLB4NsEsSvDoREmdx5w-JiFrinEJJuEoz08Ws_IFupkX2bPSvy5qmths9ijwvDrXi1OBCWk9GW9Kt-qNNOAA9g/Maui09_0034.JPG:MobileReady",
                    type: "album"
                },
                {
                    height: 72,
            ...
            link:
                "https://skydrive.live.com/redir.aspx?cid\u003dde57f4126ed7e411\u0026page\u003dview\u0026resid\u003dDE57F4126ED7E411!128\u0026parid\u003dDE57F4126ED7E411!126",
    ...
    data: [
        {
            ...
            source:
                "http://storage.live.com/s1pKk5vzd-gdPaJ5Q1MKN34itsyRlUkAYzD_zsr0Dg-5r4bH8Qo8XRgsunA0M-V4G-XPpu1spowx4xwfjCuDcWQVa7aWld2WCdfeWjBK_coPqaQqzoE26BJP3OZAITB5i_DRPK8jK3ZLilSbNJd-onrOA/Wildlife.wmv:VideoMain",
            upload_location:
                "https://apis.live.net/v5.0/file.de57f4126ed7e411.DE57F4126ED7E411!135/content/",
            link:
                "https://skydrive.live.com/redir.aspx?cid\u003dde57f4126ed7e411\u0026page\u003dview\u0026resid\u003dDE57F4126ED7E411!135\u0026parid\u003dDE57F4126ED7E411!126",
            height: 720,
            width: 1280,
            duration: 30093,
            bitrate: 5942130,
...
function openFromSkyDrive() {
    WL.fileDialog({
        ...
        function(errorResponse) {
            log(
                "WL.fileDialog errorResponse = " + JSON.stringify(errorResponse)
            );
        }
    );
}
