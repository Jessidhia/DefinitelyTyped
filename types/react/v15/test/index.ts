...
const statelessFactory: React.SFCFactory<SCProps> = React.createFactory(
    StatelessComponent
);
const statelessFactoryElement: React.SFCElement<SCProps> = statelessFactory(
    props
);

const classicFactory: React.ClassicFactory<Props> = React.createFactory(
    ClassicComponent
);
const classicFactoryElement: React.ClassicElement<Props> = classicFactory(
    props
);
...
const emptyElement1: React.ReactElement<{}> = React.createElement(
    ModernComponent
);
if (TestUtils.isElementOfType(emptyElement1, StatelessComponent)) {
    emptyElement1.props.foo;
}
const emptyElement2: React.ReactElement<{}> = React.createElement(
    StatelessComponent
);
