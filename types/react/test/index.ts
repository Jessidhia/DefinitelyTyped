...
class ModernComponent extends React.Component<Props, State, Snapshot>
    ...
    static propTypes: React.ValidationMap<Props> = {
        ...
        key: PropTypes.oneOfType([
            PropTypes.number,
            PropTypes.string
        ]) as PropTypes.Validator<string | number | undefined>
    };
...
// React.createFactory
const factory: React.CFactory<Props, ModernComponent> = React.createFactory(
    ModernComponent
);
const factoryElement: React.CElement<Props, ModernComponent> = factory(props);

const functionComponentFactory: React.FunctionComponentFactory<
    SCProps
> = React.createFactory(FunctionComponent);
const functionComponentFactoryElement: React.FunctionComponentElement<
    SCProps
> = functionComponentFactory(props);

const legacyStatelessComponentFactory: React.SFCFactory<
    SCProps
> = React.createFactory(FunctionComponent);
const legacyStatelessComponentFactoryElement: React.SFCElement<
    SCProps
...
const elementNoState: React.CElement<
    Props,
    ModernComponentNoState
> = React.createElement(ModernComponentNoState, props);
const elementNullProps: React.CElement<
    {},
    ModernComponentNoPropsAndState
> = React.createElement(ModernComponentNoPropsAndState, null);
const functionComponentElement: React.FunctionComponentElement<
    SCProps
> = React.createElement(FunctionComponent, scProps);
const functionComponentElementNullProps: React.FunctionComponentElement<
    SCProps
> = React.createElement(FunctionComponent4, null);
const legacyStatelessComponentElement: React.SFCElement<
    SCProps
> = React.createElement(FunctionComponent, scProps);
const legacyStatelessComponentElementNullProps: React.SFCElement<
    SCProps
> = React.createElement(FunctionComponent4, null);
...
// React.cloneElement
const clonedElement: React.CElement<
    Props,
    ModernComponent
...
const clonedElement2: React.CElement<
    Props,
    ModernComponent
> = React.cloneElement(element, {
    ref: c => c && c.reset()
});
const clonedElement3: React.CElement<
    Props,
    ModernComponent
> = React.cloneElement(element, {
    key: "8eac7",
...
const clonedfunctionComponentElement: React.FunctionComponentElement<
    SCProps
> = React.cloneElement(functionComponentElement, { foo: 44 });
const clonedlegacyStatelessComponentElement: React.SFCElement<
    SCProps
...
const clonedHtmlElement: React.ReactHTMLElement<
    HTMLInputElement
...
const ForwardingRefComponent = React.forwardRef(
    (props: {}, ref: React.Ref<RefComponent>) => {
...
function RefCarryingComponent() {
    ...
    return React.createElement<React.RefAttributes<RefComponent>>(
...
const inst: ModernComponent = TestUtils.renderIntoDocument<ModernComponent>(
    element
);
...
const emptyElement1: React.ReactElement<Props> = React.createElement(
    ModernComponent
);
if (TestUtils.isElementOfType(emptyElement1, FunctionComponent)) {
    emptyElement1.props.foo;
}
const emptyElement2: React.ReactElement<SCProps> = React.createElement(
    FunctionComponent
);
...
// defaultProps should be optional of props
{
    ...
    const VariableWithAClass: React.ComponentClass<
        ComponentProps
