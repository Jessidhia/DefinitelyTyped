...
///////////////////////////////////////////////////////////////////////////////
{
    ...
    // Create snapshot
    snapshotFromSubscription.create(
        "my-snapshot",
        (err, snapshot, apiResponse) => {
            if (!err) {
...
///////////////////////////////////////////////////////////////////////////////
{
    ...
    {
        const callback: PubSub.Topic.CreateSubscriptionCallback = (
            err,
            subscription,
            apiResponse
        ) => {};
    ...
    {
        const callback: PubSub.Topic.GetSubscriptionsCallback = (
            err,
            subscriptions
        ) => {
            // subscriptions is an array of `Subscription` objects.
