...
declare class SparkPost {
    ...
    recipientLists: {
         ...
         */
        find(
            options: { id: string; show_recipients?: false },
    ...
    subaccounts: {
        ...
        create(
            ...
            callback: SparkPost.ResultsCallback<
                SparkPost.CreateSubaccountResponse
            >
        ): void;
        /**
    ...
    templates: {
         ...
         */
        find(
            options: { id: string; draft?: boolean },
         ...
         */
        preview(
            options: { id: string; data: any; draft?: boolean },
    ...
    transmissions: {
         ...
         */
        all(
            options: { campaign_id?: string; template_id?: string },
            callback: SparkPost.ResultsCallback<SparkPost.TransmissionSummary[]>
        ): void;
        /**
