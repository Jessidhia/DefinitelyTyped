...
client.transmissions.send(
    {
        transmissionBody: {
            ...
            content: {
                ...
                html:
                    "<p>An example email using bcc with SparkPost to the {{recipient_type}} recipient.</p>"
            }
        }
    },
    function(err, res) {
...
client.transmissions.send(
    {
        transmissionBody: {
            ...
            content: {
                ...
                html:
                    "<p>An example email using cc with SparkPost to the {{recipient_type}} recipient.</p>"
            }
        }
    },
    function(err, res) {
