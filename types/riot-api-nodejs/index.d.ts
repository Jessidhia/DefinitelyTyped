...
export declare class ClassicAPI extends API {
     ...
     */
    staticDataLanguagesStrings(): Promise<
        RiotGamesAPI.LolStaticData.LanguageStringsDto
    >;
    /**
     * get league of legends languages
     ...
     */
    staticDataSummonerSpells(): Promise<
        RiotGamesAPI.LolStaticData.SummonerSpellListDto
    >;
    /**
