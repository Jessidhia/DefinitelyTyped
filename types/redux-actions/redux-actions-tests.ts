...
const incrementAction: () => ReduxActions.Action<
    number
> = ReduxActions.createAction<number>("INCREMENT", () => 1);

const multiplyAction: (
    ...args: number[]
) => ReduxActions.Action<number> = ReduxActions.createAction<number>(
    "MULTIPLY"
);
...
const actionsHandlerWithRecursiveReducerMapAndOptions = ReduxActions.handleActions<
    number,
    number
>(
    {
...
const typedIncrementAction: () => ReduxActions.Action<
    TypedPayload
