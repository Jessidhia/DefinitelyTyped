...
var simpleStorageTest3: boolean | Error = simpleStorage.set("string", 7, {
    TTL: 7
});
var simpleStorageTest4: boolean | Error = simpleStorage.set(
    "string",
    undefined
);
var simpleStorageTest5: boolean | Error = simpleStorage.set(
    "string",
    undefined,
    {}
);
var simpleStorageTest6: boolean | Error = simpleStorage.set(
    "string",
    undefined,
    { TTL: 7 }
);
