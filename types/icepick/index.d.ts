...
export declare function assoc<T, V>(
    collection: T,
    key: number | string,
    value: V
): T;
export declare function dissoc<T>(collection: T, key: number | string): T;
export declare function dissocIn<T>(
    collection: T,
    path: Array<number | string>
): T;
export declare function assocIn<T, V>(
    collection: T,
    path: Array<number | string>,
    value: V
): T;
export declare function getIn<T>(
    collection: T,
    path: Array<number | string>
): any;
...
export declare function assign<T, S1, S2>(
    target: T,
    s1: S1,
    s2: S2
): T & S1 & S2;
export declare function assign<T, S1, S2, S3>(
    target: T,
    s1: S1,
    s2: S2,
    s3: S3
): T & S1 & S2 & S3;
export declare function assign<T, S1, S2, S3, S4>(
    target: T,
    s1: S1,
    s2: S2,
    s3: S3,
