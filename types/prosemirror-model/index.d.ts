...
export class Fragment<S extends Schema = any> {
     ...
     */
    static fromArray<S extends Schema = any>(
        array: Array<ProsemirrorNode<S>>
    ): Fragment<S>;
    /**
...
export interface ParseRule {
     ...
     */
    getContent?:
        | (<S extends Schema = any>(p: Node, schema: S) => Fragment<S>)
        | null;
    /**
...
export class Mark<S extends Schema = any> {
     ...
     */
    static sameSet<S extends Schema = any>(
        a: Array<Mark<S>>,
        b: Array<Mark<S>>
    ): boolean;
    /**
     ...
     */
    static setFrom<S extends Schema = any>(
        marks?: Mark<S> | Array<Mark<S>>
    ): Array<Mark<S>>;
    /**
...
declare class ProsemirrorNode<S extends Schema = any> {
    ...
    childAfter(
        pos: number
    ): { node?: ProsemirrorNode<S> | null; index: number; offset: number };
    /**
...
export class Schema<N extends string = any, M extends string = any> {
    ...
    nodes: { [name in N]: NodeType<Schema<N, M>> } & {
        [key: string]: NodeType<Schema<N, M>>;
    };
    /**
     * A map from mark names to mark type objects.
     */
    marks: { [name in M]: MarkType<Schema<N, M>> } & {
        [key: string]: MarkType<Schema<N, M>>;
    };
    /**
     ...
     */
    mark(
        type: string | MarkType<Schema<N, M>>,
        attrs?: { [key: string]: any }
    ): Mark<Schema<N, M>>;
    /**
