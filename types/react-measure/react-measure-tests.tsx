...
class Test extends React.Component {
    ...
    onResize(contentRect: ContentRect): void {
        ...
        if (client != null) {
            console.log(
                `client - top: ${client.top}, left: ${client.left}, width: ${
                    client.width
        ...
        if (offset != null) {
            console.log(
                `offset - top: ${offset.top}, left: ${offset.left}, width: ${
                    offset.width
        ...
        if (scroll != null) {
            console.log(
                `scroll - top: ${scroll.top}, left: ${scroll.left}, width: ${
                    scroll.width
        ...
        if (bounds != null) {
            console.log(
                `bounds - top: ${bounds.top}, left: ${bounds.left}, bottom: ${
                    bounds.bottom
                }, right: ${bounds.right}, width: ${bounds.width}, height: ${
                    bounds.height
                }`
            );
        }
        if (margin != null) {
            console.log(
                `bounds - top: ${margin.top}, left: ${margin.left}, bottom: ${
                    margin.bottom
                }, right: ${margin.right}`
            );
        }
...
const TestFunctionalComponentWithProps: React.SFC<
...
function testHocComponent2<T>() {
    return withContentRect(["scroll", "margin"] as ReadonlyArray<
        MeasurementType
