...
declare namespace ForceGraph {
    ...
    interface ForceGraphInstance {
        ...
        nodeColor(
            color?: string | NodeAccessorFn<string>
        ): ForceGraphInstance & (string | NodeAccessorFn<string>);
        nodeAutoColorBy(
            attribute?: string | NodeAccessorFn<string>
        ): ForceGraphInstance & (string | NodeAccessorFn<string>);
        nodeCanvasObject(
            callback?: NodeCanvasCallbackFn
        ): ForceGraphInstance & NodeCanvasCallbackFn;
        ...
        linkCurvature(
            curvature?:
                | LinkCurvatureType
                | string
                | LinkAccessorFn<LinkCurvatureType>
        ): ForceGraphInstance;
        linkCanvasObject(
            callback?: LinkCanvasCallbackFn
        ): ForceGraphInstance & LinkCanvasCallbackFn;
        ...
        centerAt(
            ...
            y?: number,
            milliseconds?: number
        ): ForceGraphInstance & { x: number; y: number };
        zoom(
            zoomLevel?: number,
            duration?: number
        ): ForceGraphInstance & number;
