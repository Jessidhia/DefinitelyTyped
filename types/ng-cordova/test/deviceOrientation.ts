...
namespace demo.deviceorientation {
    ...
    export class DeviceOrientationController {
        ...
        watchHeading() {
            this.this_watch = this.$cordovaDeviceOrientation.watchHeading({
                frequency: 1000
            });
    ...
    angular
        .module("demo.deviceorientation")
        .controller("DeviceOrientationController", DeviceOrientationController);
}
