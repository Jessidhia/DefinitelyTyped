function test() {
    ...
    function testModel() {
        ...
        var opts: MakerJs.ICombineOptions = {
            trimDeadEnds: true,
    ...
    function testModels(): MakerJs.IModel[] {
        ...
        makerjs.models.BezierCurve.getBezierSeeds(
    ...
    function testPath() {
        ...
        makerjs.path.intersection(paths.circle, paths.arc, {
    ...
    function testPoint() {
        ...
        makerjs.point.fromSlopeIntersection(
