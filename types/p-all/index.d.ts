...
declare function pAll<T1, T2, T3>(
    tasks: [PromiseFactory<T1>, PromiseFactory<T2>, PromiseFactory<T3>],
    options?: pAll.Options
): Promise<[T1, T2, T3]>;
declare function pAll<T1, T2>(
    tasks: [PromiseFactory<T1>, PromiseFactory<T2>],
    options?: pAll.Options
): Promise<[T1, T2]>;
declare function pAll<T1>(
    tasks: [PromiseFactory<T1>],
    options?: pAll.Options
): Promise<[T1]>;
declare function pAll<TAll>(
    tasks: Iterable<PromiseFactory<TAll>> | Array<PromiseFactory<TAll>>,
    options?: pAll.Options
): Promise<TAll[]>;
