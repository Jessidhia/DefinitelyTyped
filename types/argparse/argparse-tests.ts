...
simpleExample.addArgument(["-f", "--foo"], {
    help: "foo bar"
});
simpleExample.addArgument(["-b", "--bar"], {
    help: "bar foo"
});
simpleExample.addArgument("positional", {
    help: "bar foo"
});
...
constantExample.addArgument(["-a"], {
    action: "storeConst",
    dest: "answer",
    help: "store constant",
    constant: 42
});
constantExample.addArgument(["--str"], {
    action: "appendConst",
    dest: "types",
    help: 'append constant "str" to types',
    constant: "str"
});
constantExample.addArgument(["--int"], {
    action: "appendConst",
    dest: "types",
...
constantExample.addArgument(["--true"], {
    action: "storeTrue",
    help: "store true constant"
});
constantExample.addArgument(["--false"], {
    action: "storeFalse",
...
nargsExample.addArgument(["-f", "--foo"], {
    help: "foo bar",
    nargs: 1
});
nargsExample.addArgument(["-b", "--bar"], {
    help: "bar foo",
    nargs: "*"
});
...
parent_parser.addArgument(["--parent"], { type: "int", help: "parent" });
