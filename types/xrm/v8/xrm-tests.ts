...
const lookupAttribute2 = Xrm.Page.getControl<Xrm.Page.LookupControl>(
    "customerid"
);
...
const optionSetAttribute = Xrm.Page.getAttribute<Xrm.Page.OptionSetAttribute>(
    "statuscode"
);
...
let autoCompleteControl = Xrm.Page.getControl<Xrm.Page.AutoLookupControl>(
    "name"
);
