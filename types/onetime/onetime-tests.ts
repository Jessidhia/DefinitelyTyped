...
onetime((t1: boolean, t2: string, t3: number, t4: undefined) => 5)(
    true,
    "",
    5,
    undefined
); // $ExpectType number
onetime((t1: boolean, t2: string, t3: number, t4: undefined, t5: string) => 5)(
    true,
    "",
    5,
    undefined,
...
)(true, "", 5, undefined, "", 6); // $ExpectType number
onetime(
    (
        t1: boolean,
        t2: string,
...
)(true, "", 5, undefined, "", 6, false); // $ExpectType number
