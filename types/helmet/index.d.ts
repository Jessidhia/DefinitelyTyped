...
declare namespace helmet {
    ...
    export type HelmetCspDirectiveValue =
        | string
        | IHelmetContentSecurityPolicyDirectiveFunction;
    ...
    export interface Helmet {
         ...
         */
        contentSecurityPolicy(
            options?: IHelmetContentSecurityPolicyConfiguration
         ...
         */
        frameguard(
            options?: IHelmetFrameguardConfiguration
        ): express.RequestHandler;
         ...
         */
        hidePoweredBy(
            options?: IHelmetHidePoweredByConfiguration
        ): express.RequestHandler;
         ...
         */
        xssFilter(
            options?: IHelmetXssFilterConfiguration
        ): express.RequestHandler;
         ...
         */
        expectCt(
            options?: IHelmetExpectCtConfiguration
        ): express.RequestHandler;
