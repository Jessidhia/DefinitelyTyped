...
declare namespace QTip2 {
    ...
    interface Plugin {
        ...
        (methodName: "option", propertyName: "position.target"):
            | QTip2.Target
            | boolean;
        (methodName: "option", propertyName: "position.container"):
            | JQuery
            | boolean;
        (methodName: "option", propertyName: "position.viewport"):
            | JQuery
            | boolean;
        ...
        (methodName: "option", propertyName: "show.solo"):
            | JQuery
            | string
            | boolean;
        ...
        (methodName: "option", propertyName: "show.effect"):
            | boolean
            | ((offset: any) => void);
        (methodName: "option", propertyName: "show.modal"):
            | boolean
            | QTip2.Modal;
        ...
        (methodName: "option", propertyName: "style.width"):
            | string
            | number
            | boolean;
        (methodName: "option", propertyName: "style.height"):
            | string
            | number
            | boolean;
        (methodName: "option", propertyName: "style.tip"):
            | string
            | boolean
            | QTip2.Tip;
