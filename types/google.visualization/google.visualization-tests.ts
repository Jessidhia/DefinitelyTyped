...
function test_formatter_ArrowFormat() {
    ...
    var table = new google.visualization.Table(
        document.getElementById("arrowformat_div")
    );
...
function test_formatter_BarFormat() {
    ...
    var table = new google.visualization.Table(
        document.getElementById("barformat_div")
    );
...
function test_formatter_DateFormat() {
    function drawDateFormatTable() {
        ...
        // Draw our data
        var table = new google.visualization.Table(
            document.getElementById("dateformat_div")
        );
        table.draw(data, {
            showRowNumber: true,
            width: "100%",
...
function test_formatter_NumberFormat() {
    ...
    var table = new google.visualization.Table(
        document.getElementById("numberformat_div")
    );
