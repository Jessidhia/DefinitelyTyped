...
declare namespace Router {
    ...
    interface PlainRoute {
        ...
        getComponent?: (
            location: Location,
            cb: (error: any, component?: RouteComponent) => void
        ) => void;
        getComponents?: (
            location: Location,
            cb: (error: any, components?: RouteComponents) => void
        ) => void;
        onEnter?: EnterHook;
        onLeave?: LeaveHook;
        ...
        getIndexRoute?: (
            location: Location,
            cb: (error: any, indexRoute: RouteConfig) => void
        ) => void;
        childRoutes?: PlainRoute[];
        getChildRoutes?: (
            location: Location,
            cb: (error: any, childRoutes: RouteConfig) => void
        ) => void;
    }
    ...
    interface RouterOnContext extends History {
        ...
        isActive(
            pathOrLoc: Path | LocationDescriptor,
            indexOnly?: boolean
        ): boolean;
    }
