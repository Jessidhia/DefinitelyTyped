...
> = injectIntl<SomeComponentProps & InjectedIntlProps>(
    ({
        ...
        const formattedRelative = formatRelative(new Date().getTime(), {
            format: "short"
        });
        ...
        const formattedMessage = formatMessage(
            ...
            { name: "Roger", nullAllowed: null, undefinedAllowed: undefined }
        );
        ...
        const formattedHTMLMessage = formatHTMLMessage(
            { id: "hello", defaultMessage: "Hello <strong>{name}</strong>!" },
            { name: "Roger", nullAllowed: null, undefinedAllowed: undefined }
        );
...
> {
    ...
    render(): React.ReactElement<{}> {
        ...
        const formattedRelative = intl.formatRelative(new Date().getTime(), {
            format: "short"
        });
        ...
        const formattedMessageNumber = intl.formatMessage(
            { id: "hello", defaultMessage: "Hello {num}!" },
            { num: 1 }
        );
        const formattedMessageDate = intl.formatMessage(
            { id: "hello", defaultMessage: "Hello {date}!" },
            { date: new Date() }
        );
        const formattedMessageBool = intl.formatMessage(
            { id: "hello", defaultMessage: "Hello {bool}!" },
            { bool: true }
        );
        ...
        const formattedHTMLMessage = intl.formatHTMLMessage(
            { id: "hello", defaultMessage: "Hello <strong>{name}</strong>!" },
            { name: "Roger" }
        );
        const formattedHTMLMessageNumber = intl.formatHTMLMessage(
            { id: "hello", defaultMessage: "Hello <strong>{num}</strong>!" },
            { num: 1 }
        );
        const formattedHTMLMessageDate = intl.formatHTMLMessage(
            { id: "hello", defaultMessage: "Hello <strong>{date}</strong>!" },
            { date: new Date() }
        );
        const formattedHTMLMessageBool = intl.formatHTMLMessage(
            { id: "hello", defaultMessage: "Hello <strong>{bool}</strong>!" },
            { bool: true }
        );
        return (
            <div className={this.props.className}>
                ...
                <FormattedMessage id="test" description="Test">
...
const wrappedComponent = (
    <SomeComponentWithIntl.WrappedComponent className="test" intl={intl} />
);
