...
declare namespace H {
    ...
    namespace map {
         ...
         */
        class ViewPort extends H.util.EventTarget
        ...
        namespace layer {
             ...
             */
            class MarkerTileLayer extends H.map.layer.BaseTileLayer
             ...
             */
            class ObjectLayer extends H.map.layer.Layer
             ...
             */
            class TileLayer extends H.map.layer.BaseTileLayer
                implements H.map.layer.ITileLayer {
                /**
                 * Constructor
                 * @param provider {H.map.provider.TileProvider} - data source for the TileLayer
    ...
    namespace service {
         ...
         */
        class MapTileService extends H.util.EventTarget
        ...
        class TrafficIncidentsService extends H.service.AbstractRestService {
             ...
             */
            constructor(
                opt_options?: H.service.TrafficIncidentsService.Options
            );
        ...
        namespace metaInfo {
             ...
             */
            class Service extends H.util.EventTarget
                implements H.service.IConfigurable {
                /**
                 * Constructor
    ...
    namespace ui {
        ...
        namespace UI {
            ...
            interface Options {
                ...
                distancemeasurement?:
                    | H.ui.DistanceMeasurement.Options
                    | boolean;
