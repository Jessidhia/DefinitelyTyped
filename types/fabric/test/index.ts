...
function sample8() {
        ...
        (() => {
            ...
            slider.onchange = function() {
                ...
                if (activeObject || activeGroup) {
                    (activeObject || activeGroup).setOpacity(
    ...
    if (supportsColorpicker()) {
        (() => {
            ...
            colorpicker.onchange = function() {
                ...
                if (activeObject || activeGroup) {
                    (activeObject || activeGroup).setFill(
    ...
    drawingLineWidthEl.onchange = () => {
        canvas.freeDrawingLineWidth =
            parseInt(drawingLineWidthEl.value, 10) || 1; // disallow 0, NaN, etc.
    };
...
laboris nisi ut aliquip ex ea commodo consequat.`;
    ...
    if (cmdOverlineBtn) {
        ...
        cmdOverlineBtn.onclick = function() {
            ...
            if (activeObject && activeObject.type === "text") {
                activeObject.textDecoration =
                    activeObject.textDecoration === "overline"
                        ? ""
                        : "overline";
                (this as HTMLElement).className = activeObject.textDecoration
                    ? "selected"
