...
export class StaticCanvas {
    ...
    setOverlayColor(
        overlayColor: string | Pattern,
        callback: (pattern: Pattern | undefined) => void
    ): this;
     ...
     */
    clone(
        callback: (canvas: StaticCanvas) => void,
        properties?: string[]
    ): void;
...
export class ActiveSelection {
    ...
    static fromObject(
        object: Group,
        callback: (activeSelection: ActiveSelection) => void
    ): void;
}
