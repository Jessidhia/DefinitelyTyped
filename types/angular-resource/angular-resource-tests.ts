...
angular
    .injector(["ng"])
    .invoke(function($cacheFactory: angular.ICacheFactoryService) {
...
///////////////////////////////////////
let mod: ng.IModule;
let resourceServiceFactoryFunction: angular.resource.IResourceServiceFactoryFunction<
    IMyResource
>;

resourceClass = resourceServiceFactoryFunction<IMyResourceClass>(
    resourceService
);
