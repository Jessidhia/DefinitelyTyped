...
export namespace extensions {
    ...
    class MjmlConditionalComment extends React.Component<{
        children: string;
        condition: string;
    }> {}
...
export namespace utils {
    ...
    function fixConditionalComment(
        html: string,
...
export class MjmlBody extends React.Component<
...
export class MjmlAccordion extends React.Component<
    RequiredChildrenProps & MjmlAccordionElementProps
> {}
...
export class MjmlNavbar extends React.Component<
    MjmlNavbarProps & RequiredChildrenProps
> {}
