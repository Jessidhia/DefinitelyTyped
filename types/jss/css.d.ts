    ...
    background:
        | {
              ...
              position:
                  ...
                  | [
                        csstype.Properties["backgroundPosition"],
                        csstype.Properties["backgroundPosition"]
              ...
              size:
                  ...
                  | [
                        csstype.Properties["backgroundSize"],
                        csstype.Properties["backgroundSize"]
                    ]; // Can be written using array e.g. `['center' 'center']`
          }
...
export type JssExpandArr = {
    [k in keyof JssExpand]?: JssExpand[k] | Array<JssExpand[k]>
};
