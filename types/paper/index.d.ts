...
declare module paper {
    ...
    export class Item {
        ...
        on(
            type: string,
            callback: (event: IFrameEvent) => void | boolean
        ): Item;
        ...
        off(
            type: string,
            callback: (event: MouseEvent) => void | boolean
        ): Item;
        /**
         * Detach an event handler from the item.
         * @param type - the type of event: ‘frame’, mousedown’, ‘mouseup’, ‘mousedrag’, ‘click’, ‘doubleclick’, ‘mousemove’, ‘mouseenter’, ‘mouseleave’
        ...
        on(
            type: string,
            callback: (event: Event | MouseEvent) => void | boolean
        ): Item;
    ...
    export class PathItem extends Item {
        ...
        intersect(
            path: PathItem,
            options?: { insert?: boolean; trace?: boolean }
        ): PathItem;
    ...
    export class Gradient {
         ...
         */
        constructor(
            stops?: GradientStop[] | string[] | (string | number)[][],
            radial?: boolean
        );
    ...
    export class Tool {
        ...
        on(
            type: string,
            callback: (event: ToolEvent | KeyEvent) => void | boolean
        ): Tool;
