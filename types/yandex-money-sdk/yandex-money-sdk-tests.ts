...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.GetAccessTokenResult
    >;
...
{
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.AccountInfoResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.OperationHistoryResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.OperationDetailsResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.RequestPaymentResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.ProcessPaymentResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.IncomingTransferAcceptResult
    >;
...

{
    let operation_id: string;
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.Wallet.IncomingTransferRejectResult
    >;
...

{
    let clientId: string;
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.ExternalPayment.GetInstanceIdResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.ExternalPayment.RequestResult
    >;
...

{
    ...
    let callback: ymsdk.ResponseCallback<
        YandexMoneySDK.ExternalPayment.ProcessResult
    >;
