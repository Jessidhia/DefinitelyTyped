...
declare function RollingRateLimiter(
    options: RollingRateLimiter.InMemoryOptions
): RollingRateLimiter.SyncOrAsyncLimiter;
declare function RollingRateLimiter(
    options: RollingRateLimiter.WithRedisOptions
...
declare namespace RollingRateLimiter {
    ...
    type AsyncLimiterWithToken = (
        token: string,
        callback: AsyncLimiterCallback
    ) => void;
    type AsyncLimiterWithoutToken = (callback: AsyncLimiterCallback) => void;
    type AsyncLimiterCallback = (
        err: any,
        timeLeft: number,
        actionsLeft: number
    ) => void;
