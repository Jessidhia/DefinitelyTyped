...
declare namespace MangoPay {
    ...
    namespace models {
        ...
        class BankingAlias extends EntityBase<
        ...
        interface DocumentPageConsult
            extends disputeDocument.DocumentPageConsult {}
        ...
        class UboDeclaration extends EntityBase<
        ...
        interface CardRegistration
            extends cardRegistration.CardRegistrationData {}
        ...
        > {
            constructor(
                data: Partial<settlementTransfer.SettlementTransferData>
            );
        }
    ...
    class BankingAliases {
        ...
        update: MethodOverload<
            Partial<
                Omit<bankingAlias.CreateIBANBankingAlias, "CreditedUserId">
            >,
            bankingAlias.IBANBankingAliasData
        >;
