...
declare namespace Bookshelf {
    ...
    abstract class ModelBase<T extends Model<any>> extends Events<
        T | Collection<T>
    > {
    ...
    abstract class CollectionBase<T extends Model<any>> extends Events<T> {
        ...
        map<U>(
            predicate?: Lodash.ListIterator<T, U> | string,
            thisArg?: any
        ): U[];
        map<U>(
        ...
        max(
            predicate?: Lodash.ListIterator<T, boolean> | string,
            thisArg?: any
        ): T;
