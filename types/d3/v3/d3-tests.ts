...
function populationPyramid() {
    ...
    d3.csv("population.csv", <any>(
        function(error: any, rows: Array<PyramidData>) {
...
function azimuthalEquidistant() {
    ...
    d3.json("/mbostock/raw/4090846/world-50m.json", function(error, world) {
        ...
        svg.insert("path", ".graticule")
            .datum(
                topojson.mesh(world, world.objects.countries, function(
                    a: any,
                    b: any
                ) {
                    return a !== b;
...
function quadtree() {
    ...
    var point = svg
        .selectAll(".point")
        .data(<
            { scanned?: boolean; selected?: boolean; 0: number; 1: number }[]
        >data)
        .enter()
        .append("circle")
        .attr("class", "point")
...
function nestTest() {
    ...
    entries = d3
        .nest<{ 0: number; 1: number; 2?: number }>()
        .key(function(d) {
            return String(d[0]);
        })
        .sortKeys(d3.ascending)
