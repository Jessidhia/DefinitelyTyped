...
export class DecorationSet<S extends Schema = any> {
    ...
    map(
        ...
        options?: {
            onRemove?:
                | ((decorationSpec: { [key: string]: any }) => void)
                | null;
        }
    ): DecorationSet<S>;
    /**
...
export interface EditorProps<S extends Schema = any> {
     ...
     */
    handleKeyDown?:
        | ((view: EditorView<S>, event: KeyboardEvent) => boolean)
        | null;
    /**
     ...
     */
    handleClick?:
        | ((view: EditorView<S>, pos: number, event: MouseEvent) => boolean)
        | null;
    /**
     ...
     */
    handlePaste?:
        | ((view: EditorView<S>, event: Event, slice: Slice<S>) => boolean)
        | null;
    /**
     ...
     */
    clipboardTextParser?:
        | ((text: string, $context: ResolvedPos<S>) => Slice<S>)
        | null;
    /**
     ...
     */
    decorations?:
        | ((state: EditorState<S>) => DecorationSet<S> | null | undefined)
        | null;
    /**
...
export interface NodeView<S extends Schema = any> {
     ...
     */
    update?:
        | ((node: ProsemirrorNode<S>, decorations: Decoration[]) => boolean)
        | null;
    /**
