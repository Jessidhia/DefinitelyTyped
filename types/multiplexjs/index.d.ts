...
declare namespace multiplex {
    ...
    interface SortedListConstructor {
         ...
         */
        new <TKey, TValue>(dictionary: Dictionary<TKey, TValue>): SortedList<
            TKey,
            TValue
        >;
    ...
    interface KeyValuePairConstructor {
         ...
         */
        new <TKey, TValue>(key: TKey, value: TValue): KeyValuePair<
            TKey,
            TValue
        >;
    }
    ...
    interface DictionaryConstructor {
         ...
         */
        new <TKey, TValue>(dictionary: Dictionary<TKey, TValue>): Dictionary<
            TKey,
            TValue
        >;
         ...
         */
        new <TKey, TValue>(comparer: EqualityComparer<TKey>): Dictionary<
            TKey,
            TValue
        >;
