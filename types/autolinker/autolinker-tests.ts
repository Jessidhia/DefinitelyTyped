...
() => {
    ...
    let linkedText3 = Autolinker.link("Check out google.com", {
        className: "myLink"
    });
    let linkedText4 = Autolinker.link("Check out google.com", {
        newWindow: false
    });
    let linkedText5 = Autolinker.link(
        ...
        replaceFn: function(autolinker, match) {
            ...
            switch (match.getType()) {
                ...
                case "twitter":
                    ...
                    return (
                        '<a href="http://newplace.to.link.twitter.handles.to/">' +
                        twitterHandle +
                        "</a>"
                    );
...
() => {
    ...
    let linkedText3 = AutolinkerCJS.link("Check out google.com", {
        className: "myLink"
    });
    let linkedText4 = AutolinkerCJS.link("Check out google.com", {
        newWindow: false
    });
    let linkedText5 = AutolinkerCJS.link(
        "http://www.yahoo.com/some/long/path/to/a/file",
        { truncate: 25, newWindow: false }
    );
    let myTextEl = document.getElementById("text");
