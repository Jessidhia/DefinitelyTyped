...
declare namespace CKEDITOR {
    ...
    interface config {
        ...
        toolbar?:
            ...
            | Array<
                  | string
                  | string[]
                  | { name: string; items?: string[]; groups?: string[] }
              >
            | null;
    ...
    class dialog {
        ...
        static add(
            ...
            dialogDefinition:
                | string
                | ((editor: editor) => dialog.IDialogDefinition)
        ): void;
        static addIframe(
            name: string,
            title: string,
    ...
    class editor extends event {
        ...
        getClipboardData(
            callbackOrOptions: { title: string } | ((data: any) => void),
            callback: (data: any) => void
        ): void;
        getColorFromDialog(
    ...
    module filter {
        ...
        interface transformation {
            ...
            right: (
                ...
                tools: string | filter.transformationTools
            ) => boolean;
        }
    ...
    class htmlDataProcessor implements dataProcessor {
        ...
        toDataFormat(
            ...
            options?:
                | string
                | { context?: string; filter?: filter; enterMode?: number }
        ): string;
        toHtml(
            data: string,
    ...
    namespace htmlParser {
        ...
        class cssStyle {
            ...
            populate(
                obj: htmlParser.element | dom.element | { [key: string]: any }
            ): void;
        }
        ...
        class element extends node {
            ...
            find(
                criteria: string | ((el: htmlParser.node) => boolean),
                recursive?: boolean
            ): htmlParser.node[];
            forEach(
                callback: (node: htmlParser.node) => void | false,
                type?: number,
                skipRoot?: boolean
            ): void;
            getFirst(
        ...
        class node {
            ...
            getAscendant(
                condition:
                    | string
                    | { [name: string]: string }
                    | ((node: htmlParser.element) => boolean)
            ): element;
            getIndex(): number;
        ...
        type rule =
            | ((
                  value: htmlParser.node | htmlParser.fragment | string
              ) => boolean)
            | [string, string];
    ...
    namespace plugins {
        ...
        namespace widget {
            ...
            interface definition extends feature {
                ...
                styleToAllowedContentRules?: (
                    style: style
                ) => filter.allowedContentRules;
                styleableElements?: string;
                template?: string | template;
                upcast?:
                    | string
                    | ((element: htmlParser.element, data: any) => boolean);
        ...
        class widget extends event implements widget.definition {
            ...
            initEditable(
                editableName: string,
                definition: plugins.widget.nestedEditable.definition
            ): boolean;
            isInited(): boolean;
            isReady(): boolean;
            removeClass(className: string): void;
    ...
    namespace tools {
        ...
        function override<T extends Function>(
            originalFunction: T,
        ...
        function prototypedCopy(source: {
            [key: string]: any;
        }): { [key: string]: any };
        ...
        function transformPlainTextToHtml(
            text: string,
            etnerMode: number
        ): string;
        ...
        namespace style {
            namespace parse {
                function background(
                    value: string
                ): { color: string; unprocessed: string };
                function border(
                    value: string
        ...
        class balloonPanel {
            ...
            attach(
                ...
                options?:
                    | dom.element
                    | boolean
                    | { focusElement?: dom.element | boolean; show?: boolean }
            ): void;
            blur(): void;
            build(): void;
