...
declare namespace CKEDITOR {
    ...
    namespace dom {
        ...
        class document extends domObject {
            ...
            createElement(
                name: string,
                attribsAndStyles?: { attributes: Object; styles: Object }
            ): element;
    ...
    class editor extends event {
        ...
        getSelectedHtml(
            toString?: boolean
        ): CKEDITOR.dom.documentFragment | string;
    ...
    namespace dialog {
        ...
        function add(
            name: string,
            dialogDefinition: (editor: CKEDITOR.editor) => IDialogDefinition
        ): void;
        function addIframe(
            name: string,
            title: string,
    ...
    namespace htmlParser {
        ...
        class element extends node {
            ...
            forEach(
                callback: (node: node, type?: number) => void | false,
                type?: number,
                skipRoot?: boolean
            ): void;
        ...
        class fragment {
            ...
            forEach(
                callback: (node: node, type?: number) => void | boolean,
                type?: number,
                skipRoot?: boolean
            ): void;
            writeHtml(writer: basicWriter, filter?: filter): void;
