...
declare namespace Cesium {
    ...
    class ObjectOrientedBoundingBox {
        ...
        static intersect(
            left: ObjectOrientedBoundingBox,
            right: ObjectOrientedBoundingBox
        ): boolean;
        static equals(
            left: ObjectOrientedBoundingBox,
            right: ObjectOrientedBoundingBox
    ...
    namespace SelectionIndicatorViewModel {
        type ComputeScreenSpacePosition = (
            position: Cartesian3,
            result: Cartesian2
        ) => Cartesian2;
    }
    ...
    class ToggleButtonViewModel {
        ...
        constructor(
            command: Command,
            options?: { toggled?: boolean; tooltip?: string }
        );
    }
    ...
    namespace GeometryPipeline {
        ...
        function reorderForPostVertexCache(
            geometry: Geometry,
    ...
    namespace IntersectionTests {
        ...
        function grazingAltitudeLocation(
            ray: Ray,
            ellipsoid: Ellipsoid
        ): Cartesian3;
