...
myApp.controller("sortableController", function(
    $scope: MySortableControllerScope
) {
    $scope.sortableOptions = {
        activate: function(e, ui) {
            var jQueryEventObject: JQueryEventObject = e;
            var uiSortableUIParams: ng.ui.UISortableUIParams<
                SortableModelInfo
            > = ui;
        },
    ...
    const sortableFloatingOption0: ng.ui.UISortableOptions<
        SortableModelInfo
    > = { "ui-floating": undefined };
    const sortableFloatingOption1: ng.ui.UISortableOptions<
        SortableModelInfo
    > = { "ui-floating": false };
    const sortableFloatingOption2: ng.ui.UISortableOptions<
        SortableModelInfo
    > = { "ui-floating": true };
    const sortableFloatingOption3: ng.ui.UISortableOptions<
        SortableModelInfo
    > = { "ui-floating": "auto" };
});
