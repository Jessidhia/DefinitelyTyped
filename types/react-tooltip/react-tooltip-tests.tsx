...
export class ReactTooltipTest extends React.PureComponent {
    ...
    render() {
        const getContent: ReactTooltip.GetContent = [
            dataTip => Math.floor(Math.random() * 100),
            30
        ];
        ...
        return (
            <div>
                ...
                <ReactTooltip
                    sanitizeHtmlOptions={this.options}
