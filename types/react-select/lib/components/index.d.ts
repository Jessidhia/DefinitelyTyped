...
export type IndicatorComponentType<OptionType> = ComponentType<
...
export type SelectComponentsConfig<OptionType> = Partial<
...
export function defaultComponents<OptionType>(
