...
export namespace policies {
    ...
    namespace speculativeExecution {
        ...
        interface ConstantSpeculativeExecutionPolicy
            extends SpeculativeExecutionPolicy {}
    }
...
export interface Encoder {
    ...
    encode(
        value: any,
        typeInfo?: string | number | { code: number; info?: any }
    ): Buffer;
}
...
export namespace metadata {
    ...
    interface Metadata {
        ...
        getTable(
            keyspaceName: string,
            name: string,
            callback: MetadataCallback<TableMetadata>
        ): void;
