...
declare namespace google.earth {
     ...
     */
    export class GEFeatureContainer extends GESchemaObjectContainer<
        KmlFeature
    > {}
     ...
     */
    export class GEGeometryContainer extends GESchemaObjectContainer<
        KmlGeometry
    > {}
     ...
     */
    export class GELinearRingContainer extends GESchemaObjectContainer<
        KmlLinearRing
    > {}
     ...
     */
    export class GEStyleSelectorContainer extends GESchemaObjectContainer<
        KmlStyleSelector
    > {}
