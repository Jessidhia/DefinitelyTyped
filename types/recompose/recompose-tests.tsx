...
function testWithHandlers() {
    ...
    const InnerComponent: React.StatelessComponent<
...
function testRenameProp() {
    ...
    const innerComponent: React.StatelessComponent<InnerProps> = ({
        c,
        b
    }: InnerProps) => (
        <div>
    ...
    const enhanced: React.ComponentClass<OutterProps> = enhancer(
        innerComponent
    );
}
...
function testWithReducer() {
    ...
    const InnerComponent: React.StatelessComponent<InnerProps> = props => (
        <div onClick={() => props.dispatch({ type: "INCREMENT" })} />
    );
...
function testBranch() {
    ...
    const enhanced2: React.ComponentClass<OutterProps> = enhancer2(
        innerComponent
    );
}
