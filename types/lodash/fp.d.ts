...
declare namespace _ {
    ...
    interface LodashAfter {
        <TFunc extends (...args: any[]) => any>(func: TFunc): LodashAfter1x1<
            TFunc
        >;
    ...
    interface LodashEvery {
        <T>(predicate: lodash.ValueIterateeCustom<T, boolean>): LodashEvery1x1<
            T
        >;
        <T>(
            predicate: lodash.__,
    ...
    interface LodashSome {
        <T>(predicate: lodash.ValueIterateeCustom<T, boolean>): LodashSome1x1<
            T
        >;
        <T>(
            predicate: lodash.__,
    ...
    interface LodashAssignIn {
        ...
        <TSource>(object: lodash.__, source: TSource): LodashAssignIn1x2<
            TSource
        >;
        <TObject, TSource>(object: TObject, source: TSource): TObject & TSource;
    }
    ...
    interface LodashAssignInWith1x1 {
        ...
        <TSource>(object: lodash.__, source: TSource): LodashAssignInWith1x5<
            TSource
        >;
        <TObject, TSource>(object: TObject, source: TSource): TObject & TSource;
    }
    ...
    interface LodashAssignWith {
        ...
        <TObject>(customizer: lodash.__, object: TObject): LodashAssignWith1x2<
            TObject
        >;
        <TObject>(
            customizer: lodash.AssignCustomizer,
    ...
    interface LodashAssignWith1x1 {
        ...
        <TSource>(object: lodash.__, source: TSource): LodashAssignWith1x5<
            TSource
        >;
        <TObject, TSource>(object: TObject, source: TSource): TObject & TSource;
    }
    interface LodashAssignWith1x2<TObject> {
        ...
        <TSource>(customizer: lodash.__, source: TSource): LodashAssignWith1x6<
            TObject,
            TSource
        >;
        <TSource>(
    ...
    interface LodashAssignWith1x4<TSource> {
        ...
        <TObject>(customizer: lodash.__, object: TObject): LodashAssignWith1x6<
            TObject,
            TSource
        >;
        <TObject>(
    ...
    interface LodashBefore {
        <TFunc extends (...args: any[]) => any>(func: TFunc): LodashBefore1x1<
            TFunc
        >;
    ...
    type LodashCompact = <T>(
        array:
            | lodash.List<T | null | undefined | false | "" | 0>
            | null
            | undefined
    ) => T[];
    interface LodashNegate {
        ...
        <A1, A2>(predicate: (a1: A1, a2: A2) => boolean): (
            a1: A1,
            a2: A2
        ) => boolean;
    ...
    interface LodashFlowRight {
        ...
        <A1, A2, R2, R1>(f2: (a: R1) => R2, f1: (a1: A1, a2: A2) => R1): (
            a1: A1,
            a2: A2
        ) => R2;
        <A1, A2, R3, R2, R1>(
        ...
        <R2, R1>(f2: (a: R1) => R2, f1: (...args: any[]) => R1): (
            ...args: any[]
        ) => R2;
        <R3, R2, R1>(
            f3: (a: R2) => R3,
    ...
    type LodashCond = <T, R>(
        pairs: Array<lodash.CondPair<T, R>>
    ) => (Target: T) => R;
    ...
    interface LodashCurry {
        ...
        <T1, T2, R>(func: (t1: T1, t2: T2) => R): lodash.CurriedFunction2<
            T1,
            T2,
            R
        >;
    ...
    interface LodashCurryN {
        ...
        <T1, R>(arity: number, func: (t1: T1) => R): lodash.CurriedFunction1<
            T1,
            R
        >;
        <T1, T2, R>(
    ...
    interface LodashCurryRight {
        ...
        <T1, T2, R>(func: (t1: T1, t2: T2) => R): lodash.RightCurriedFunction2<
            T1,
            T2,
            R
        >;
    ...
    interface LodashCurryRightN {
        ...
        <T1, R>(arity: lodash.__, func: (t1: T1) => R): LodashCurryRightN1x2<
            T1,
            R
        >;
        <T1, R>(
    ...
    interface LodashDebounce {
        ...
        <T extends (...args: any[]) => any>(wait: number, func: T): T &
            lodash.Cancelable;
    }
    ...
    interface LodashDefaults {
        ...
        <TObject>(source: lodash.__, object: TObject): LodashDefaults1x2<
            TObject
        >;
    ...
    interface LodashDefaultTo {
        ...
        <T, TDefault>(defaultValue: TDefault, value: T | null | undefined):
            | T
            | TDefault;
    }
    ...
    interface LodashDifferenceBy1x1<T1, T2> {
        (array: lodash.List<T1> | null | undefined): LodashDifferenceBy1x3<
            T1,
            T2
        >;
    ...
    interface LodashDifferenceBy1x2<T1> {
        <T2>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashDifferenceBy1x3<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashDifferenceBy1x4<T2> {
        <T1>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashDifferenceBy1x5<
            T1
        >;
        <T1>(
            iteratee: lodash.__,
    ...
    interface LodashDifferenceWith1x1<T1, T2> {
        (array: lodash.List<T1> | null | undefined): LodashDifferenceWith1x3<
            T1,
            T2
        >;
        (array: lodash.__, values: lodash.List<T2>): LodashDifferenceWith1x5<
            T1
        >;
        (
            array: lodash.List<T1> | null | undefined,
    ...
    interface LodashDifferenceWith1x2<T1> {
        <T2>(comparator: lodash.Comparator2<T1, T2>): LodashDifferenceWith1x3<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashDifferenceWith1x4<T2> {
        <T1>(comparator: lodash.Comparator2<T1, T2>): LodashDifferenceWith1x5<
            T1
        >;
        <T1>(
            comparator: lodash.__,
    ...
    type LodashDropRightWhile1x2<T> = (
        predicate: lodash.ValueIteratee<T>
    ) => T[];
    ...
    interface LodashForEach {
        ...
        <T>(iteratee: lodash.__, collection: lodash.List<T>): LodashForEach2x2<
            T
        >;
        <T>(
    ...
    interface LodashForEach1x1<T> {
        ...
        <T1 extends object>(collection: T1 | null | undefined):
            | T1
            | null
            | undefined;
    }
    ...
    type LodashForEachRight5x2<T, TList> = (
        iteratee: (value: T) => any
    ) => TList;
    ...
    interface LodashToPairs {
        <T>(object: lodash.Dictionary<T> | lodash.NumericDictionary<T>): Array<
            [string, T]
        >;
    ...
    interface LodashExtendWith {
        ...
        <TObject>(customizer: lodash.__, object: TObject): LodashExtendWith1x2<
            TObject
        >;
        <TObject>(
            customizer: lodash.AssignCustomizer,
    ...
    interface LodashExtendWith1x1 {
        ...
        <TSource>(object: lodash.__, source: TSource): LodashExtendWith1x5<
            TSource
        >;
        <TObject, TSource>(object: TObject, source: TSource): TObject & TSource;
    }
    interface LodashExtendWith1x2<TObject> {
        ...
        <TSource>(customizer: lodash.__, source: TSource): LodashExtendWith1x6<
            TObject,
            TSource
        >;
        <TSource>(
    ...
    interface LodashExtendWith1x4<TSource> {
        ...
        <TObject>(customizer: lodash.__, object: TObject): LodashExtendWith1x6<
            TObject,
            TSource
        >;
        <TObject>(
    ...
    interface LodashFill1x1 {
        ...
        <T, U>(end: number, value: T, array: U[] | null | undefined): Array<
            T | U
        >;
        <U>(
            end: lodash.__,
    ...
    interface LodashFill1x2 {
        ...
        <T, U>(start: number, value: T, array: U[] | null | undefined): Array<
            T | U
        >;
        <U>(
            start: lodash.__,
    ...
    interface LodashFill1x3 {
        ...
        <T, U>(value: T, array: lodash.List<U> | null | undefined): lodash.List<
            T | U
        >;
    }
    interface LodashFill1x4<T> {
        ...
        <U>(start: number, end: number, array: U[] | null | undefined): Array<
            T | U
        >;
        <U>(
            start: lodash.__,
    ...
    interface LodashFill1x5<T> {
        ...
        <U>(end: lodash.__, array: U[] | null | undefined): LodashFill1x13<
            T,
            U
        >;
        ...
        <U>(end: number, array: lodash.List<U> | null | undefined): lodash.List<
            T | U
        >;
    }
    interface LodashFill1x6<T> {
        (start: number): LodashFill1x7<T>;
        <U>(start: lodash.__, array: U[] | null | undefined): LodashFill1x14<
            T,
            U
        >;
    ...
    interface LodashFilter {
        ...
        <T>(predicate: lodash.ValueIterateeCustom<T, boolean>): LodashFilter2x1<
            T
        >;
        <T>(
            predicate: lodash.ValueIterateeCustom<T, boolean>,
    ...
    interface LodashFilter3x2<T> {
        ...
        (predicate: lodash.ValueIterateeCustom<T[keyof T], boolean>): Array<
            T[keyof T]
        >;
    }
    interface LodashFind {
        ...
        <T>(predicate: lodash.ValueIterateeCustom<T, boolean>): LodashFind2x1<
            T
        >;
        <T>(
            predicate: lodash.ValueIterateeCustom<T, boolean>,
    ...
    interface LodashFind1x2<T> {
        <S extends T>(predicate: lodash.ValueIteratorTypeGuard<T, S>):
            | S
            | undefined;
    ...
    interface LodashFindFrom1x1<T, S> {
        ...
        (fromIndex: number, collection: lodash.List<T> | null | undefined):
            | S
            | undefined;
    }
    ...
    interface LodashFindFrom1x4<T> {
        ...
        (predicate: lodash.ValueIterateeCustom<T, boolean>): LodashFindFrom2x5<
            T
        >;
        (predicate: lodash.ValueIterateeCustom<T, boolean>, fromIndex: number):
            | T
            | undefined;
    }
    ...
    interface LodashFindLastIndexFrom1x4<T> {
        ...
        (predicate: lodash.__, fromIndex: number): LodashFindLastIndexFrom1x6<
            T
        >;
        (
            predicate: lodash.ValueIterateeCustom<T, boolean>,
    ...
    interface LodashForIn {
        ...
        <T>(iteratee: lodash.__, object: T | null | undefined): LodashForIn2x2<
            T
        >;
        <T>(
            iteratee: (value: T[keyof T]) => any,
    ...
    interface LodashForIn1x1<T> {
        ...
        <T1 extends object>(object: T1 | null | undefined):
            | T1
            | null
            | undefined;
    }
    ...
    interface LodashForOwn {
        ...
        <T>(iteratee: (value: T[keyof T]) => any, object: T): T;
        <T>(iteratee: lodash.__, object: T | null | undefined): LodashForOwn2x2<
            T
        >;
        <T>(
            iteratee: (value: T[keyof T]) => any,
    ...
    interface LodashGet {
        ...
        <T>(path: lodash.__, object: lodash.NumericDictionary<T>): LodashGet3x2<
            T
        >;
    ...
    type LodashGet1x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey];
    type LodashGet2x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey] | undefined;
    interface LodashGet3x1 {
        <T>(object: lodash.NumericDictionary<T>): T;
        <T>(object: lodash.NumericDictionary<T> | null | undefined):
            | T
            | undefined;
    }
    ...
    interface LodashGetOr {
        ...
        <TDefault>(defaultValue: TDefault, path: number): LodashGetOr2x3<
            TDefault
        >;
        <T>(
            defaultValue: lodash.__,
    ...
    interface LodashGetOr1x2<TObject, TKey extends keyof TObject> {
        <TDefault>(defaultValue: TDefault): LodashGetOr1x3<
            TObject,
            TKey,
            TDefault
        >;
    ...
    type LodashGetOr2x3<TDefault> = <T>(
        object: lodash.NumericDictionary<T> | null | undefined
    ) => T | TDefault;
    ...
    interface LodashKeyBy {
        ...
        <T extends object>(
            iteratee: lodash.ValueIterateeCustom<
                T[keyof T],
                lodash.PropertyName
            >,
            collection: T | null | undefined
    ...
    interface LodashIntersection {
        ...
        <T>(arrays2: lodash.__, arrays: lodash.List<T>): LodashIntersection1x2<
            T
        >;
    ...
    interface LodashIntersectionBy1x1<T1, T2> {
        ...
        (array: lodash.__, values: lodash.List<T2>): LodashIntersectionBy1x5<
            T1
        >;
        (array: lodash.List<T1> | null, values: lodash.List<T2>): T1[];
    }
    interface LodashIntersectionBy1x2<T1> {
        <T2>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashIntersectionBy1x3<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashIntersectionBy1x4<T2> {
        <T1>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashIntersectionBy1x5<
            T1
        >;
        <T1>(
            iteratee: lodash.__,
    ...
    interface LodashIntersectionWith1x1<T1, T2> {
        (array: lodash.List<T1> | null | undefined): LodashIntersectionWith1x3<
            T1,
            T2
        >;
        (array: lodash.__, values: lodash.List<T2>): LodashIntersectionWith1x5<
            T1
        >;
        (
            array: lodash.List<T1> | null | undefined,
    ...
    interface LodashIntersectionWith1x2<T1> {
        <T2>(comparator: lodash.Comparator2<T1, T2>): LodashIntersectionWith1x3<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashIntersectionWith1x4<T2> {
        <T1>(comparator: lodash.Comparator2<T1, T2>): LodashIntersectionWith1x5<
            T1
        >;
        <T1>(
            comparator: lodash.__,
    ...
    interface LodashInvokeArgsMap {
        ...
        <TResult>(method: (...args: any[]) => TResult): LodashInvokeArgsMap2x1<
            TResult
        >;
        <TResult>(
    ...
    interface LodashInvokeArgsMap1x2 {
        ...
        <TResult>(method: (...args: any[]) => TResult): LodashInvokeArgsMap2x3<
            TResult
        >;
        <TResult>(
            method: (...args: any[]) => TResult,
    ...
    interface LodashInvokeArgsMap1x4 {
        ...
        <TResult>(method: (...args: any[]) => TResult): LodashInvokeArgsMap2x5<
            TResult
        >;
        <TResult>(
            method: (...args: any[]) => TResult,
    ...
    type LodashInvokeArgsMap2x5<TResult> = (
        args: ReadonlyArray<any>
    ) => TResult[];
    interface LodashInvokeMap {
        ...
        (methodName: string, collection: object | null | undefined): any[];
        <TResult>(method: (...args: any[]) => TResult): LodashInvokeMap2x1<
            TResult
        >;
        <TResult>(
            method: (...args: any[]) => TResult,
    ...
    interface LodashLastIndexOfFrom1x4<T> {
        ...
        (value: lodash.__, fromIndex: true | number): LodashLastIndexOfFrom1x6<
            T
        >;
    ...
    interface LodashMapValues {
        <T, TResult>(callback: (value: T) => TResult): LodashMapValues1x1<
            T,
            TResult
        >;
        <T>(
        ...
        <T extends object>(iteratee: object, obj: T | null | undefined): {
        ...
        <T extends object>(iteratee: string, obj: T | null | undefined): {
            [P in keyof T]: any
        };
    }
    ...
    type LodashMapValues2x1<T, TResult> = (
        obj: T | null | undefined
    ) => { [P in keyof T]: TResult };
    ...
    interface LodashMapValues3x1 {
        ...
        <T extends object>(obj: T | null | undefined): {
            [P in keyof T]: boolean
        };
    }
    ...
    type LodashMaxBy1x2<T> = (
        iteratee: lodash.ValueIteratee<T>
    ) => T | undefined;
    type LodashMean = (
        collection: lodash.List<any> | null | undefined
    ) => number;
    ...
    interface LodashMergeWith1x1 {
        ...
        <TSource>(object: lodash.__, source: TSource): LodashMergeWith1x5<
            TSource
        >;
        <TObject, TSource>(object: TObject, source: TSource): TObject & TSource;
    }
    interface LodashMergeWith1x2<TObject> {
        ...
        <TSource>(customizer: lodash.__, source: TSource): LodashMergeWith1x6<
            TObject,
            TSource
        >;
        <TSource>(
    ...
    interface LodashMergeWith1x4<TSource> {
        ...
        <TObject>(customizer: lodash.__, object: TObject): LodashMergeWith1x6<
            TObject,
            TSource
        >;
        <TObject>(
    ...
    interface LodashOmit1x1 {
        ...
        <T extends object>(object: T | null | undefined): lodash.PartialObject<
            T
        >;
    }
    type LodashOmit1x2<T> = (paths: lodash.Many<lodash.PropertyName>) => T;
    type LodashOmit2x1<T, K extends keyof T> = (
        object: T | null | undefined
    ) => lodash.Omit<T, K>;
    ...
    interface LodashOrderBy {
        ...
        <T>(iteratees: lodash.Many<lodash.ValueIteratee<T>>): LodashOrderBy2x1<
            T
        >;
        <T>(
    ...
    interface LodashOrderBy1x2 {
        ...
        <T>(iteratees: lodash.Many<lodash.ValueIteratee<T>>): LodashOrderBy2x3<
            T
        >;
        <T extends object>(
            iteratees: lodash.__,
    ...
    interface LodashPartial {
        ...
        <T1, T2, R>(func: lodash.Function2<T1, T2, R>): LodashPartial2x1<
            T1,
            T2,
            R
        >;
        ...
        <T1, T3>(func: lodash.__, arg1: [T1, lodash.__, T3]): LodashPartial9x2<
            T1,
            T3
        >;
        <T1, T2, T3, R>(
        ...
        <T2, T3>(func: lodash.__, plc1: [lodash.__, T2, T3]): LodashPartial10x2<
            T2,
            T3
        >;
        <T1, T2, T3, R>(
        ...
        <T1, T2, T3>(func: lodash.__, arg1: [T1, T2, T3]): LodashPartial11x2<
            T1,
            T2,
            T3
        >;
        ...
        ): LodashPartial12x1<T1, T2, T3, T4, R>;
        <T1, T2, T3, T4, R>(
            func: lodash.Function4<T1, T2, T3, T4, R>,
            arg1: [T1]
        ...
        (func: (...args: any[]) => any, args: ReadonlyArray<any>): (
            ...args: any[]
        ) => any;
        placeholder: lodash.__;
    }
    ...
    interface LodashPartial1x2<T1> {
        ...
        <T2, T3, R>(func: lodash.Function3<T1, T2, T3, R>): lodash.Function2<
            T2,
            T3,
            R
        >;
    ...
    interface LodashPartial3x2<T2> {
        ...
        <T1, T3, R>(func: lodash.Function3<T1, T2, T3, R>): lodash.Function2<
            T1,
            T3,
            R
        >;
    ...
    interface LodashPartial8x2<T3> {
        <T1, T2, R>(func: lodash.Function3<T1, T2, T3, R>): lodash.Function2<
            T1,
            T2,
            R
        >;
    ...
    interface LodashPartial11x2<T1, T2, T3> {
        ...
        <T4, R>(func: lodash.Function4<T1, T2, T3, T4, R>): lodash.Function1<
            T4,
            R
        >;
    }
    interface LodashPartial12x1<T1, T2, T3, T4, R> {
        ...
        (plc1: [lodash.__, lodash.__, lodash.__, T4]): lodash.Function3<
            T1,
            T2,
            T3,
            R
    ...
    type LodashPartial22x2<T1, T2, T4> = <T3, R>(
        func: lodash.Function4<T1, T2, T3, T4, R>
    ) => lodash.Function1<T3, R>;
    type LodashPartial23x2<T3, T4> = <T1, T2, R>(
        func: lodash.Function4<T1, T2, T3, T4, R>
    ) => lodash.Function2<T1, T2, R>;
    type LodashPartial24x2<T1, T3, T4> = <T2, R>(
        func: lodash.Function4<T1, T2, T3, T4, R>
    ) => lodash.Function1<T2, R>;
    type LodashPartial25x2<T2, T3, T4> = <T1, R>(
        func: lodash.Function4<T1, T2, T3, T4, R>
    ) => lodash.Function1<T1, R>;
    type LodashPartial26x2<T1, T2, T3, T4> = <R>(
        func: lodash.Function4<T1, T2, T3, T4, R>
    ) => lodash.Function0<R>;
    type LodashPartial27x1 = (
        args: ReadonlyArray<any>
    ) => (...args: any[]) => any;
    type LodashPartial27x2 = (
        func: (...args: any[]) => any
    ) => (...args: any[]) => any;
    interface LodashPartialRight {
        ...
        <T1, R>(func: lodash.Function1<T1, R>, arg1: [T1]): lodash.Function0<R>;
        <T1, T2, R>(func: lodash.Function2<T1, T2, R>): LodashPartialRight2x1<
            T1,
            T2,
            R
        >;
        ...
        <T1, T2>(func: lodash.__, arg1: [T1, T2]): LodashPartialRight4x2<
            T1,
            T2
        >;
        <T1, T2, R>(
        ...
        <T2, T3>(func: lodash.__, arg2: [T2, T3]): LodashPartialRight10x2<
            T2,
            T3
        >;
        <T1, T2, T3, R>(
        ...
        <T3>(func: lodash.__, arg3: [T3, lodash.__]): LodashPartialRight15x2<
            T3
        >;
        <T1, T2, T3, T4, R>(
            func: lodash.Function4<T1, T2, T3, T4, R>,
        ...
        <T3, T4>(func: lodash.__, arg3: [T3, T4]): LodashPartialRight23x2<
            T3,
            T4
        >;
        <T1, T2, T3, T4, R>(
    ...
    type LodashPartition1x1<T> = (
        collection: lodash.List<T> | object | null | undefined
    ) => [T[], T[]];
    type LodashPartition1x2<T> = (
        callback: lodash.ValueIteratee<T>
    ) => [T[], T[]];
    type LodashPartition2x2<T> = (
        callback: lodash.ValueIteratee<T[keyof T]>
    ) => [Array<T[keyof T]>, Array<T[keyof T]>];
    ...
    type LodashPath1x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey];
    type LodashPath2x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey] | undefined;
    ...
    interface LodashPathOr {
        ...
        <TDefault>(defaultValue: TDefault, path: number): LodashPathOr2x3<
            TDefault
        >;
        <T>(
            defaultValue: lodash.__,
    ...
    interface LodashPathOr1x2<TObject, TKey extends keyof TObject> {
        <TDefault>(defaultValue: TDefault): LodashPathOr1x3<
            TObject,
            TKey,
            TDefault
        >;
    ...
    type LodashPathOr2x3<TDefault> = <T>(
        object: lodash.NumericDictionary<T> | null | undefined
    ) => T | TDefault;
    ...
    type LodashPathOr2x6<T> = <TDefault>(
        defaultValue: TDefault
    ) => T | TDefault;
    ...
    type LodashProp1x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey];
    type LodashProp2x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey] | undefined;
    ...
    type LodashProperty1x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey];
    type LodashProperty2x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey] | undefined;
    ...
    type LodashPropertyOf1x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey];
    type LodashPropertyOf2x2<TObject> = <TKey extends keyof TObject>(
        path: TKey | [TKey]
    ) => TObject[TKey] | undefined;
    ...
    interface LodashPropOr {
        ...
        <TDefault>(defaultValue: TDefault, path: number): LodashPropOr2x3<
            TDefault
        >;
        <T>(
            defaultValue: lodash.__,
    ...
    interface LodashPropOr1x2<TObject, TKey extends keyof TObject> {
        <TDefault>(defaultValue: TDefault): LodashPropOr1x3<
            TObject,
            TKey,
            TDefault
        >;
    ...
    type LodashPropOr2x3<TDefault> = <T>(
        object: lodash.NumericDictionary<T> | null | undefined
    ) => T | TDefault;
    ...
    type LodashPropOr2x6<T> = <TDefault>(
        defaultValue: TDefault
    ) => T | TDefault;
    ...
    interface LodashPullAllBy {
        ...
        <T1, T2>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashPullAllBy3x1<
            T1,
            T2
        >;
        <T2>(iteratee: lodash.__, values: lodash.List<T2>): LodashPullAllBy3x2<
            T2
        >;
        <T1, T2>(
            iteratee: lodash.ValueIteratee<T1 | T2>,
    ...
    interface LodashPullAllBy1x2<T> {
        ...
        (iteratee: lodash.ValueIteratee<T>, array: lodash.List<T>): lodash.List<
            T
        >;
    }
    ...
    interface LodashPullAllBy3x1<T1, T2> {
        ...
        (values: lodash.__, array: ReadonlyArray<T1>): LodashPullAllBy3x5<
            T1,
            T2
        >;
    ...
    interface LodashPullAllBy3x2<T2> {
        ...
        <T1>(iteratee: lodash.__, array: ReadonlyArray<T1>): LodashPullAllBy3x6<
            T1,
            T2
        >;
        <T1>(
        ...
        <T1>(iteratee: lodash.__, array: lodash.List<T1>): LodashPullAllBy4x6<
            T1,
            T2
        >;
        <T1>(
    ...
    interface LodashPullAllBy3x4<T1> {
        <T2>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashPullAllBy3x5<
            T1,
            T2
        >;
        <T2>(iteratee: lodash.__, values: lodash.List<T2>): LodashPullAllBy3x6<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashPullAllBy4x4<T1> {
        <T2>(iteratee: lodash.ValueIteratee<T1 | T2>): LodashPullAllBy4x5<
            T1,
            T2
        >;
        <T2>(iteratee: lodash.__, values: lodash.List<T2>): LodashPullAllBy4x6<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashPullAllWith {
        ...
        <T1, T2>(comparator: lodash.Comparator2<T1, T2>): LodashPullAllWith3x1<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashPullAllWith1x2<T> {
        ...
        (comparator: lodash.__, array: ReadonlyArray<T>): LodashPullAllWith1x6<
            T
        >;
        (comparator: lodash.Comparator<T>, array: ReadonlyArray<T>): T[];
        (comparator: lodash.__, array: lodash.List<T>): LodashPullAllWith2x6<T>;
        (comparator: lodash.Comparator<T>, array: lodash.List<T>): lodash.List<
            T
        >;
    }
    ...
    interface LodashPullAllWith1x4<T> {
        ...
        (comparator: lodash.__, values: lodash.List<T>): LodashPullAllWith1x6<
            T
        >;
    ...
    interface LodashPullAllWith2x4<T> {
        ...
        (comparator: lodash.__, values: lodash.List<T>): LodashPullAllWith2x6<
            T
        >;
        (comparator: lodash.Comparator<T>, values: lodash.List<T>): lodash.List<
            T
        >;
    }
    ...
    interface LodashPullAllWith3x1<T1, T2> {
        ...
        (values: lodash.__, array: ReadonlyArray<T1>): LodashPullAllWith3x5<
            T1,
            T2
        >;
        (values: lodash.List<T2>, array: ReadonlyArray<T1>): T1[];
        (values: lodash.__, array: lodash.List<T1>): LodashPullAllWith4x5<
            T1,
            T2
        >;
        (values: lodash.List<T2>, array: lodash.List<T1>): lodash.List<T1>;
    ...
    interface LodashPullAllWith3x4<T1> {
        <T2>(comparator: lodash.Comparator2<T1, T2>): LodashPullAllWith3x5<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashPullAllWith4x4<T1> {
        <T2>(comparator: lodash.Comparator2<T1, T2>): LodashPullAllWith4x5<
            T1,
            T2
        >;
        <T2>(
    ...
    interface LodashPullAt {
        ...
        <T>(indexes: lodash.Many<number>, array: lodash.List<T>): lodash.List<
            T
        >;
    }
    ...
    interface LodashRearg {
        ...
        (indexes: lodash.Many<number>, func: (...args: any[]) => any): (
            ...args: any[]
        ) => any;
    }
    type LodashRearg1x1 = (
    ...
    interface LodashReduce {
        ...
        <TResult>(callback: lodash.__, accumulator: TResult): LodashReduce1x2<
            TResult
        >;
        <T, TResult>(
            callback: lodash.MemoIteratorCapped<T, TResult>,
    ...
    interface LodashReduce1x2<TResult> {
        <T>(callback: lodash.MemoIteratorCapped<T, TResult>): LodashReduce1x3<
            T,
            TResult
        >;
        <T>(
    ...
    interface LodashReduce1x4<T> {
        ...
        <TResult>(callback: lodash.__, accumulator: TResult): LodashReduce1x6<
            T,
            TResult
        >;
        <TResult>(
    ...
    interface LodashReduce2x4<T> {
        ...
        <TResult>(callback: lodash.__, accumulator: TResult): LodashReduce2x6<
            T,
            TResult
        >;
        <TResult>(
    ...
    interface LodashReduce3x4<T> {
        ...
        <TResult>(callback: lodash.__, accumulator: TResult): LodashReduce3x6<
            T,
            TResult
        >;
        <TResult>(
    ...
    interface LodashReject {
        <T>(predicate: lodash.ValueIterateeCustom<T, boolean>): LodashReject1x1<
            T
        >;
        <T>(
            predicate: lodash.__,
    ...
    type LodashReverse = <TList extends lodash.List<any>>(
        array: TList
    ) => TList;
    ...
    interface LodashSample {
        ...
        <T extends object>(collection: T | null | undefined):
            | T[keyof T]
            | undefined;
    }
    interface LodashSampleSize {
        ...
        <T extends object>(n: number, collection: T | null | undefined): Array<
            T[keyof T]
        >;
    }
    ...
    interface LodashSetWith1x6 {
        ...
        <T extends object>(customizer: lodash.__, object: T): LodashSetWith1x14<
            T
        >;
        <T extends object>(
            customizer: lodash.SetWithCustomizer<T>,
    ...
    interface LodashSortBy {
        <T>(iteratees: lodash.Many<lodash.ValueIteratee<T>>): LodashSortBy1x1<
            T
        >;
        <T>(
            iteratees: lodash.__,
    ...
    interface LodashSpreadFrom {
        ...
        <TResult>(start: number, func: (...args: any[]) => TResult): (
            ...args: any[]
        ) => TResult;
    }
    ...
    type LodashTakeRightWhile1x2<T> = (
        predicate: lodash.ValueIteratee<T>
    ) => T[];
    ...
    interface LodashThru {
        <T, TResult>(interceptor: (value: T) => TResult): LodashThru1x1<
            T,
            TResult
        >;
    ...
    interface LodashTransform {
        ...
        <T, TResult>(
            iteratee: lodash.MemoVoidIteratorCapped<
                T,
                lodash.Dictionary<TResult>
            >
    ...
    interface LodashTransform1x1<T, TResult> {
        ...
        (accumulator: lodash.__, object: ReadonlyArray<T>): LodashTransform1x5<
            TResult
        >;
        (
            accumulator: ReadonlyArray<TResult>,
    ...
    interface LodashTransform1x2<TResult> {
        ...
        <T>(iteratee: lodash.__, object: ReadonlyArray<T>): LodashTransform1x6<
            T,
            TResult
        >;
        <T>(
    ...
    type LodashTransform1x5<TResult> = (
        accumulator: ReadonlyArray<TResult>
    ) => TResult[];
    ...
    interface LodashTransform2x1<T, TResult> {
        (accumulator: lodash.Dictionary<TResult>): LodashTransform2x3<
            T,
            TResult
        >;
        (accumulator: lodash.__, object: ReadonlyArray<T>): LodashTransform2x5<
            TResult
        >;
        (
            accumulator: lodash.Dictionary<TResult>,
    ...
    interface LodashTransform2x2<TResult> {
        ...
        <T>(iteratee: lodash.__, object: ReadonlyArray<T>): LodashTransform2x6<
            T,
            TResult
        >;
        <T>(
    ...
    type LodashTransform2x5<TResult> = (
        accumulator: lodash.Dictionary<TResult>
    ) => lodash.Dictionary<TResult>;
    ...
    type LodashTransform3x5<TResult> = (
        accumulator: lodash.Dictionary<TResult>
    ) => lodash.Dictionary<TResult>;
    type LodashTransform3x6<T, TResult> = (
        iteratee: lodash.MemoVoidIteratorCapped<T, lodash.Dictionary<TResult>>
    ) => lodash.Dictionary<TResult>;
    type LodashTransform4x5<TResult> = (
        accumulator: ReadonlyArray<TResult>
    ) => TResult[];
    type LodashTransform4x6<T, TResult> = (
        iteratee: lodash.MemoVoidIteratorCapped<T, TResult[]>
    ) => TResult[];
    ...
    interface LodashUnzipWith {
        <T, TResult>(iteratee: (...values: T[]) => TResult): LodashUnzipWith1x1<
            T,
            TResult
        >;
        <T>(
    ...
    interface LodashUpdateWith1x1<T> {
        ...
        (path: lodash.__, updater: (oldValue: any) => any): LodashUpdateWith1x5<
            T
        >;
        (
            path: lodash.PropertyPath,
        ...
        (path: lodash.__, updater: lodash.__, object: T): LodashUpdateWith1x9<
            T
        >;
        (
            path: lodash.PropertyPath,
    ...
    interface LodashWrap1x2<T> {
        <TArgs, TResult>(wrapper: (value: T, ...args: TArgs[]) => TResult): (
            ...args: TArgs[]
        ) => TResult;
        <TResult>(wrapper: (value: T, ...args: any[]) => TResult): (
            ...args: any[]
        ) => TResult;
    }
    ...
    interface LodashZip {
        ...
        <T1, T2>(arrays1: lodash.List<T1>, arrays2: lodash.List<T2>): Array<
    ...
    interface LodashZipAll {
        <T1, T2>(arrays1: [lodash.List<T1>, lodash.List<T2>]): Array<
            [T1 | undefined, T2 | undefined]
        >;
        <T1, T2, T3>(
        ...
        >;
        <T>(arrays: ReadonlyArray<lodash.List<T> | null | undefined>): Array<
            Array<T | undefined>
        >;
    }
    ...
    interface LodashZipWith {
        ...
        <T1>(iteratee: lodash.__, arrays1: lodash.List<T1>): LodashZipWith1x2<
            T1
        >;
        <T1, T2, TResult>(
            iteratee: (value1: T1, value2: T2) => TResult,
    ...
    interface LodashZipWith1x1<T1, T2, TResult> {
        ...
        (arrays1: lodash.__, arrays2: lodash.List<T2>): LodashZipWith1x5<
            T1,
            TResult
        >;
    ...
    interface LodashZipWith1x2<T1> {
        ...
        <T2>(iteratee: lodash.__, arrays2: lodash.List<T2>): LodashZipWith1x6<
            T1,
            T2
        >;
        <T2, TResult>(
    ...
    type LodashZipWith1x3<T2, TResult> = (
        arrays2: lodash.List<T2>
    ) => TResult[];
    interface LodashZipWith1x4<T2> {
        ...
        <T1>(iteratee: lodash.__, arrays1: lodash.List<T1>): LodashZipWith1x6<
            T1,
            T2
        >;
        <T1, TResult>(
    ...
    type LodashZipWith1x5<T1, TResult> = (
        arrays1: lodash.List<T1>
    ) => TResult[];
