...
var keys: IKey[] = [{ dir: "left", code: 97 }, { dir: "right", code: 100 }];
...
result = <_.LoDashImplicitArrayWrapper<number>>(
    _([1, 2, 3, 4]).sort((a, b) => 1)
);
result = <_.LoDashImplicitArrayWrapper<number>>_([1, 2, 3, 4]).splice(1);
result = <_.LoDashImplicitArrayWrapper<number>>(
    _([1, 2, 3, 4]).splice(1, 2, 5, 6)
);
...
namespace TestDifference {
...

    {
        ...
        result = _(array)
            .chain()
            .difference(list, array);
        result = _(array)
            .chain()
            .difference(array, list, array);
        ...
        result = _(list)
            .chain()
            .difference<TResult>(list);
        result = _(list)
            .chain()
            .difference<TResult>(array, list);
        result = _(list)
            .chain()
            .difference<TResult>(list, array, list);
    }
}
...
namespace TestDropRightWhile {
...

    {
        ...
        result = _(array)
            .chain()
            .dropRightWhile(predicateFn);
        result = _(array)
            .chain()
            .dropRightWhile(predicateFn, any);
        result = _(array)
            .chain()
            .dropRightWhile("");
        result = _(array)
        ...
        result = _(array)
            .chain()
            .dropRightWhile<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .dropRightWhile<TResult>();
        result = _(list)
            .chain()
            .dropRightWhile<TResult>(predicateFn);
        result = _(list)
            .chain()
            .dropRightWhile<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .dropRightWhile<TResult>("");
        result = _(list)
            .chain()
            .dropRightWhile<TResult>("", any);
        result = _(list)
            .chain()
            .dropRightWhile<{ a: number }, TResult>({ a: 42 });
    }
}
...
namespace TestDropWhile {
...

    {
        ...
        result = _(array)
            .chain()
            .dropWhile(predicateFn);
        result = _(array)
            .chain()
            .dropWhile(predicateFn, any);
        result = _(array)
            .chain()
            .dropWhile("");
        result = _(array)
        ...
        result = _(list)
            .chain()
            .dropWhile<TResult>(predicateFn);
        result = _(list)
            .chain()
            .dropWhile<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .dropWhile<TResult>("");
        result = _(list)
            .chain()
            .dropWhile<TResult>("", any);
        result = _(list)
            .chain()
            .dropWhile<{ a: number }, TResult>({ a: 42 });
    }
}
...
namespace TestFindIndex {
...

    {
        ...
        result = _(list)
            .chain()
            .findIndex<TResult>(predicateFn);
        result = _(list)
            .chain()
            .findIndex<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .findIndex("");
        result = _(list)
...
namespace TestFindLastIndex {
...

    {
        ...
        result = _(list)
            .chain()
            .findLastIndex<TResult>(predicateFn);
        result = _(list)
            .chain()
            .findLastIndex<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .findLastIndex("");
        result = _(list)
...
namespace TestFirst {
...

    {
        ...
        result = _(array)
            .chain()
            .first<_.LoDashExplicitObjectWrapper<TResult>>();
        result = _(list)
            .chain()
            .first<_.LoDashExplicitObjectWrapper<TResult>>();
    }
...
namespace TestFlatten {
...

    {
        ...
        result = _.flatten<number>(
            { 0: 1, 1: [2, [3]], 2: [[4]], length: 3 },
            true
        );
    }
...

    {
        ...
        result = _({ 0: 1, 1: [2, [3]], 2: [[4]], length: 3 }).flatten<number>(
            true
        );
    }

    {
        ...
        result = _({ 0: 1, 1: [2, [3]], length: 2 }).flatten<
            number | number[]
        >();
        result = _({ 0: 1, 1: [2, [3]], 2: [[4]], length: 3 }).flatten<
            number | number[]
        >();
    }
...
namespace TestFlattenDeep {
...

    {
        ...
        result = _({ 0: 1, 1: [2, [3]], length: 2 }).flattenDeep<number>();
        result = _({ 0: 1, 1: [2, [3]], 2: [[4]], length: 3 }).flattenDeep<
            number
        >();
    }

    {
        ...
        result = _({ 0: 1, 1: [2, [3]], length: 2 }).flattenDeep<
            number | number[]
        >();
        result = _({ 0: 1, 1: [2, [3]], 2: [[4]], length: 3 }).flattenDeep<
            number | number[]
...
namespace TestHead {
...

    {
        ...
        result = _(array)
            .chain()
            .head<_.LoDashExplicitObjectWrapper<TResult>>();
        result = _(list)
            .chain()
            .head<_.LoDashExplicitObjectWrapper<TResult>>();
    }
...
namespace TestIndexOf {
...

    {
        ...
        result = _(list)
            .chain()
            .indexOf<TResult>(value);
        result = _(list)
            .chain()
            .indexOf<TResult>(value, true);
        result = _(list)
            .chain()
            .indexOf<TResult>(value, 42);
    }
}
...
namespace TestIntersection {
...

    {
        ...
        result = _(array)
            .chain()
            .intersection<TResult>(array);
        result = _(array)
            .chain()
            .intersection<TResult>(list, array);
...
namespace TestLast {
...

    {
        ...
        result = _(array)
            .chain()
            .last<_.LoDashExplicitObjectWrapper<TResult>>();
    }
...
namespace TestLastIndexOf {
...

    {
        ...
        result = _(array)
            .chain()
            .lastIndexOf(value, true);
        result = _(array)
            .chain()
            .lastIndexOf(value, 42);

        result = _(list)
            .chain()
            .lastIndexOf<TResult>(value);
        result = _(list)
            .chain()
            .lastIndexOf<TResult>(value, true);
        result = _(list)
            .chain()
            .lastIndexOf<TResult>(value, 42);
    }
}
...
namespace TestObject {
...

    {
        ...
        result = _.object<number, _.Dictionary<number>>(
            arrayOfKeys,
            arrayOfValues
        );
        result = _.object<number, _.Dictionary<number>>(
...

    {
        ...
        result = _(arrayOfKeys).object<number, _.Dictionary<number>>(
            arrayOfValues
        );
        result = _(arrayOfKeys).object<number, _.Dictionary<number>>(
            listOfValues
        );
        result = _(listOfKeys).object<number, _.Dictionary<number>>(
            listOfValues
        );
        result = _(listOfKeys).object<number, _.Dictionary<number>>(
            arrayOfValues
        ...
        result = _(listOfKeys).object<_.Dictionary<number>>(
...

    {
        ...
        result = _(arrayOfKeys)
            .chain()
            .object<_.Dictionary<void>>();
        result = _(listOfKeys)
            .chain()
            .object<_.Dictionary<void>>();
    }

    {
        ...
        result = _(arrayOfKeys)
            .chain()
            .object<_.Dictionary<number>>(arrayOfValues);
        result = _(arrayOfKeys)
            .chain()
            .object<_.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
            .chain()
            .object<_.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
        ...
        result = _(arrayOfKeys)
            .chain()
            .object<number, _.Dictionary<number>>(arrayOfValues);
        result = _(arrayOfKeys)
            .chain()
            .object<number, _.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
            .chain()
            .object<number, _.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
        ...
        result = _(listOfKeys)
            .chain()
            .object<_.Dictionary<number>>(arrayOfKeyValuePairs);
        result = _(listOfKeys)
            .chain()
            .object<_.Dictionary<number>>(listOfKeyValuePairs);
    }

    {
        ...
        result = _(listOfKeys)
            .chain()
            .object(arrayOfKeyValuePairs);
        result = _(listOfKeys)
            .chain()
            .object(listOfKeyValuePairs);
    }
}
...
namespace TestPull {
...

    {
        ...
        result = _(list)
            .chain()
            .pull<TResult>(value, value);
        result = _(list)
            .chain()
            .pull<TResult>(value, value, value);
    }
}
...
namespace TestPullAt {
...

    {
        ...
        result = _(list)
            .chain()
            .pullAt<TResult>([2, 3], 1);
        result = _(list)
            .chain()
            .pullAt<TResult>(4, [2, 3], 1);
    }
}
...
namespace TestRemove {
...

    {
        ...
        result = _(list)
            .chain()
            .remove<TResult>(predicateFn);
        result = _(list)
            .chain()
            .remove<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .remove<TResult>("");
        result = _(list)
...
namespace TestSortedIndex {
...

    {
        ...
        result = _.sortedIndex<SampleType, number>(
            array,
            value,
            arrayIterator,
            any
        );
        result = _.sortedIndex<{ a: number }, SampleType>(array, value, {
            a: 42
        });
        ...
        result = _.sortedIndex<{ a: number }, SampleType>(list, value, {
            a: 42
        });
        ...
        result = _(list).sortedIndex<SampleType, number>(
            value,
            listIterator,
            any
        );
        result = _(list).sortedIndex<{ a: number }, SampleType>(value, {
            a: 42
        });
    }

    {
        ...
        result = _("")
            .chain()
            .sortedIndex<number>("", stringIterator);
        result = _("")
            .chain()
            .sortedIndex<number>("", stringIterator, any);
        ...
        result = _(array)
            .chain()
            .sortedIndex<number>(value, arrayIterator);
        result = _(array)
            .chain()
            .sortedIndex<number>(value, arrayIterator, any);
        result = _(array)
            .chain()
            .sortedIndex(value, "");
        result = _(array)
            .chain()
            .sortedIndex<{ a: number }>(value, { a: 42 });

        result = _(list)
            .chain()
            .sortedIndex<SampleType>(value);
        result = _(list)
            .chain()
            .sortedIndex<SampleType>(value, listIterator);
        result = _(list)
            .chain()
            .sortedIndex<SampleType>(value, listIterator, any);
        result = _(list)
            .chain()
            .sortedIndex<SampleType>(value, "");
        result = _(list)
            .chain()
            .sortedIndex<SampleType>(value, { a: 42 });
        result = _(list)
            .chain()
            .sortedIndex<SampleType, number>(value, listIterator);
        result = _(list)
            .chain()
            .sortedIndex<SampleType, number>(value, listIterator, any);
        result = _(list)
            .chain()
            .sortedIndex<{ a: number }, SampleType>(value, { a: 42 });
    }
}
...
namespace TestSortedLastIndex {
...

    {
        ...
        result = _.sortedLastIndex<SampleType>(
            array,
            value,
            arrayIterator,
            any
        ...
        result = _.sortedLastIndex<SampleType, number>(
            array,
            value,
            arrayIterator
        );
        ...
        result = _.sortedLastIndex<{ a: number }, SampleType>(array, value, {
            a: 42
        });
        ...
        result = _.sortedLastIndex<{ a: number }, SampleType>(list, value, {
            a: 42
        });
        ...
        result = _(list).sortedLastIndex<SampleType, number>(
            value,
            listIterator
        );
        result = _(list).sortedLastIndex<SampleType, number>(
        ...
        result = _(list).sortedLastIndex<{ a: number }, SampleType>(value, {
            a: 42
        });
    }

    {
        ...
        result = _("")
            .chain()
            .sortedLastIndex<number>("", stringIterator);
        result = _("")
            .chain()
            .sortedLastIndex<number>("", stringIterator, any);
        ...
        result = _(array)
            .chain()
            .sortedLastIndex<number>(value, arrayIterator);
        result = _(array)
            .chain()
            .sortedLastIndex<number>(value, arrayIterator, any);
        result = _(array)
            .chain()
            .sortedLastIndex(value, "");
        result = _(array)
            .chain()
            .sortedLastIndex<{ a: number }>(value, { a: 42 });

        result = _(list)
            .chain()
            .sortedLastIndex<SampleType>(value);
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType>(value, listIterator);
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType>(value, listIterator, any);
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType>(value, "");
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType>(value, { a: 42 });
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType, number>(value, listIterator);
        result = _(list)
            .chain()
            .sortedLastIndex<SampleType, number>(value, listIterator, any);
        result = _(list)
            .chain()
            .sortedLastIndex<{ a: number }, SampleType>(value, { a: 42 });
    }
}
...
namespace TestTakeRightWhile {
...

    {
        ...
        result = _(array)
            .chain()
            .takeRightWhile(predicateFn);
        result = _(array)
            .chain()
            .takeRightWhile(predicateFn, any);
        result = _(array)
            .chain()
            .takeRightWhile("");
        result = _(array)
        ...
        result = _(array)
            .chain()
            .takeRightWhile<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .takeRightWhile<TResult>();
        result = _(list)
            .chain()
            .takeRightWhile<TResult>(predicateFn);
        result = _(list)
            .chain()
            .takeRightWhile<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .takeRightWhile<TResult>("");
        result = _(list)
            .chain()
            .takeRightWhile<TResult>("", any);
        result = _(list)
            .chain()
            .takeRightWhile<{ a: number }, TResult>({ a: 42 });
    }
}
...
namespace TestTakeWhile {
...

    {
        ...
        result = _(list)
            .chain()
            .takeWhile<TResult>(predicateFn);
        result = _(list)
            .chain()
            .takeWhile<TResult>(predicateFn, any);
        result = _(list)
            .chain()
            .takeWhile<TResult>("");
        result = _(list)
            .chain()
            .takeWhile<TResult>("", any);
        result = _(list)
            .chain()
            .takeWhile<{ a: number }, TResult>({ a: 42 });
    }
}
...
namespace TestUniq {
    ...
    let listIterator: (
        value: SampleObject,
        index: number,
        collection: _.List<SampleObject>
    ) => number;
...

    {
        ...
        result = _("abc")
            .chain()
            .uniq<string>(true, stringIterator);
        result = _("abc")
            .chain()
            .uniq<string>(true, stringIterator, any);
        result = _("abc")
            .chain()
            .uniq<string>(stringIterator);
        result = _("abc")
            .chain()
            .uniq<string>(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .uniq<number>(true, listIterator);
        result = _(array)
            .chain()
            .uniq<number>(true, listIterator, any);
        result = _(array)
            .chain()
            .uniq<number>(listIterator);
        result = _(array)
            .chain()
            .uniq<number>(listIterator, any);
        result = _(array)
            .chain()
            .uniq(true, "a");
        result = _(array)
        ...
        result = _(list)
            .chain()
            .uniq<SampleObject>(true);
        result = _(list)
            .chain()
            .uniq<SampleObject>(true, listIterator);
        result = _(list)
            .chain()
            .uniq<SampleObject>(true, listIterator, any);
        result = _(list)
            .chain()
            .uniq<SampleObject, number>(true, listIterator);
        result = _(list)
            .chain()
            .uniq<SampleObject, number>(true, listIterator, any);
        result = _(list)
            .chain()
            .uniq<SampleObject>(listIterator);
        result = _(list)
            .chain()
            .uniq<SampleObject>(listIterator, any);
        result = _(list)
            .chain()
            .uniq<SampleObject, number>(listIterator);
        result = _(list)
            .chain()
            .uniq<SampleObject, number>(listIterator, any);
        result = _(list)
            .chain()
            .uniq<SampleObject>(true, "a");
        result = _(list)
            .chain()
            .uniq<SampleObject>(true, "a", any);
        result = _(list)
            .chain()
            .uniq<SampleObject>("a");
        result = _(list)
            .chain()
            .uniq<SampleObject>("a", any);
        result = _(list)
            .chain()
            .uniq<SampleObject>(true, { a: 42 });
        result = _(list)
            .chain()
            .uniq<{ a: number }, SampleObject>(true, { a: 42 });
        result = _(list)
            .chain()
            .uniq<SampleObject>({ a: 42 });
        result = _(list)
            .chain()
            .uniq<{ a: number }, SampleObject>({ a: 42 });
    }
}
...
namespace TestUnique {
...

    {
        ...
        result = _("abc")
            .chain()
            .unique<string>(true, stringIterator);
        result = _("abc")
            .chain()
            .unique<string>(true, stringIterator, any);
        result = _("abc")
            .chain()
            .unique<string>(stringIterator);
        result = _("abc")
            .chain()
            .unique<string>(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .unique<number>(true, listIterator);
        result = _(array)
            .chain()
            .unique<number>(true, listIterator, any);
        result = _(array)
            .chain()
            .unique<number>(listIterator);
        result = _(array)
            .chain()
            .unique<number>(listIterator, any);
        result = _(array)
            .chain()
            .unique(true, "a");
        result = _(array)
        ...
        result = _(array)
            .chain()
            .unique<{ a: number }>(true, { a: 42 });
        result = _(array)
            .chain()
            .unique<{ a: number }>({ a: 42 });
        ...
        result = _(list)
            .chain()
            .unique<SampleObject>(true);
        result = _(list)
            .chain()
            .unique<SampleObject>(true, listIterator);
        result = _(list)
            .chain()
            .unique<SampleObject>(true, listIterator, any);
        result = _(list)
            .chain()
            .unique<SampleObject, number>(true, listIterator);
        result = _(list)
            .chain()
            .unique<SampleObject, number>(true, listIterator, any);
        result = _(list)
            .chain()
            .unique<SampleObject>(listIterator);
        result = _(list)
            .chain()
            .unique<SampleObject>(listIterator, any);
        result = _(list)
            .chain()
            .unique<SampleObject, number>(listIterator);
        result = _(list)
            .chain()
            .unique<SampleObject, number>(listIterator, any);
        result = _(list)
            .chain()
            .unique<SampleObject>(true, "a");
        result = _(list)
            .chain()
            .unique<SampleObject>(true, "a", any);
        result = _(list)
            .chain()
            .unique<SampleObject>("a");
        result = _(list)
            .chain()
            .unique<SampleObject>("a", any);
        result = _(list)
            .chain()
            .unique<SampleObject>(true, { a: 42 });
        result = _(list)
            .chain()
            .unique<{ a: number }, SampleObject>(true, { a: 42 });
        result = _(list)
            .chain()
            .unique<SampleObject>({ a: 42 });
        result = _(list)
            .chain()
            .unique<{ a: number }, SampleObject>({ a: 42 });
    }
}
...
// _.unzipWith
{
    ...
    let testUnzipWithIterator: {
        (prev: TResult, curr: number, index?: number, list?: number[]): TResult;
    };
    let result: TResult[];
    result = _.unzipWith<number, TResult>(testUnzipWithArray);
    result = _.unzipWith<number, TResult>(
        testUnzipWithArray,
        testUnzipWithIterator
    );
    result = _.unzipWith<number, TResult>(
        testUnzipWithArray,
        testUnzipWithIterator,
    ...
    result = _(testUnzipWithArray)
        .unzipWith<number, TResult>(testUnzipWithIterator)
        .value();
    result = _(testUnzipWithArray)
        .unzipWith<number, TResult>(testUnzipWithIterator, any)
        .value();
    result = _(testUnzipWithList)
        .unzipWith<number, TResult>(testUnzipWithIterator)
        .value();
    result = _(testUnzipWithList)
        .unzipWith<number, TResult>(testUnzipWithIterator, any)
...
namespace TestZipObject {
...

    {
        ...
        result = _.zipObject<number, _.Dictionary<number>>(
            arrayOfKeys,
            arrayOfValues
        );
        result = _.zipObject<number, _.Dictionary<number>>(
...

    {
        ...
        result = _(arrayOfKeys).zipObject<number, _.Dictionary<number>>(
            arrayOfValues
        );
        result = _(arrayOfKeys).zipObject<number, _.Dictionary<number>>(
            listOfValues
        );
        result = _(listOfKeys).zipObject<number, _.Dictionary<number>>(
            listOfValues
        );
        result = _(listOfKeys).zipObject<number, _.Dictionary<number>>(
            arrayOfValues
        ...
        result = _(listOfKeys).zipObject<_.Dictionary<number>>(
            arrayOfKeyValuePairs
        );
        result = _(listOfKeys).zipObject<_.Dictionary<number>>(
            listOfKeyValuePairs
...

    {
        ...
        result = _(arrayOfKeys)
            .chain()
            .zipObject<_.Dictionary<number>>(arrayOfValues);
        result = _(arrayOfKeys)
            .chain()
            .zipObject<_.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
            .chain()
            .zipObject<_.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
        ...
        result = _(arrayOfKeys)
            .chain()
            .zipObject<number, _.Dictionary<number>>(arrayOfValues);
        result = _(arrayOfKeys)
            .chain()
            .zipObject<number, _.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
            .chain()
            .zipObject<number, _.Dictionary<number>>(listOfValues);
        result = _(listOfKeys)
        ...
        result = _(listOfKeys)
            .chain()
            .zipObject<_.Dictionary<number>>(arrayOfKeyValuePairs);
        result = _(listOfKeys)
            .chain()
            .zipObject<_.Dictionary<number>>(listOfKeyValuePairs);
    }

    {
        ...
        result = _(arrayOfKeys)
            .chain()
            .zipObject(arrayOfValues);
        result = _(arrayOfKeys)
            .chain()
            .zipObject(listOfValues);
        ...
        result = _(listOfKeys)
            .chain()
            .zipObject(arrayOfKeyValuePairs);
        result = _(listOfKeys)
            .chain()
            .zipObject(listOfKeyValuePairs);
    }
}
...
result = <number[]>_([1, 2])
    ...
    .value();
result = <number[]>_([1, 2])
    .zipWith<number>(testZipWithFn)
    .value();
result = <number[]>_([1, 2])
    .zipWith<number>(testZipWithFn, any)
    .value();
result = <number[]>_([1, 2])
    .zipWith<number>([1, 2], testZipWithFn, any)
    .value();
result = <number[]>_([1, 2])
    .zipWith<number>([1, 2], [1, 2], [1, 2], [1, 2], [1, 2], testZipWithFn, any)
    .value();
...
namespace TestThru {
...

    {
        ...
        result = _(1)
            .chain()
            .thru<number>(interceptor);
        result = _(1)
            .chain()
            .thru<number>(interceptor, any);
    }

    {
        ...
        result = _("")
            .chain()
            .thru<string>(interceptor);
        result = _("")
            .chain()
            .thru<string>(interceptor, any);
    }

    {
        ...
        result = _(true)
            .chain()
            .thru<boolean>(interceptor);
        result = _(true)
            .chain()
            .thru<boolean>(interceptor, any);
    }

    {
        ...
        result = _({ a: "" })
            .chain()
            .thru<{ a: string }>(interceptor);
        result = _({ a: "" })
            .chain()
            .thru<{ a: string }>(interceptor, any);
    }
...
namespace TestReverse {
    ...
    {
        let result: _.LoDashExplicitArrayWrapper<number> = _([42])
            .chain()
            .reverse();
    }
}
...
namespace TestAll {
    ...
    let dictionaryIterator: (
        value: TResult,
        key: string,
        collection: _.Dictionary<TResult>
    ) => boolean;
...

    {
        ...
        result = _(list)
            .chain()
            .all<TResult>(listIterator);
        result = _(list)
            .chain()
            .all<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .all("");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .all<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .all<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .all("");
        result = _(dictionary)
...
namespace TestAny {
    ...
    let dictionaryIterator: (
        value: SampleObject,
        key: string,
        collection: _.Dictionary<SampleObject>
    ) => boolean;
...

    {
        ...
        result = _.any<{ a: number }, SampleObject>(numericDictionary, {
            a: 42
        });
...

    {
        ...
        result = _(list)
            .chain()
            .any<SampleObject>(listIterator);
        result = _(list)
            .chain()
            .any<SampleObject>(listIterator, any);
        result = _(list)
            .chain()
            .any("a");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .any<SampleObject>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .any<SampleObject>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .any("a");
        result = _(dictionary)
        ...
        result = _(numericDictionary)
            .chain()
            .any<SampleObject>();
        result = _(numericDictionary)
            .chain()
            .any<SampleObject>(numericDictionaryIterator);
        result = _(numericDictionary)
            .chain()
            .any<SampleObject>(numericDictionaryIterator, any);
        result = _(numericDictionary)
            .chain()
            .any("a");
        result = _(numericDictionary)
...
namespace TestCollect {
...

    {
        ...
        result = _.collect<number, TResult>(
            dictionary,
            dictionaryIterator,
            any
        );
...

    {
        ...
        result = _<number>(array)
            .chain()
            .collect<TResult>();
        result = _<number>(array)
            .chain()
            .collect<TResult>(listIterator);
        result = _<number>(array)
            .chain()
            .collect<TResult>(listIterator, any);
        result = _<number>(array)
            .chain()
            .collect<TResult>("");
        ...
        result = _(list)
            .chain()
            .collect<number, TResult>();
        result = _(list)
            .chain()
            .collect<number, TResult>(listIterator);
        result = _(list)
            .chain()
            .collect<number, TResult>(listIterator, any);
        result = _(list)
            .chain()
            .collect<number, TResult>("");
        ...
        result = _(dictionary)
            .chain()
            .collect<number, TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .collect<number, TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .collect<number, TResult>("");
    }
...
namespace TestContains {
...

    {
        ...
        result = _(list)
            .chain()
            .contains<SampleType>(target);
        result = _(list)
            .chain()
            .contains<SampleType>(target, 42);
...
namespace TestCountBy {
    ...
    let numericDictionaryIterator: (
        value: TResult,
        key: number,
        collection: _.NumericDictionary<TResult>
    ) => any;

    {
        ...
        result = _.countBy<{ a: number }, TResult>(numericDictionary, {
            a: 42
        });
...

    {
        ...
        result = _(numericDictionary).countBy<TResult>(
            numericDictionaryIterator
        );
        result = _(numericDictionary).countBy<TResult>(
            numericDictionaryIterator,
...

    {
        ...
        result = _("")
            .chain()
            .countBy(stringIterator);
        result = _("")
            .chain()
            .countBy(stringIterator, any);
        ...
        result = _(array)
            .chain()
            .countBy(listIterator);
        result = _(array)
            .chain()
            .countBy(listIterator, any);
        result = _(array)
            .chain()
            .countBy("");
        result = _(array)
        ...
        result = _(list)
            .chain()
            .countBy<TResult>(listIterator);
        result = _(list)
            .chain()
            .countBy<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .countBy("");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .countBy<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .countBy<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .countBy("");
        result = _(dictionary)
        ...
        result = _(numericDictionary)
            .chain()
            .countBy<TResult>(numericDictionaryIterator);
        result = _(numericDictionary)
            .chain()
            .countBy<TResult>(numericDictionaryIterator, any);
        result = _(numericDictionary)
            .chain()
            .countBy("");
        result = _(numericDictionary)
...
namespace TestEach {
...

    {
        ...
        _(list)
            .chain()
            .each<TResult>(listIterator);
        _(list)
            .chain()
            .each<TResult>(listIterator, any);
    }

    {
        ...
        _(dictionary)
            .chain()
            .each<TResult>(dictionaryIterator);
        _(dictionary)
            .chain()
            .each<TResult>(dictionaryIterator, any);
    }
}
...
namespace TestEachRight {
...

    {
        ...
        _("")
            .chain()
            .eachRight(stringIterator);
        _("")
            .chain()
            .eachRight(stringIterator, any);
    }

    {
        ...
        _(array)
            .chain()
            .eachRight(listIterator);
        _(array)
            .chain()
            .eachRight(listIterator, any);
    }

    {
        ...
        _(list)
            .chain()
            .eachRight<TResult>(listIterator);
        _(list)
            .chain()
            .eachRight<TResult>(listIterator, any);
    }

    {
        ...
        _(dictionary)
            .chain()
            .eachRight<TResult>(dictionaryIterator);
        _(dictionary)
            .chain()
            .eachRight<TResult>(dictionaryIterator, any);
    }
}
...
namespace TestEvery {
...

    {
        ...
        result = _(list)
            .chain()
            .every<TResult>(listIterator);
        result = _(list)
            .chain()
            .every<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .every("");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .every<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .every<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .every("");
        result = _(dictionary)
...
namespace TestFilter {
...

    {
        ...
        result = _(array)
            .chain()
            .filter<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .filter<TResult>(listIterator);
        result = _(list)
            .chain()
            .filter<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .filter<TResult>("");
        result = _(list)
        ...
        result = _(list)
            .chain()
            .filter<{ a: number }, TResult>({ a: 42 });

        result = _(dictionary)
            .chain()
            .filter<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .filter<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .filter<TResult>("");
        result = _(dictionary)
...
namespace TestForEach {
...

    {
        ...
        _("")
            .chain()
            .forEach(stringIterator);
        _("")
            .chain()
            .forEach(stringIterator, any);
    }
...

    {
        ...
        _(list)
            .chain()
            .forEach<TResult>(listIterator);
        _(list)
            .chain()
            .forEach<TResult>(listIterator, any);
    }

    {
        ...
        _(dictionary)
            .chain()
            .forEach<TResult>(dictionaryIterator);
        _(dictionary)
            .chain()
            .forEach<TResult>(dictionaryIterator, any);
    }
}
...
namespace TestForEachRight {
...

    {
        ...
        _("")
            .chain()
            .forEachRight(stringIterator);
        _("")
            .chain()
            .forEachRight(stringIterator, any);
    }

    {
        ...
        _(array)
            .chain()
            .forEachRight(listIterator);
        _(array)
            .chain()
            .forEachRight(listIterator, any);
    }

    {
        ...
        _(list)
            .chain()
            .forEachRight<TResult>(listIterator);
        _(list)
            .chain()
            .forEachRight<TResult>(listIterator, any);
    }

    {
        ...
        _(dictionary)
            .chain()
            .forEachRight<TResult>(dictionaryIterator);
        _(dictionary)
            .chain()
            .forEachRight<TResult>(dictionaryIterator, any);
    }
}
...
namespace TestGroupBy {
    ...
    let listIterator: (
        value: SampleType,
        index: number,
        collection: _.List<SampleType>
    ) => number;
    let dictionaryIterator: (
        value: SampleType,
        key: string,
        collection: _.Dictionary<SampleType>
    ) => number;
...

    {
        ...
        result = _.groupBy<SampleType, number>(
            dictionary,
            dictionaryIterator,
            any
        );
...

    {
        ...
        result = _(dictionary).groupBy<SampleType, number>(
            dictionaryIterator,
            any
        );
...

    {
        ...
        result = _("")
            .chain()
            .groupBy<number>(stringIterator);
        result = _("")
            .chain()
            .groupBy<number>(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .groupBy<number>(listIterator);
        result = _(array)
            .chain()
            .groupBy<number>(listIterator, any);
        result = _(array)
            .chain()
            .groupBy("");
        result = _(array)
        ...
        result = _(list)
            .chain()
            .groupBy<SampleType>(listIterator);
        result = _(list)
            .chain()
            .groupBy<SampleType>(listIterator, any);
        result = _(list)
            .chain()
            .groupBy<SampleType>("");
        result = _(list)
            .chain()
            .groupBy<SampleType>("", any);
        result = _(list)
            .chain()
            .groupBy<SampleType>({ a: 42 });

        result = _(list)
            .chain()
            .groupBy<SampleType, number>(listIterator);
        result = _(list)
            .chain()
            .groupBy<SampleType, number>(listIterator, any);
        result = _(list)
            .chain()
            .groupBy<SampleType, boolean>("", true);
        result = _(list)
            .chain()
            .groupBy<{ a: number }, SampleType>({ a: 42 });
        ...
        result = _(dictionary)
            .chain()
            .groupBy<SampleType>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .groupBy<SampleType>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .groupBy<SampleType>("");
        result = _(dictionary)
        ...
        result = _(dictionary)
            .chain()
            .groupBy<SampleType, number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .groupBy<SampleType, number>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .groupBy<SampleType, boolean>("", true);
        result = _(dictionary)
...
namespace TestInclude {
...

    {
        ...
        result = _(list)
            .chain()
            .include<SampleType>(target);
        result = _(list)
            .chain()
            .include<SampleType>(target, 42);
...
namespace TestIncludes {
...

    {
        ...
        result = _(list)
            .chain()
            .includes<SampleType>(target);
        result = _(list)
            .chain()
            .includes<SampleType>(target, 42);
...
namespace TestIndexBy {
...

    {
        ...
        result = _.indexBy<{ a: number }, SampleObject>(numericDictionary, {
            a: 42
        });
...

    {
        ...
        result = _(numericDictionary).indexBy<{ a: number }, SampleObject>({
            a: 42
        });
...

    {
        ...
        result = _("abcd")
            .chain()
            .indexBy(stringIterator);
        result = _("abcd")
            .chain()
            .indexBy(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .indexBy(listIterator);
        result = _(array)
            .chain()
            .indexBy(listIterator, any);
        result = _(array)
            .chain()
            .indexBy("a");
        result = _(array)
        ...
        result = _(array)
            .chain()
            .indexBy<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .indexBy<SampleObject>();
        result = _(list)
            .chain()
            .indexBy<SampleObject>(listIterator);
        result = _(list)
            .chain()
            .indexBy<SampleObject>(listIterator, any);
        result = _(list)
            .chain()
            .indexBy<SampleObject>("a");
        result = _(list)
            .chain()
            .indexBy<SampleObject>("a", any);
        result = _(list)
            .chain()
            .indexBy<{ a: number }, SampleObject>({ a: 42 });
        result = _(list)
            .chain()
            .indexBy<SampleObject>({ a: 42 });
        ...
        result = _(numericDictionary)
            .chain()
            .indexBy<SampleObject>(numericDictionaryIterator);
        result = _(numericDictionary)
            .chain()
            .indexBy<SampleObject>(numericDictionaryIterator, any);
        result = _(numericDictionary)
            .chain()
            .indexBy<SampleObject>("a");
        result = _(numericDictionary)
        ...
        result = _(dictionary)
            .chain()
            .indexBy<SampleObject>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .indexBy<SampleObject>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .indexBy<SampleObject>("a");
        result = _(dictionary)
...
namespace TestMap {
...

    {
        ...
        result = _<number>(array)
            .chain()
            .map<TResult>(listIterator);
        result = _<number>(array)
            .chain()
            .map<TResult>(listIterator, any);
        result = _<number>(array)
            .chain()
            .map<TResult>("");
        ...
        result = _(list)
            .chain()
            .map<number, TResult>(listIterator);
        result = _(list)
            .chain()
            .map<number, TResult>(listIterator, any);
        result = _(list)
            .chain()
            .map<number, TResult>("");
        ...
        result = _(dictionary)
            .chain()
            .map<number, TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .map<number, TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .map<number, TResult>("");
    }
...
result = <number[][]>(
    _.partition<number>({ 0: 1, 1: 2, 2: 3, 3: 4, length: 4 }, n => n < 3)
);
result = <number[][]>(
    _.partition<number>({ a: 1, b: 2, c: 3, d: 4 }, n => n < 3)
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }, { a: number }>([{ a: 1 }, { a: 2 }], { a: 2 })
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }, { a: number }>(
        { 0: { a: 1 }, 1: { a: 2 }, length: 2 },
        { a: 2 }
    )
);
result = <{ a: number }[][]>(
...
result = <{ a: number }[][]>(
    _.partition<{ a: number }>([{ a: 1 }, { a: 2 }], "a")
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }>([{ a: 1 }, { a: 2 }], "a", 2)
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }>({ 0: { a: 1 }, 1: { a: 2 }, length: 2 }, "a")
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }>({ 0: { a: 1 }, 1: { a: 2 }, length: 2 }, "a", 2)
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }>({ 0: { a: 1 }, 1: { a: 2 } }, "a")
);
result = <{ a: number }[][]>(
    _.partition<{ a: number }>({ 0: { a: 1 }, 1: { a: 2 } }, "a", 2)
);
...
result = <number>(
    _.reduce<number, number>([1, 2, 3], (sum: number, num: number) => sum + num)
);
result = <ABC>_.reduce(
    { a: 1, b: 2, c: 3 },
...
result = <number>(
    _([1, 2, 3]).reduce<number>((sum: number, num: number) => sum + num)
);
result = <ABC>_({ a: 1, b: 2, c: 3 }).reduce<number, ABC>(
    (r: ABC, num: number, key: string) => {
        r[key] = num * 3;
        return r;
    },
...
result = <number>(
    _([1, 2, 3]).foldl<number>((sum: number, num: number) => sum + num)
);
result = <ABC>_({ a: 1, b: 2, c: 3 }).foldl<number, ABC>(
    (r: ABC, num: number, key: string) => {
        r[key] = num * 3;
        return r;
    },
...
result = <number>(
    _([1, 2, 3]).inject<number>((sum: number, num: number) => sum + num)
);
result = <ABC>_({ a: 1, b: 2, c: 3 }).inject<number, ABC>(
    (r: ABC, num: number, key: string) => {
        r[key] = num * 3;
        return r;
    },
...
namespace TestReject {
...

    {
        ...
        result = _("")
            .chain()
            .reject(stringIterator);
        result = _("")
            .chain()
            .reject(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .reject<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .reject<TResult>(listIterator);
        result = _(list)
            .chain()
            .reject<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .reject<TResult>("");
        result = _(list)
        ...
        result = _(list)
            .chain()
            .reject<{ a: number }, TResult>({ a: 42 });

        result = _(dictionary)
            .chain()
            .reject<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .reject<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .reject<TResult>("");
        result = _(dictionary)
...
namespace TestSelect {
...

    {
        ...
        result = _("")
            .chain()
            .select(stringIterator);
        result = _("")
            .chain()
            .select(stringIterator, any);
    }

    {
        ...
        result = _(array)
            .chain()
            .select<{ a: number }>({ a: 42 });

        result = _(list)
            .chain()
            .select<TResult>(listIterator);
        result = _(list)
            .chain()
            .select<TResult>(listIterator, any);
        result = _(list)
            .chain()
            .select<TResult>("");
        result = _(list)
        ...
        result = _(list)
            .chain()
            .select<{ a: number }, TResult>({ a: 42 });

        result = _(dictionary)
            .chain()
            .select<TResult>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .select<TResult>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .select<TResult>("");
        result = _(dictionary)
...
namespace TestSample {
...

    {
        ...
        result = _(array)
            .chain()
            .sample<_.LoDashExplicitWrapper<string>>();
        result = _(list)
            .chain()
            .sample<_.LoDashExplicitWrapper<string>>();
        result = _(dictionary)
...
namespace TestSome {
...

    {
        ...
        result = _.some<{ a: number }, SampleObject>(numericDictionary, {
            a: 42
        });
...

    {
        ...
        result = _(list)
            .chain()
            .some<SampleObject>(listIterator);
        result = _(list)
            .chain()
            .some<SampleObject>(listIterator, any);
        result = _(list)
            .chain()
            .some("a");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .some<SampleObject>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .some<SampleObject>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .some("a");
        result = _(dictionary)
        ...
        result = _(numericDictionary)
            .chain()
            .some<SampleObject>(numericDictionaryIterator);
        result = _(numericDictionary)
            .chain()
            .some<SampleObject>(numericDictionaryIterator, any);
        result = _(numericDictionary)
            .chain()
            .some("a");
        result = _(numericDictionary)
...
namespace TestSortBy {
...

    {
        ...
        result = _(array)
            .chain()
            .sortBy<number>(listIterator);
        result = _(array)
            .chain()
            .sortBy<number>(listIterator, any);
        result = _(array)
            .chain()
            .sortBy("");
        result = _(array)
            .chain()
            .sortBy<{ a: number }>({ a: 42 });
        ...
        result = _(list)
            .chain()
            .sortBy<TResult, number>(listIterator);
        result = _(list)
            .chain()
            .sortBy<TResult, number>(listIterator, any);
        result = _(list)
            .chain()
            .sortBy<TResult>("");
        result = _(list)
            .chain()
            .sortBy<{ a: number }, TResult>({ a: 42 });
        ...
        result = _(dictionary)
            .chain()
            .sortBy<TResult, number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .sortBy<TResult, number>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .sortBy<TResult>("");
        result = _(dictionary)
...
result = <IStoogesAge[]>(
    _.sortByAll(stoogesAges, "name", stooge => Math.sin(stooge.age))
);
...
namespace TestSortByOrder {
...

    {
        let iteratees: (
            ...
            | string
            | { a: number }
            | ((value: SampleObject) => any | string | { a: number })[];
        let result: SampleObject[];

        result = _.sortByOrder<{ a: number }, SampleObject>(array, iteratees);
        result = _.sortByOrder<{ a: number }, SampleObject>(
            array,
            iteratees,
            orders
        );
        ...
        result = _.sortByOrder<SampleObject>(
            numericDictionary,
            iteratees,
            orders
        );
...

    {
        ...
        result = _(list).sortByOrder<{ a: number }, SampleObject>(
            iteratees,
            orders
        );
        ...
        result = _(numericDictionary).sortByOrder<{ a: number }, SampleObject>(
            iteratees
        );
        result = _(numericDictionary).sortByOrder<{ a: number }, SampleObject>(
            iteratees,
        ...
        result = _(numericDictionary).sortByOrder<SampleObject>(
            iteratees,
            orders
        );

        result = _(dictionary).sortByOrder<{ a: number }, SampleObject>(
            iteratees
        );
        result = _(dictionary).sortByOrder<{ a: number }, SampleObject>(
            iteratees,
...

    {
        ...
        result = _(array)
            .chain()
            .sortByOrder<{ a: number }>(iteratees);
        result = _(array)
            .chain()
            .sortByOrder<{ a: number }>(iteratees, orders);

        result = _(list)
            .chain()
            .sortByOrder<{ a: number }, SampleObject>(iteratees);
        result = _(list)
            .chain()
            .sortByOrder<{ a: number }, SampleObject>(iteratees, orders);
        result = _(list)
            .chain()
            .sortByOrder<SampleObject>(iteratees);
        result = _(list)
            .chain()
            .sortByOrder<SampleObject>(iteratees, orders);
...
namespace TestBackflow {
...

    {
        ...
        result = _.backflow<(m: number, n: number) => number>(
            Fn1,
            Fn1,
            Fn1,
            Fn2
...

    {
        ...
        result = _(Fn1).backflow<(m: number, n: number) => number>(
            Fn1,
            Fn1,
            Fn2
        );
...

    {
        ...
        result = _(Fn1)
            .chain()
            .backflow<(m: number, n: number) => number>(Fn2);
        result = _(Fn1)
            .chain()
            .backflow<(m: number, n: number) => number>(Fn1, Fn2);
        result = _(Fn1)
            .chain()
            .backflow<(m: number, n: number) => number>(Fn1, Fn1, Fn2);
    }
}
...
namespace TestCompose {
...

    {
        ...
        result = _.compose<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _.compose<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1).compose<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _(Fn1).compose<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1)
            .chain()
            .compose<(m: number, n: number) => number>(Fn2);
        result = _(Fn1)
            .chain()
            .compose<(m: number, n: number) => number>(
                Fn1,
                Fn2
            );
        result = _(Fn1)
...
result = <_.LoDashImplicitObjectWrapper<() => boolean>>(
    _(createCallbackObj).createCallback()
);
...
curryResult0 = _.curry(testCurryFn)(1)(2)(3);
curryResult0 = _.curry(testCurryFn)(1)(2, 3);
curryResult0 = _(testCurryFn)
    .curry()
    .value()(1, 2, 3);
curryResult2 = _(testCurryFn)
    .curry()
    .value()(1);

declare function testCurry2(
    a: string,
    b: number,
    c: boolean
...
curryResult0 = _(testCurryRightFn)
    .curryRight()
    .value()(1, 2, 3);
curryResult2 = _(testCurryRightFn)
    .curryRight()
    .value()(1);
...
namespace TestFlow {
...

    {
        ...
        result = _.flow<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _.flow<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1).flow<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _(Fn1).flow<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1)
            .chain()
            .flow<(m: number, n: number) => number>(Fn2);
        result = _(Fn1)
            .chain()
            .flow<(m: number, n: number) => number>(
                Fn1,
                Fn2
            );
        result = _(Fn1)
...
namespace TestFlowRight {
...

    {
        ...
        result = _.flowRight<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _.flowRight<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1).flowRight<(m: number, n: number) => number>(
            Fn1,
            Fn2
        );
        result = _(Fn1).flowRight<(m: number, n: number) => number>(
...

    {
        ...
        result = _(Fn1)
            .chain()
            .flowRight<(m: number, n: number) => number>(Fn2);
        result = _(Fn1)
            .chain()
            .flowRight<(m: number, n: number) => number>(
                Fn1,
                Fn2
            );
        result = _(Fn1)
...
namespace TestModArgs {
...

    {
        ...
        result = _.modArgs<Func2, (a: string, b: number) => boolean>(
            func2,
            transform1,
            transform2
        );
        result = _.modArgs<Func2, (a: string, b: number) => boolean>(func2, [
            transform1,
            transform2
        ]);
    }
...

    {
        ...
        result = _(func2).modArgs<(a: string, b: number) => boolean>(
            transform1,
            transform2
        );
        result = _(func2).modArgs<(a: string, b: number) => boolean>([
...

    {
        ...
        result = _(func1)
            .chain()
            .modArgs<(a: string) => boolean>(transform1);
        result = _(func1)
            .chain()
            .modArgs<(a: string) => boolean>([transform1]);
    }

    {
        ...
        result = _(func2)
            .chain()
            .modArgs<(a: string, b: number) => boolean>(transform1, transform2);
        result = _(func2)
            .chain()
            .modArgs<(a: string, b: number) => boolean>([
                transform1,
                transform2
            ]);
    }
...
result = <string[]>(
    _.rearg<TestReargResultFn>(testReargFn, 2, 0, 1)("b", "c", "a")
);
result = <string[]>(
    _.rearg<TestReargResultFn>(testReargFn, [2, 0, 1])("b", "c", "a")
);
...
namespace TestRestParam {
...

    {
        ...
        result = _(func)
            .chain()
            .restParam<ResultFunc>();
        result = _(func)
            .chain()
            .restParam<ResultFunc>(1);
    }
}
...
namespace TestWrap {
...

    {
        ...
        result = _.wrap<SampleValue, SampleWrapper, SampleResult>(
            value,
            wrapper
        );
...

    {
        ...
        result = _(value)
            .chain()
            .wrap<SampleWrapper, SampleResult>(wrapper);
        result = _(value)
            .chain()
            .wrap<SampleResult>(wrapper);
    }
...
namespace TestClone {
...

    {
        ...
        result = _(42)
            .chain()
            .clone<string>(false, customizer);
        result = _(42)
            .chain()
            .clone<string>(false, customizer, any);
        result = _(42)
            .chain()
            .clone<string>(customizer);
        result = _(42)
            .chain()
            .clone<string>(customizer, any);
    }
    ...
    {
        let customizer: CloneCustomizer<
            { a: { b: string } },
            { a: { b: number } }
        >;
...

    {
        ...
        result = _.clone<{ a: { b: number } }, { a: { b: string } }>(
            { a: { b: 42 } },
            false,
            customizer
        );
        ...
        result = _({ a: { b: 42 } }).clone<{ a: { b: string } }>(
            false,
            customizer
        );
        result = _({ a: { b: 42 } }).clone<{ a: { b: string } }>(
...
namespace TestCloneDeep {
...

    {
        ...
        result = _(42)
            .chain()
            .cloneDeep<string>(customizer);
        result = _(42)
            .chain()
            .cloneDeep<string>(customizer, any);
    }
...

    {
        ...
        result = _.cloneDeep<{ a: { b: number } }, { a: { b: string } }>(
            { a: { b: 42 } },
            customizer
        );
        result = _.cloneDeep<{ a: { b: number } }, { a: { b: string } }>(
        ...
        result = _({ a: { b: 42 } }).cloneDeep<{ a: { b: string } }>(
            customizer
        );
        result = _({ a: { b: 42 } }).cloneDeep<{ a: { b: string } }>(
            customizer,
...
namespace TestIsEqual {
...

    {
        ...
        result = _(any)
            .chain()
            .isEqual(any, customizer);
        result = _(any)
            .chain()
            .isEqual(any, customizer, any);
    }
}
...
namespace TestSum {
...

    {
        ...
        result = _(array)
            .chain()
            .sum(listIterator, any);
        result = _(objectArray)
            .chain()
            .sum("");
        ...
        result = _(list)
            .chain()
            .sum<number>(listIterator);
        result = _(list)
            .chain()
            .sum<number>(listIterator, any);
        result = _(objectList)
            .chain()
            .sum("age");
        ...
        result = _(dictionary)
            .chain()
            .sum<number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .sum<number>(dictionaryIterator, any);
        result = _(objectDictionary)
            .chain()
            .sum("age");
    }
}
...
namespace TestAssign {
...

    {
        ...
        result = _.assign<Obj, S1, S2, { a: number; b: number }>(
            obj,
            s1,
            s2,
            customizer
...

    {
        ...
        result = _.assign<Obj, S1, S2, S3, { a: number; b: number; c: number }>(
            obj,
            s1,
            s2,
            s3
...

    {
        ...
        result = _.assign<
            ...
            S4,
            { a: number; b: number; c: number; d: number }
        >(obj, s1, s2, s3, s4, customizer, any);
    }

    {
        ...
        result = _.assign<
            Obj,
            { a: number; b: number; c: number; d: number; e: number }
        >(obj, s1, s2, s3, s4, s5, customizer);
        result = _.assign<
            Obj,
            { a: number; b: number; c: number; d: number; e: number }
        >(obj, s1, s2, s3, s4, s5, customizer, any);
    }
...

    {
        ...
        result = _(obj).assign<S1, S2, { a: number; b: number }>(
            s1,
            s2,
            customizer
        );
...

    {
        ...
        result = _(obj).assign<S1, S2, S3, { a: number; b: number; c: number }>(
            s1,
            s2,
            s3
        );
...

    {
        ...
        result = _(obj)
            .chain()
            .assign<S1, { a: number }>(s1);
        result = _(obj)
            .chain()
            .assign<S1, { a: number }>(s1, customizer);
        result = _(obj)
            .chain()
            .assign<S1, { a: number }>(s1, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .assign<S1, S2, { a: number; b: number }>(s1, s2);
        result = _(obj)
            .chain()
            .assign<S1, S2, { a: number; b: number }>(s1, s2, customizer);
        result = _(obj)
            .chain()
            .assign<S1, S2, { a: number; b: number }>(s1, s2, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .assign<S1, S2, S3, { a: number; b: number; c: number }>(
                s1,
                s2,
                s3
            );
...

    {
        ...
        result = _(obj)
            .chain()
            .assign<{ a: number; b: number; c: number; d: number; e: number }>(
                s1,
                s2,
                s3,
                s4,
...
namespace TestDefaults {
...

    {
        ...
        result = _(obj)
            .chain()
            .defaults<S1, S2, { a: string; b: number }>(s1, s2);
    }

    {
        ...
        result = _(obj)
            .chain()
            .defaults<S1, S2, S3, { a: string; b: number; c: number }>(
                s1,
                s2,
                s3
            );
...
result = <DefaultsDeepResult>_(TestDefaultsDeepObject)
    .defaultsDeep<DefaultsDeepResult>(TestDefaultsDeepSource)
    .value();
...
namespace TestExtend {
...

    {
        ...
        result = _.extend<Obj, Obj & S1 & S2 & S3 & S4 & S5>(
            obj,
            s1,
            s2,
            s3,
...

    {
        ...
        result = _(obj).extend<S1, S2, S3, Obj & S1 & S2 & S3>(
            s1,
            s2,
            s3,
            customizer
...

    {
        ...
        result = _(obj).extend<S1, S2, S3, S4, Obj & S1 & S2 & S3 & S4>(
            s1,
            s2,
            s3,
            s4
...

    {
        ...
        result = _(obj).extend<Obj & S1 & S2 & S3 & S4 & S5>(
            s1,
            s2,
            s3,
            s4,
...

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, Obj & S1>(s1, customizer);
        result = _(obj)
            .chain()
            .extend<S1, Obj & S1>(s1, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, S2, Obj & S1 & S2>(s1, s2);
        result = _(obj)
            .chain()
            .extend<S1, S2, Obj & S1 & S2>(s1, s2, customizer);
        result = _(obj)
            .chain()
            .extend<S1, S2, Obj & S1 & S2>(s1, s2, customizer, any);
    }

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, Obj & S1 & S2 & S3>(s1, s2, s3);
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, Obj & S1 & S2 & S3>(s1, s2, s3, customizer);
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, Obj & S1 & S2 & S3>(
                s1,
                s2,
                s3,
                customizer,
...

    {
        ...
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, S4, Obj & S1 & S2 & S3 & S4>(s1, s2, s3, s4);
        result = _(obj)
            .chain()
            .extend<S1, S2, S3, S4, Obj & S1 & S2 & S3 & S4>(
                s1,
                s2,
                s3,
                s4,
...

    {
        ...
        result = _(obj)
            .chain()
            .extend<Obj & S1 & S2 & S3 & S4 & S5>(s1, s2, s3, s4, s5);
        result = _(obj)
            .chain()
            .extend<Obj & S1 & S2 & S3 & S4 & S5>(
                s1,
                s2,
                s3,
                s4,
...
namespace TestFindKey {
...

    {
        let predicateFn: (
            value: string,
            key?: string,
            collection?: _.Dictionary<string>
        ) => boolean;
        let result: string;
...
namespace TestFindLastKey {
    {
        ...
        result = _.findLastKey<{ a: number }, { a: string }>(
            { a: "" },
            { a: 42 }
        );
        ...
        result = _<{ a: string }>({ a: "" }).findLastKey<{ a: number }>({
            a: 42
        });
    }

    {
        ...
        result = _.findLastKey<string, { a: string }>(
            { a: "" },
            predicateFn,
            any
        );
        ...
        result = _<{ a: string }>({ a: "" }).findLastKey<string>(
            predicateFn,
            any
        );
    }
...
namespace TestForIn {
...

    {
        ...
        result = _(dictionary)
            .chain()
            .forIn<number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .forIn<number>(dictionaryIterator, any);
    }
}
...
namespace TestForInRight {
...

    {
        ...
        result = _(dictionary)
            .chain()
            .forInRight<number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .forInRight<number>(dictionaryIterator, any);
    }
}
...
namespace TestForOwn {
...

    {
        ...
        result = _(dictionary)
            .chain()
            .forOwn<number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .forOwn<number>(dictionaryIterator, any);
    }
}
...
namespace TestForOwnRight {
...

    {
        ...
        result = _(dictionary)
            .chain()
            .forOwnRight<number>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .forOwnRight<number>(dictionaryIterator, any);
    }
}
...
namespace TestGet {
...

    {
        ...
        result = _("abc")
            .chain()
            .get<_.LoDashExplicitWrapper<string>>("0", "_");
        result = _("abc")
            .chain()
            .get<_.LoDashExplicitWrapper<string>>(["0"]);
        result = _("abc")
...

    {
        ...
        result = _([42])
            .chain()
            .get<_.LoDashExplicitWrapper<number>>("0");
        result = _([42])
            .chain()
            .get<_.LoDashExplicitWrapper<number>>("0", -1);
        result = _([42])
            .chain()
            .get<_.LoDashExplicitWrapper<number>>(["0"]);
        result = _([42])
...

    {
        ...
        result = _({ a: true })
            .chain()
            .get<_.LoDashExplicitWrapper<boolean>>("a");
        result = _({ a: true })
            .chain()
            .get<_.LoDashExplicitWrapper<boolean>>("a", false);
        result = _({ a: true })
            .chain()
            .get<_.LoDashExplicitWrapper<boolean>>(["a"]);
        result = _({ a: true })
...
namespace TestMapKeys {
...

    {
        ...
        result = _.mapKeys<TResult, string>(
            dictionary,
            dictionaryIterator,
            any
        );
...

    {
        ...
        result = _(array)
            .chain()
            .mapKeys<string>(listIterator);
        result = _(array)
            .chain()
            .mapKeys<string>(listIterator, any);
        result = _(array)
            .chain()
            .mapKeys("");
        result = _(array)
        ...
        result = _(list)
            .chain()
            .mapKeys<TResult, string>();
        result = _(list)
            .chain()
            .mapKeys<TResult, string>(listIterator);
        result = _(list)
            .chain()
            .mapKeys<TResult, string>(listIterator, any);
        result = _(list)
            .chain()
            .mapKeys<TResult>("");
        result = _(list)
        ...
        result = _(dictionary)
            .chain()
            .mapKeys<TResult, string>(dictionaryIterator);
        result = _(dictionary)
            .chain()
            .mapKeys<TResult, string>(dictionaryIterator, any);
        result = _(dictionary)
            .chain()
            .mapKeys<TResult>("");
        result = _(dictionary)
...
namespace TestMerge {
    ...
    result = _(initialValue)
        .merge(mergingValue)
        .value();
    result = _(initialValue)
        .merge(mergingValue, customizer)
        .value();
    result = _(initialValue)
        .merge(mergingValue, customizer, any)
        .value();
    ...
    // Once we get to the varargs version, you have to specify the result explicitly
    result = _(initialValue)
        .merge<ExpectedResult>({}, {}, {}, {}, mergingValue)
        .value();
    result = _(initialValue)
        .merge<ExpectedResult>({}, {}, {}, {}, mergingValue, customizer)
        .value();
    result = _(initialValue)
        .merge<ExpectedResult>({}, {}, {}, {}, mergingValue, customizer, any)
        .value();
...
namespace TestOmit {
...

    {
        ...
        result = _({})
            .chain()
            .omit<TResult>(true, 0, "a");
        result = _({})
            .chain()
            .omit<TResult>(["b", 1, false], true, 0, "a");
        result = _({})
            .chain()
            .omit<TResult>(predicate);
        result = _({})
            .chain()
            .omit<TResult>(predicate, any);
    }
}
...
namespace TestPick {
...

    {
        ...
        result = _({})
            .chain()
            .pick<TResult>(true, 0, "a");
        result = _({})
            .chain()
            .pick<TResult>(["b", 1, false], true, 0, "a");
        result = _({})
            .chain()
            .pick<TResult>(predicate);
        result = _({})
            .chain()
            .pick<TResult>(predicate, any);
    }
}
...
namespace TestResult {
...

    {
        ...
        result = _.result<{ a: boolean }, boolean>(
            { a: true },
            "a",
            () => false
        );
...

    {
        ...
        result = _("abc")
            .chain()
            .result<_.LoDashExplicitWrapper<string>>("0");
        result = _("abc")
            .chain()
...

    {
        ...
        result = _([42])
            .chain()
            .result<_.LoDashExplicitWrapper<number>>("0");
        result = _([42])
            .chain()
...

    {
        ...
        result = _({ a: true })
            .chain()
            .result<_.LoDashExplicitWrapper<boolean>>("a");
        result = _({ a: true })
            .chain()
...
namespace TestSet {
...

    {
        ...
        result = _.set<SampleObject, number, SampleResult>(
            object,
            "a.b[1]",
            value
        );
...

    {
        ...
        result = _(object)
            .chain()
            .set<number, SampleResult>("a.b[1]", value);
        result = _(object)
            .chain()
            .set<number, SampleResult>(["a", "b", 1], value);
    }
...
namespace TestTransform {
...

    {
        ...
        result = _.transform<number, TResult>(
            array,
            iterator,
            accumulator,
            any
        ...
        result = _<number>(array)
            ...
            .value();
        result = _<number>(array)
            .transform<TResult>(iterator)
            .value();
        result = _<number>(array)
            .transform<TResult>(iterator, accumulator)
            .value();
        result = _<number>(array)
            .transform<TResult>(iterator, accumulator, any)
            .value();
    }

    {
        let iterator: (
            acc: _.Dictionary<TResult>,
            curr: number,
            index?: number,
            arr?: number[]
        ) => void;
...

    {
        ...
        result = _(dictionary)
            .transform<number, TResult>()
            .value();
        result = _(dictionary)
            .transform<number, TResult>(iterator)
            .value();
        result = _(dictionary)
            .transform<number, TResult>(iterator, accumulator)
            .value();
        result = _(dictionary)
            .transform<number, TResult>(iterator, accumulator, any)
            .value();
    }
...
namespace TestEscapeRegExp {
...

    {
        ...
        result = _("[lodash](https://lodash.com/)")
            .chain()
            .escapeRegExp();
    }
}
...
namespace TestTrunc {
...

    {
        ...
        result = _("hi-diddly-ho there, neighborino")
            .chain()
            .trunc();
        result = _("hi-diddly-ho there, neighborino")
            .chain()
...
namespace TestConstant {
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<() => number> = _(
            42
        ).constant<number>();
    }

    {
        let result: _.LoDashImplicitObjectWrapper<() => string> = _(
            "a"
        ).constant<string>();
    }

    {
        let result: _.LoDashImplicitObjectWrapper<() => boolean> = _(
            true
        ).constant<boolean>();
    }
    ...
    {
        let result: _.LoDashImplicitObjectWrapper<() => { a: string }> = _({
            a: "a"
        }).constant<{ a: string }>();
    }

    {
        let result: _.LoDashExplicitObjectWrapper<() => number> = _(42)
            .chain()
            .constant<number>();
    }

    {
        let result: _.LoDashExplicitObjectWrapper<() => string> = _("a")
            .chain()
            .constant<string>();
    }

    {
        let result: _.LoDashExplicitObjectWrapper<() => boolean> = _(true)
            .chain()
            .constant<boolean>();
    }
    ...
    {
        let result: _.LoDashExplicitObjectWrapper<() => { a: string }> = _({
            a: "a"
        })
            .chain()
            .constant<{ a: string }>();
...
namespace TestMatches {
...

    {
        ...
        result = _(path)
            .chain()
            .matchesProperty<TResult>(source);
    }

    {
        ...
        result = _(path)
            .chain()
            .matchesProperty<TResult, TResult>(source);
    }
}
...
namespace TestMethod {
...

    {
        ...
        result = _.method<{ a: string }, { b: string }>(["a", 0], any);
        result = _.method<{ a: string }, { b: string }>(["a", 0], any, any);
        result = _.method<{ a: string }, { b: string }>(
            ["a", 0],
            any,
            any,
            any
...

    {
        ...
        result = _("a.0")
            .chain()
            .method<{ a: string }>(any, any);
        result = _("a.0")
            .chain()
            .method<{ a: string }>(any, any, any);
...

    {
        ...
        result = _("a.0")
            .chain()
            .method<{ a: string }, { b: string }>(any);
        result = _("a.0")
            .chain()
            .method<{ a: string }, { b: string }>(any, any);
        result = _("a.0")
            .chain()
            .method<{ a: string }, { b: string }>(any, any, any);
...
namespace TestMethodOf {
    ...
    type ResultFn = (
        path: _.StringRepresentable | _.StringRepresentable[]
    ) => TResult;
...

    {
        ...
        result = _(object)
            .chain()
            .methodOf<TResult>(any);
        result = _(object)
            .chain()
            .methodOf<TResult>(any, any);
        result = _(object)
            .chain()
            .methodOf<TResult>(any, any, any);
    }
}
...
namespace TestMixin {
...

    {
        ...
        result = _({})
            .chain()
            .mixin<TResult>(source);
        result = _({})
            .chain()
            .mixin<TResult>(source, options);
        result = _(source)
            .chain()
            .mixin<TResult>();
        result = _(source)
            .chain()
            .mixin<TResult>(options);
    }
}
