...
declare module _ {
    ...
    interface LoDashStatic {
         ...
         */
        flatten<T>(
            array: ListOfRecursiveArraysOrValues<T>,
            isDeep: boolean
        ): T[];
    ...
    interface LoDashStatic {
         ...
         */
        memoize: {
            <T extends Function>(func: T, resolver?: Function): T &
                MemoizedFunction;
            Cache: MapCache;
        };
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
        ...
        memoize(
            resolver?: Function
        ): LoDashExplicitObjectWrapper<T & MemoizedFunction>;
    }
    ...
    interface LoDashImplicitObjectWrapper<T> {
         ...
         * @see _.negate
         */
        negate<TResult extends Function>(): LoDashImplicitObjectWrapper<
            TResult
        >;
    }
    ...
    interface LoDashExplicitObjectWrapper<T> {
         ...
         * @see _.negate
         */
        negate<TResult extends Function>(): LoDashExplicitObjectWrapper<
            TResult
        >;
    }
    ...
    interface LoDashImplicitWrapperBase<T, TWrapper> {
         ...
         * @see _.toPlainObject
         */
        toPlainObject<TResult extends {}>(): LoDashImplicitObjectWrapper<
            TResult
        >;
    }
    ...
    interface LoDashExplicitObjectWrapperBase<
        T,
        TObject extends T | null | undefined,
        TWrapper
    > {
        /**
         * @see _.mapValues
        ...
        mapValues<TResult>(
            where: Dictionary<TResult>
        ): LoDashExplicitObjectWrapper<boolean>;
    }
