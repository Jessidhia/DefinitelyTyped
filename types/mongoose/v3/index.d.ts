...
declare module "mongoose" {
    ...
    function plugin<T>(
        plugin: (schema: Schema, options: T) => void,
        options: T
    ): Mongoose;
    ...
    export class Schema {
        ...
        post(
            method: string,
            fn: (doc: Document, next?: HookNextFunction) => any
        ): Schema;
    ...
    export interface Model<T extends Document> extends NodeJS.EventEmitter {
        ...
        save(
            callback?: (err: any, result: T, numberAffected: number) => void
        ): Query<T>;
