...
declare module "mongoose" {
    ...
    class Schema<T = any> extends events.EventEmitter {
        ...
        method(methodObj: { [F in keyof T]: T[F] }): this;
        ...
        set<T extends keyof SchemaOptions>(
            key: T,
            value: SchemaOptions[T]
        ): this;
    ...
    interface SchemaOptions {
        ...
        safe?:
            | boolean
            | { w?: number | string; wtimeout?: number; j?: boolean };
    ...
    > extends mquery {
        ...
        toConstructor<T, Doc extends Document>(): new (
            ...args: any[]
        ) => DocumentQuery<T, Doc> & QueryHelpers;
    ...
    interface Model<T extends Document, QueryHelpers = {}>
        ...
        remove(
            conditions: any,
            callback?: (err: any) => void
        ): Query<mongodb.DeleteWriteOpResultObject["result"]> & QueryHelpers;
        deleteOne(
            conditions: any,
            callback?: (err: any) => void
        ): Query<mongodb.DeleteWriteOpResultObject["result"]> & QueryHelpers;
    ...
    interface ModelFindOneAndUpdateOptions
